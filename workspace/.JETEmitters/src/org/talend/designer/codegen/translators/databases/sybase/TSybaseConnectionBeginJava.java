...
public class TSybaseConnectionBeginJava
{
  ...
  protected final String TEXT_40 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_41 = NL + "\t\t";
  protected final String TEXT_42 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_43 = "\", conn_";
  protected final String TEXT_44 = ");" + NL + "\t}";
  protected final String TEXT_45 = NL + "\tif (null != conn_";
  protected final String TEXT_46 = ") {" + NL + "\t\t";
  protected final String TEXT_47 = NL + "\t}";
  protected final String TEXT_48 = NL + "\t" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_49 = "\", conn_";
  protected final String TEXT_50 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_51 = "\", ";
  protected final String TEXT_52 = ");" + NL + "\tglobalMap.put(\"port_";
  protected final String TEXT_53 = "\", ";
  protected final String TEXT_54 = ");" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_55 = "\", ";
  protected final String TEXT_56 = ");" + NL + "\tglobalMap.put(\"user_";
  protected final String TEXT_57 = "\", ";
  protected final String TEXT_58 = ");" + NL + "\tglobalMap.put(\"pass_";
  protected final String TEXT_59 = "\", ";
  protected final String TEXT_60 = ");" + NL + "\tglobalMap.put(\"dbschema_";
