...
public class TSybaseOutputMainJava {
  ...
  protected final String TEXT_384 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_385 = " = conn_";
  protected final String TEXT_386 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_387 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_388 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_389 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_390 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_391 = " = buffersSize_";
  protected final String TEXT_392 = ";";
  protected final String TEXT_393 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_394 = " = buffersSize_";
  protected final String TEXT_395 = ";";
  protected final String TEXT_396 = NL + "        whetherReject_";
  protected final String TEXT_397 = " = false;";
  protected final String TEXT_398 = NL + "                    ";
  protected final String TEXT_399 = NL + "                        query_";
  protected final String TEXT_400 = " = ";
  protected final String TEXT_401 = ";";
  protected final String TEXT_402 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_403 = ".";
  protected final String TEXT_404 = ", pstmt_";
  protected final String TEXT_405 = ", ";
  protected final String TEXT_406 = ", \"";
  protected final String TEXT_407 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_408 = NL + "                globalMap.put(\"";
  protected final String TEXT_409 = "_QUERY\", query_";
  protected final String TEXT_410 = ".toString().trim());";
  protected final String TEXT_411 = NL + "    \t\tpstmt_";
  protected final String TEXT_412 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_413 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_414 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_415 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_416 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_417 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_418 = " = insertedCount_";
  protected final String TEXT_419 = " + pstmt_";
  protected final String TEXT_420 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_421 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_422 = " = true;";
  protected final String TEXT_423 = NL + "                    throw(e);";
  protected final String TEXT_424 = NL + "                        ";
  protected final String TEXT_425 = " = new ";
  protected final String TEXT_426 = "Struct();";
  protected final String TEXT_427 = NL + "                            ";
  protected final String TEXT_428 = ".";
  protected final String TEXT_429 = " = ";
  protected final String TEXT_430 = ".";
  protected final String TEXT_431 = ";";
  protected final String TEXT_432 = NL + "                        rejectedCount_";
  protected final String TEXT_433 = " = rejectedCount_";
  protected final String TEXT_434 = " + 1;";
  protected final String TEXT_435 = NL + "                        ";
  protected final String TEXT_436 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_437 = ";";
  protected final String TEXT_438 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_439 = NL + "            }";
  protected final String TEXT_440 = NL + "                    ";
  protected final String TEXT_441 = NL + "                        query_";
  protected final String TEXT_442 = " = ";
  protected final String TEXT_443 = ";";
  protected final String TEXT_444 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_445 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_462 = "_QUERY\", query_";
  protected final String TEXT_463 = ".toString().trim());";
  ...
  protected final String TEXT_470 = NL + "            try {" + NL + "                updatedCount_";
  ...
  protected final String TEXT_474 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_475 = " = true;";
  protected final String TEXT_476 = NL + "                    throw(e);";
  protected final String TEXT_477 = NL + "                        ";
  protected final String TEXT_478 = " = new ";
  protected final String TEXT_479 = "Struct();";
  protected final String TEXT_480 = NL + "                            ";
  protected final String TEXT_481 = ".";
  protected final String TEXT_482 = " = ";
  protected final String TEXT_483 = ".";
  protected final String TEXT_484 = ";";
  protected final String TEXT_485 = NL + "                        rejectedCount_";
  protected final String TEXT_486 = " = rejectedCount_";
  protected final String TEXT_487 = " + 1;";
  protected final String TEXT_488 = NL + "                        ";
  protected final String TEXT_489 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_490 = ";";
  protected final String TEXT_491 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_496 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_497 = " = pstmt_";
  protected final String TEXT_498 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_499 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_500 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_501 = " = rs_";
  protected final String TEXT_502 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_503 = " > 0) {";
  protected final String TEXT_504 = NL + "                        ";
  protected final String TEXT_505 = NL + "                            query_";
  protected final String TEXT_506 = " = ";
  protected final String TEXT_507 = ";";
  protected final String TEXT_508 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_509 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_510 = ".";
  protected final String TEXT_511 = ", pstmtUpdate_";
  ...
  protected final String TEXT_524 = NL + "                    globalMap.put(\"";
  protected final String TEXT_525 = "_QUERY\", query_";
  protected final String TEXT_526 = ".toString().trim());";
  protected final String TEXT_527 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_528 = " = updatedCount_";
  protected final String TEXT_529 = " + pstmtUpdate_";
  protected final String TEXT_530 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_548 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_549 = NL + "                        ";
  protected final String TEXT_550 = NL + "                            query_";
  protected final String TEXT_551 = " = ";
  protected final String TEXT_552 = ";";
  protected final String TEXT_553 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_554 = ".";
  protected final String TEXT_555 = ", pstmtInsert_";
  protected final String TEXT_556 = ", ";
  protected final String TEXT_557 = ", \"";
  protected final String TEXT_558 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_559 = NL + "                    globalMap.put(\"";
  protected final String TEXT_560 = "_QUERY\", query_";
  protected final String TEXT_561 = ".toString().trim());";
  protected final String TEXT_562 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_563 = " = insertedCount_";
  protected final String TEXT_564 = " + pstmtInsert_";
  protected final String TEXT_565 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_566 = " = true;";
  protected final String TEXT_567 = NL + "                        throw(e);";
  protected final String TEXT_568 = NL + "                            ";
  protected final String TEXT_569 = " = new ";
  protected final String TEXT_570 = "Struct();";
  protected final String TEXT_571 = NL + "                                ";
  protected final String TEXT_572 = ".";
  protected final String TEXT_573 = " = ";
  protected final String TEXT_574 = ".";
  protected final String TEXT_575 = ";";
  protected final String TEXT_576 = NL + "                            rejectedCount_";
  protected final String TEXT_577 = " = rejectedCount_";
  protected final String TEXT_578 = " + 1;";
  protected final String TEXT_579 = NL + "                            ";
  protected final String TEXT_580 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_581 = ";";
  protected final String TEXT_582 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_583 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_584 = "++;";
  protected final String TEXT_585 = NL + "            int updateFlag_";
  protected final String TEXT_586 = " = 0;";
  protected final String TEXT_587 = NL + "                    ";
  protected final String TEXT_588 = NL + "                        query_";
  protected final String TEXT_589 = " = ";
  protected final String TEXT_590 = ";";
  protected final String TEXT_591 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_592 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_593 = ".";
  protected final String TEXT_594 = ", pstmtUpdate_";
  ...
  protected final String TEXT_608 = "_QUERY\", query_";
  protected final String TEXT_609 = ".toString().trim());";
  protected final String TEXT_610 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_611 = "=pstmtUpdate_";
  protected final String TEXT_612 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_613 = " = updatedCount_";
  protected final String TEXT_614 = "+updateFlag_";
  protected final String TEXT_615 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_633 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_634 = " == 0) {" + NL + "            \t";
  protected final String TEXT_635 = NL + "\t\t\t\tquery_";
  protected final String TEXT_636 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_637 = NL + "                        ";
  protected final String TEXT_638 = NL + "                            query_";
  protected final String TEXT_639 = " = ";
  protected final String TEXT_640 = ";";
  protected final String TEXT_641 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_642 = ".";
  protected final String TEXT_643 = ", pstmtInsert_";
  ...
  protected final String TEXT_650 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_651 = " = insertedCount_";
  protected final String TEXT_652 = " + pstmtInsert_";
  ...
  protected final String TEXT_671 = NL + "                }" + NL + "            }" + NL + "            " + NL + "            nb_line_";
  ...
  protected final String TEXT_770 = NL + "                try {" + NL + "                \t";
  protected final String TEXT_771 = NL + "\t\t\t\t\t\tif ( batchSizeCounter_";
  protected final String TEXT_772 = " > 0 ) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_773 = NL + "                \t\tint countSum_";
  protected final String TEXT_774 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_775 = ": pstmt_";
  protected final String TEXT_776 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  ...
  protected final String TEXT_790 = NL + "\t                \tbatchSizeCounter_";
  protected final String TEXT_791 = " = 0;  " + NL + "\t                \t";
  protected final String TEXT_792 = NL + "            \t   ";
  protected final String TEXT_793 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_794 = "          \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_795 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_796 = NL + "\t                \tint countSum_";
  protected final String TEXT_797 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_798 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_799 = " += (countEach_";
  protected final String TEXT_800 = " < 0 ? 0 : countEach_";
  protected final String TEXT_801 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_802 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_803 = " += countSum_";
  protected final String TEXT_804 = ";" + NL + "            \t    \t";
  protected final String TEXT_805 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_806 = " += countSum_";
  protected final String TEXT_807 = ";" + NL + "            \t    \t";
  protected final String TEXT_808 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_809 = " += countSum_";
  protected final String TEXT_810 = ";" + NL + "            \t    \t";
  protected final String TEXT_811 = " " + NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_812 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_813 = NL + "                \tconn_";
  protected final String TEXT_814 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_815 = "=0;" + NL + "                }\t";
