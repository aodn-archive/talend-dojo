...
public class TSchemaComplianceCheckBeginJava
{
  ...
  protected final String TEXT_17 = "))){" + NL + "\t\t\t\tthrow new Exception(\"Wrong Boolean type!\");" + NL + "\t\t\t}";
  protected final String TEXT_18 = NL + "\t\t\tif(";
  protected final String TEXT_19 = ".";
  protected final String TEXT_20 = ".toCharArray().length != 1){" + NL + "\t\t\t\tthrow new Exception(\"Wrong Character type!\");" + NL + "\t\t\t}";
  ...
  protected final String TEXT_37 = NL + "\t\t}" + NL + "\t} catch(Exception e) {" + NL + "\t\tifPassedThrough = false;" + NL + "\t\terrorCodeThrough += 2;" + NL + "\t\terrorMessageThrough += \"|wrong type\";" + NL + "\t}";
  ...
  protected final String TEXT_115 = "))" + NL + "\t\t\t\tthrow new IllegalArgumentException(\"Data format not matches\");";
  protected final String TEXT_116 = NL + "\t\t\tFastDateParser.getInstance(";
  protected final String TEXT_117 = ", false).parse(";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = ");            ";
  protected final String TEXT_120 = NL + "\t\t}" + NL + "\t} catch(Exception e){" + NL + "\t\tifPassedThrough = false;" + NL + "\t\terrorCodeThrough += 2;" + NL + "\t\terrorMessageThrough += \"|wrong DATE pattern or wrong DATE data\";" + NL + "\t}";
  protected final String TEXT_121 = NL + "\tifPassedThrough = false;" + NL + "\terrorCodeThrough += 2;" + NL + "\terrorMessageThrough += \"|wrong DATE pattern or wrong DATE data\";";
  protected final String TEXT_122 = NL + "\tifPassedThrough = false;" + NL + "\terrorCodeThrough += 2;" + NL + "\terrorMessageThrough += \"|The TYPE of inputting data is error. (one of OBJECT, STRING, DATE)\";";
  protected final String TEXT_123 = NL + "\t// validate nullable (empty as null)" + NL + "\tif ((";
  protected final String TEXT_124 = ".";
  protected final String TEXT_125 = " == null) || (\"\".equals(";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = "))) {";
  protected final String TEXT_128 = NL + "\t// validate nullable" + NL + "\tif (";
  ...
  public String generate(Object argument)
  {
	...
	final boolean checkAllBoolean = "true".equals(checkAll);
	final boolean checkAnother = "true".equals(ElementParameterParser.getValue(node, "__CHECK_ANOTHER__"));
    ...
    stringBuffer.append(TEXT_63);
				...
				if ( bIsTrim && !checkAllBoolean && !checkAnother ){ //CONDITION_00142 START
