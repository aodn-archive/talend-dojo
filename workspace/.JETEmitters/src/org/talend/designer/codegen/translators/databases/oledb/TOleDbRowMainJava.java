...
public class TOleDbRowMainJava
{
  ...
  protected final String TEXT_51 = NL + "    } catch (Exception e) {        " + NL + "\t\twhetherReject_";
  ...
  protected final String TEXT_62 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_63 = ";";
  protected final String TEXT_64 = NL + "         \tSystem.err.print(e.getMessage());";
  protected final String TEXT_65 = NL + "    }" + NL + "\t";
  protected final String TEXT_66 = NL + "        if(!whetherReject_";
