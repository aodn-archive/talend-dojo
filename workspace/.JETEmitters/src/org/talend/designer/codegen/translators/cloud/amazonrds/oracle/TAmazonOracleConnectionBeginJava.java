...
public class TAmazonOracleConnectionBeginJava
{
  ...
  protected final String TEXT_97 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  ...
  protected final String TEXT_105 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_106 = "\",conn_";
  protected final String TEXT_107 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_108 = "\", ";
  protected final String TEXT_109 = ");" + NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_110 = "\",";
  protected final String TEXT_111 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
