...
public class TSAPOutputMainJava
{
  ...
  protected final String TEXT_43 = ");" + NL + "\t\t\tif(input_table_";
  protected final String TEXT_44 = ".getNumRows() > 0){" + NL + "\t\t\t\tinput_table_";
  protected final String TEXT_45 = ".deleteAllRows();" + NL + "\t\t\t}" + NL + "\t        input_table_";
  protected final String TEXT_46 = ".appendRow();" + NL + "\t\t\t";
  protected final String TEXT_47 = "\t" + NL + "\t\t\t\t\tif(input_table_";
  protected final String TEXT_48 = ".getNumRows() < ";
  protected final String TEXT_49 = ".";
  protected final String TEXT_50 = ".size()){" + NL + "\t\t\t\t\t\tinput_table_";
  protected final String TEXT_51 = ".appendRows(";
  protected final String TEXT_52 = ".";
  protected final String TEXT_53 = ".size() - input_table_";
  protected final String TEXT_54 = ".getNumRows());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\tinput_table_";
  protected final String TEXT_55 = ".firstRow();" + NL + "\t\t\t\t\tfor(int i = 0; i < ";
  protected final String TEXT_56 = ".";
  protected final String TEXT_57 = ".size(); i++){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_58 = NL + "\t\t\t\t\t\t\tinput_table_";
  protected final String TEXT_59 = ".setValue(";
  protected final String TEXT_60 = ".";
  protected final String TEXT_61 = ".get(i).toString(), ";
  protected final String TEXT_62 = "); // \"input_table\"--";
  protected final String TEXT_63 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\t\t\t\t\tinput_table_";
  protected final String TEXT_65 = ".setValue(";
  protected final String TEXT_66 = ", ";
  protected final String TEXT_67 = ".";
  protected final String TEXT_68 = ".get(i).toString()); // \"input_table\"--";
  protected final String TEXT_69 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_70 = NL + "\t\t\t\t\t\tinput_table_";
  protected final String TEXT_71 = ".nextRow();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\t\tinput_table_";
  protected final String TEXT_73 = ".firstRow();" + NL + "\t\t\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t\t\t\tinput_table_";
  protected final String TEXT_75 = ".setValue(";
  protected final String TEXT_76 = ".";
  protected final String TEXT_77 = ", ";
  protected final String TEXT_78 = "); // \"input_table\"--";
  protected final String TEXT_79 = NL + "\t\t\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\t\tinput_table_";
  protected final String TEXT_81 = ".setValue(";
  protected final String TEXT_82 = ",";
  protected final String TEXT_83 = ".";
  protected final String TEXT_84 = "); // \"input_table\"--";
  protected final String TEXT_85 = NL + "\t\t\t\t\t";
  protected final String TEXT_86 = NL + "\t\t\t\t";
  protected final String TEXT_87 = "              " + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_88 = "        " + NL + "\t\t" + NL + "\t";
  protected final String TEXT_89 = NL + "\t\t";
  protected final String TEXT_90 = "          " + NL + "\t\t\ttable_input_";
  protected final String TEXT_91 = " = tableParameterList_";
  protected final String TEXT_92 = ".getTable(";
  protected final String TEXT_93 = ");" + NL + "\t\t\tif(table_input_";
  protected final String TEXT_94 = ".getNumRows() > 0){" + NL + "\t\t\t\ttable_input_";
  protected final String TEXT_95 = ".deleteAllRows();" + NL + "\t\t\t}" + NL + "\t        table_input_";
  protected final String TEXT_96 = ".appendRow();" + NL + "\t\t\t";
  protected final String TEXT_97 = NL + "\t\t\t\t\tif(table_input_";
  protected final String TEXT_98 = ".getNumRows() < ";
  protected final String TEXT_99 = ".";
  protected final String TEXT_100 = ".size()){" + NL + "\t\t\t\t\t\ttable_input_";
  protected final String TEXT_101 = ".appendRows(";
  protected final String TEXT_102 = ".";
  protected final String TEXT_103 = ".size() - table_input_";
  protected final String TEXT_104 = ".getNumRows());" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\ttable_input_";
  protected final String TEXT_105 = ".firstRow();" + NL + "\t\t\t\t\tfor(int i = 0; i < ";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = ".size(); i++){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_108 = NL + "\t\t\t\t\t\t\ttable_input_";
  protected final String TEXT_109 = ".setValue(";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = ".get(i).toString(), ";
  protected final String TEXT_112 = "); // \"table_input\"--";
  protected final String TEXT_113 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_114 = NL + "\t\t\t\t\t\t\ttable_input_";
  protected final String TEXT_115 = ".setValue(";
  protected final String TEXT_116 = ", ";
  protected final String TEXT_117 = ".";
  protected final String TEXT_118 = ".get(i).toString()); // \"table_input\"--";
  protected final String TEXT_119 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\t\t\ttable_input_";
  protected final String TEXT_121 = ".nextRow();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\ttable_input_";
  protected final String TEXT_123 = ".firstRow();" + NL + "\t\t\t\t\t";
  protected final String TEXT_124 = NL + "\t\t\t\t\t\ttable_input_";
  protected final String TEXT_125 = ".setValue(";
  protected final String TEXT_126 = ".";
  protected final String TEXT_127 = ", ";
  protected final String TEXT_128 = "); // \"table_input\"--";
  protected final String TEXT_129 = NL + "\t\t\t\t\t";
  protected final String TEXT_130 = NL + "\t\t\t\t\t\ttable_input_";
  protected final String TEXT_131 = ".setValue(";
  protected final String TEXT_132 = ", ";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = "); // \"table_input\"--";
  protected final String TEXT_135 = NL + "\t\t\t\t\t";
  protected final String TEXT_136 = "\t\t\t                 \t" + NL + "\t\t\t\t";
  protected final String TEXT_137 = "        ";
  protected final String TEXT_138 = NL + "\t\tclient_";
  protected final String TEXT_139 = ".execute(function_";
  protected final String TEXT_140 = ");" + NL + "\t}catch (Exception e_";
  protected final String TEXT_141 = ") {" + NL + "\t\tcom.sap.mw.jco.JCO.releaseClient(client_";
  protected final String TEXT_142 = ");" + NL + "\t    throw new RuntimeException(e_";
  protected final String TEXT_143 = ".getMessage());" + NL + "\t}\t";
  protected final String TEXT_144 = NL + "\t\tfunction_";
  protected final String TEXT_145 = ".execute(dest_";
  protected final String TEXT_146 = ");" + NL + "\t}catch (Exception e_";
  protected final String TEXT_147 = ") {" + NL + "\t\tcom.sap.conn.jco.JCoContext.end(dest_";
  protected final String TEXT_148 = ");" + NL + "\t    throw new RuntimeException(e_";
  protected final String TEXT_149 = ".getMessage());" + NL + "\t}\t";
