...
public class TMaxDBRowMainJava
{
  ...
  protected final String TEXT_55 = " = rs_";
  ...
  protected final String TEXT_63 = NL + "    if(commitEvery_";
  protected final String TEXT_64 = "<=commitCounter_";
  protected final String TEXT_65 = "){" + NL + "    " + NL + "    \tconn_";
  protected final String TEXT_66 = ".commit();" + NL + "    \t" + NL + "    \tcommitCounter_";
