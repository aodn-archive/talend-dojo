...
public class TMSSqlSCDBeginJava {
  ...
  protected final String TEXT_47 = ";" + NL + "    }" + NL + "\torg.talend.designer.components.util.mssql.MSSqlGenerateTimestampUtil mssqlGTU_";
  protected final String TEXT_48 = " = org.talend.designer.components.util.mssql.MSSqlUtilFactory.getMSSqlGenerateTimestampUtil();\t" + NL + "    String tmpValue_";
  ...
  protected final String TEXT_105 = " = mssqlGTU_";
  protected final String TEXT_106 = ".getDate(resultSet_";
  protected final String TEXT_107 = ".getMetaData(), resultSet_";
  protected final String TEXT_108 = ", ";
  protected final String TEXT_109 = ");";
  protected final String TEXT_110 = NL + "                    if(resultSet_";
  protected final String TEXT_111 = ".getObject(";
  ...
  protected final String TEXT_119 = NL + "            cache_";
  protected final String TEXT_120 = ".put(sk_";
  protected final String TEXT_121 = ", row_";
  protected final String TEXT_122 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_123 = ".close();" + NL + "        statement_";
  protected final String TEXT_124 = ".close();";
  protected final String TEXT_125 = NL + "            System.out.println(\"[";
  protected final String TEXT_126 = "] comparison cache loaded\");";
  protected final String TEXT_127 = NL + "        ";
  protected final String TEXT_128 = " nextSurrogateKey_";
  protected final String TEXT_129 = " = 1;";
  protected final String TEXT_130 = NL + "            if(cache_";
  protected final String TEXT_131 = ".size() > 0) {";
  protected final String TEXT_132 = NL + "        String tmpQuery_";
  protected final String TEXT_133 = " = \"SELECT MAX([";
  protected final String TEXT_134 = "]) FROM [\" + tableName_";
  protected final String TEXT_135 = " + \"]\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_138 = " = tmpStmt_";
  protected final String TEXT_139 = ".executeQuery(tmpQuery_";
  protected final String TEXT_140 = ");";
  protected final String TEXT_141 = NL + "        if(tmpRS_";
  protected final String TEXT_142 = ".next() && tmpRS_";
  protected final String TEXT_143 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_144 = " = tmpRS_";
  protected final String TEXT_145 = ".get";
  protected final String TEXT_146 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_147 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_148 = ".close();";
  protected final String TEXT_149 = NL + "            }            ";
  protected final String TEXT_150 = NL + "    String insertionSQL_";
  protected final String TEXT_151 = " = \"";
  protected final String TEXT_152 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_153 = " = conn_";
  protected final String TEXT_154 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_155 = ");";
  protected final String TEXT_156 = NL + "            insertionStatement_";
  protected final String TEXT_157 = ".setTimestamp(";
  protected final String TEXT_158 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_159 = "\")));";
  protected final String TEXT_160 = NL + "            insertionStatement_";
  protected final String TEXT_161 = ".setNull(";
  protected final String TEXT_162 = ", java.sql.Types.DATE);";
  protected final String TEXT_163 = NL + "            insertionStatement_";
  protected final String TEXT_164 = ".setTimestamp(";
  protected final String TEXT_165 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_166 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_167 = NL + "        String updateSQLForType1_";
  protected final String TEXT_168 = " = \"";
  protected final String TEXT_169 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_172 = ");        ";
  protected final String TEXT_173 = NL + "        String updateSQLForType2_";
  protected final String TEXT_174 = " = \"";
  protected final String TEXT_175 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_178 = ");";
  protected final String TEXT_179 = NL + "            updateForType2_";
  protected final String TEXT_180 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_181 = "\")));";
  protected final String TEXT_182 = NL + "        String updateSQLForType3_";
  protected final String TEXT_183 = " = \"";
  protected final String TEXT_184 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_187 = ");";
  protected final String TEXT_188 = NL + "    ";
  protected final String TEXT_189 = NL + "        SCDSK_";
  protected final String TEXT_190 = " lookUpKey_";
  protected final String TEXT_191 = " = null;        ";
  protected final String TEXT_192 = NL + "    SCDStruct_";
  protected final String TEXT_193 = " lookUpValue_";
