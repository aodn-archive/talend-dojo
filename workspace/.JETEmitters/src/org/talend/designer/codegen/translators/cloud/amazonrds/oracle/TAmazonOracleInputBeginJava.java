...
public class TAmazonOracleInputBeginJava
{
  ...
  protected final String TEXT_220 = ") {" + NL + "\t\t\t\t\tjava.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_221 = " = dataSources.get(\"";
  protected final String TEXT_222 = "\").getConnection();" + NL + "\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_223 = "\", conn_";
  protected final String TEXT_224 = ");" + NL + "\t\t        }";
  protected final String TEXT_225 = NL + NL + "\t\t    ";
  protected final String TEXT_226 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_227 = " = ";
  protected final String TEXT_228 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_229 = "_QUERY\",dbquery_";
  protected final String TEXT_230 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  ...
  protected final String TEXT_242 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_243 = "=1; i_";
  protected final String TEXT_244 = "<";
  protected final String TEXT_245 = "; i_";
  protected final String TEXT_246 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_247 = ".add(rsmd_";
  protected final String TEXT_248 = ".getColumnName(i_";
  protected final String TEXT_249 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_250 = " = ";
  protected final String TEXT_251 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_252 = "; i <= rsmd_";
  protected final String TEXT_253 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_254 = ".contains(rsmd_";
  protected final String TEXT_255 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  ...
  protected final String TEXT_267 = ".getColumnTypeName(i));";
  ...
  protected final String TEXT_292 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_293 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_294 = "++;" + NL + "\t\t        ";
  protected final String TEXT_295 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  protected final String TEXT_296 = " < ";
  protected final String TEXT_297 = ") { \t\t" + NL + "\t\t                        ";
  protected final String TEXT_298 = ".";
  protected final String TEXT_299 = " = ";
  protected final String TEXT_300 = "; \t\t\t" + NL + "\t\t                    } else {";
  protected final String TEXT_301 = NL + "\t\t                 \t\t\t";
  protected final String TEXT_302 = "\t\t\t";
  protected final String TEXT_303 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_304 = NL + "\t\t                            ";
  protected final String TEXT_305 = ".";
  protected final String TEXT_306 = " = (List)rs_";
  protected final String TEXT_307 = ".getObject(";
  protected final String TEXT_308 = ");";
  protected final String TEXT_309 = NL + "\t\t                         ";
  protected final String TEXT_310 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_311 = ".getObject(";
  protected final String TEXT_312 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_313 = NL + "                                    ";
  protected final String TEXT_314 = ".";
  protected final String TEXT_315 = " = new Geometry(wktValue);";
  protected final String TEXT_316 = NL + "                                        ";
  protected final String TEXT_317 = ".";
  protected final String TEXT_318 = ".setEPSG(";
  ...
  protected final String TEXT_325 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_326 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_327 = " = ";
  protected final String TEXT_328 = "; i_";
  protected final String TEXT_329 = "  <= rsmd_";
  protected final String TEXT_330 = ".getColumnCount(); i_";
  protected final String TEXT_331 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_332 = ".getColumnTypeName(i_";
  protected final String TEXT_333 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_334 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_335 = ".getClob(i_";
  protected final String TEXT_336 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_337 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_338 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_339 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_340 = ".add(tNTextImpl_";
  protected final String TEXT_341 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_342 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_343 = ".";
  protected final String TEXT_344 = ", rs_";
  protected final String TEXT_345 = ", fixedColumnCount_";
  protected final String TEXT_346 = ",list_";
  protected final String TEXT_347 = ");";
  protected final String TEXT_348 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_349 = ".";
  protected final String TEXT_350 = ", rs_";
  protected final String TEXT_351 = ", fixedColumnCount_";
  protected final String TEXT_352 = ");";
  protected final String TEXT_353 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_354 = ".getObject(";
  protected final String TEXT_355 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_356 = ".";
  protected final String TEXT_357 = " = new Geometry(sb.toString());";
  ...
  protected final String TEXT_366 = NL + NL + "\t" + NL + "\t" + NL;
