...
public class TMysqlInputBeginJava
{
  ...
  protected final String TEXT_126 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_127 = ") {" + NL + "\t\t\t\t\tjava.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_128 = " = dataSources.get(\"";
  protected final String TEXT_129 = "\").getConnection();" + NL + "\t\t\t\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_232 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_233 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_234 = " = ";
  protected final String TEXT_235 = "; i_";
  protected final String TEXT_236 = "  <= rsmd_";
  protected final String TEXT_237 = ".getColumnCount(); i_";
  protected final String TEXT_238 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_239 = ".getColumnTypeName(i_";
  protected final String TEXT_240 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_241 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_242 = ".getClob(i_";
  protected final String TEXT_243 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_244 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_245 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_246 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_247 = ".add(tNTextImpl_";
  protected final String TEXT_248 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_249 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_250 = ".";
  protected final String TEXT_251 = ", rs_";
  protected final String TEXT_252 = ", fixedColumnCount_";
  protected final String TEXT_253 = ",list_";
  protected final String TEXT_254 = ");";
  protected final String TEXT_255 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_256 = ".";
  protected final String TEXT_257 = ", rs_";
  protected final String TEXT_258 = ", fixedColumnCount_";
  protected final String TEXT_259 = ");";
  protected final String TEXT_260 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_261 = ".getObject(";
  protected final String TEXT_262 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_263 = ".";
  protected final String TEXT_264 = " = new Geometry(sb.toString());";
