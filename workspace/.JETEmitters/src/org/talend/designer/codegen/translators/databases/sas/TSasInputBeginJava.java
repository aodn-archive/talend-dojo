...
public class TSasInputBeginJava
{
  ...
  protected final String TEXT_134 = ") {" + NL + "\t\t\t\t\tjava.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_135 = " = dataSources.get(\"";
  ...
  protected final String TEXT_156 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_157 = "=1; i_";
  protected final String TEXT_158 = "<";
  protected final String TEXT_159 = "; i_";
  protected final String TEXT_160 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_161 = ".add(rsmd_";
  protected final String TEXT_162 = ".getColumnName(i_";
  protected final String TEXT_163 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_164 = " = ";
  protected final String TEXT_165 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_166 = "; i <= rsmd_";
  protected final String TEXT_167 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  protected final String TEXT_168 = ".contains(rsmd_";
  protected final String TEXT_169 = ".getColumnName(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_170 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_171 = ".setName(rsmd_";
  protected final String TEXT_172 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_173 = ".setDbName(rsmd_";
  protected final String TEXT_174 = ".getColumnName(i));" + NL + "                \tdcm_";
  protected final String TEXT_175 = ".setType(routines.system.Dynamic.getTalendTypeFromDBType(\"";
  protected final String TEXT_176 = "\", rsmd_";
  protected final String TEXT_177 = ".getColumnTypeName(i).toUpperCase(), rsmd_";
  protected final String TEXT_178 = ".getPrecision(i), rsmd_";
  protected final String TEXT_179 = ".getScale(i)));" + NL + "                \tdcm_";
  protected final String TEXT_180 = ".setDbType(rsmd_";
  protected final String TEXT_181 = ".getColumnTypeName(i));";
  protected final String TEXT_182 = NL + "                \tdcm_";
  protected final String TEXT_183 = ".setFormat(";
  protected final String TEXT_184 = ");";
  protected final String TEXT_185 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_186 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_187 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_188 = ".setLength(rsmd_";
  protected final String TEXT_189 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_190 = ".setLength(rsmd_";
  protected final String TEXT_191 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_192 = NL + "\t\t\tdcm_";
  protected final String TEXT_193 = ".setLength(rsmd_";
  protected final String TEXT_194 = ".getPrecision(i));";
  protected final String TEXT_195 = NL + "                \tdcm_";
  protected final String TEXT_196 = ".setPrecision(rsmd_";
  protected final String TEXT_197 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_198 = ".setNullable(rsmd_";
  protected final String TEXT_199 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_200 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_201 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_202 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_203 = ".metadatas.add(dcm_";
  protected final String TEXT_204 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_205 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_206 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_207 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_208 = "++;" + NL + "\t\t        ";
  protected final String TEXT_209 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_220 = " = (List)rs_";
  protected final String TEXT_221 = ".getObject(";
  protected final String TEXT_222 = ");";
  protected final String TEXT_223 = NL + "\t\t                         ";
  protected final String TEXT_224 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_225 = ".getObject(";
  protected final String TEXT_226 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_227 = NL + "                                    ";
  protected final String TEXT_228 = ".";
  protected final String TEXT_229 = " = new Geometry(wktValue);";
  protected final String TEXT_230 = NL + "                                        ";
  protected final String TEXT_231 = ".";
  protected final String TEXT_232 = ".setEPSG(";
  protected final String TEXT_233 = ");";
  protected final String TEXT_234 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_235 = NL + "                                  ";
  protected final String TEXT_236 = ".";
  protected final String TEXT_237 = "=dcg_";
  protected final String TEXT_238 = ";";
  protected final String TEXT_239 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_240 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_241 = " = ";
  protected final String TEXT_242 = "; i_";
  protected final String TEXT_243 = "  <= rsmd_";
  protected final String TEXT_244 = ".getColumnCount(); i_";
  protected final String TEXT_245 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_246 = ".getColumnTypeName(i_";
  protected final String TEXT_247 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_248 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_249 = ".getClob(i_";
  protected final String TEXT_250 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_251 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_252 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_253 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_254 = ".add(tNTextImpl_";
  protected final String TEXT_255 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_256 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_257 = ".";
  protected final String TEXT_258 = ", rs_";
  protected final String TEXT_259 = ", fixedColumnCount_";
  protected final String TEXT_260 = ",list_";
  protected final String TEXT_261 = ");";
  protected final String TEXT_262 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_263 = ".";
  protected final String TEXT_264 = ", rs_";
  protected final String TEXT_265 = ", fixedColumnCount_";
  protected final String TEXT_266 = ");";
  protected final String TEXT_267 = NL + "                                \torg.postgis.Geometry o = org.postgis.PGgeometry.geomFromString(rs_";
  protected final String TEXT_268 = ".getObject(";
  protected final String TEXT_269 = ").toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_270 = ".";
  protected final String TEXT_271 = " = new Geometry(sb.toString());";
