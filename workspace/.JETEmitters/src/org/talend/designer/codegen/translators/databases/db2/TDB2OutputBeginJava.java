...
public class TDB2OutputBeginJava {
  ...
  protected final String TEXT_191 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_209 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_210 = " = conn_";
  protected final String TEXT_211 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_212 = ".execute(\"";
  protected final String TEXT_213 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_214 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_236 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_237 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_238 = "            ";
  protected final String TEXT_239 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_240 = " = conn_";
  protected final String TEXT_241 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_242 = ".executeUpdate(\"";
  protected final String TEXT_243 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_244 = ".close();";
  protected final String TEXT_245 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_246 = " = conn_";
  protected final String TEXT_247 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_248 = " = stmtTruncCount_";
  protected final String TEXT_249 = ".executeQuery(\"";
  protected final String TEXT_250 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_251 = " = conn_";
  protected final String TEXT_252 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_253 = ".executeUpdate(\"";
  protected final String TEXT_254 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_255 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_256 = " += rsTruncCount_";
  protected final String TEXT_257 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_258 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_259 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_260 = ".close();            ";
  protected final String TEXT_261 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_262 = " = conn_";
  protected final String TEXT_263 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_264 = " = stmtTruncCount_";
  protected final String TEXT_265 = ".executeQuery(\"";
  protected final String TEXT_266 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_267 = " = conn_";
  protected final String TEXT_268 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_269 = ".executeUpdate(\"";
  protected final String TEXT_270 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_271 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_272 = " += rsTruncCount_";
  protected final String TEXT_273 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_274 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_275 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_280 = ") VALUES (";
  protected final String TEXT_281 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_282 = " = conn_";
  protected final String TEXT_283 = ".prepareStatement(insert_";
  protected final String TEXT_284 = ");" + NL + "\t    ";
  protected final String TEXT_285 = NL + "\t    String update_";
  protected final String TEXT_286 = " = \"UPDATE \\\"\" + tableName_";
  ...
  protected final String TEXT_291 = ".prepareStatement(update_";
  protected final String TEXT_292 = ");" + NL + "\t    ";
  protected final String TEXT_293 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_294 = " = conn_";
  protected final String TEXT_295 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_296 = " + \"\\\" WHERE ";
  protected final String TEXT_297 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_298 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_299 = " + \"\\\" (";
  protected final String TEXT_300 = ") VALUES (";
  protected final String TEXT_301 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_302 = " = conn_";
  protected final String TEXT_303 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_308 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_320 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_321 = " + \"\\\" (";
  protected final String TEXT_322 = ") VALUES (";
  protected final String TEXT_323 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_324 = " = conn_";
  protected final String TEXT_325 = ".prepareStatement(insert_";
  protected final String TEXT_326 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_327 = NL + "\t    String delete_";
  protected final String TEXT_328 = " = \"DELETE  FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_332 = ".prepareStatement(delete_";
  protected final String TEXT_333 = ");" + NL + "\t    ";
  protected final String TEXT_334 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_335 = " = null;" + NL + "       \t";
  protected final String TEXT_336 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_337 = " = insert_";
  protected final String TEXT_338 = ".split(\"\\\\?\");";
  protected final String TEXT_339 = NL + "\t\t\tupdate_";
  protected final String TEXT_340 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_341 = " = update_";
  ...
  protected final String TEXT_346 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_347 = " = insert_";
  protected final String TEXT_348 = ".split(\"\\\\?\");";
  protected final String TEXT_349 = NL + "\t\t\tdelete_";
  protected final String TEXT_350 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_351 = " = delete_";
  protected final String TEXT_352 = ".split(\"\\\\?\");";
  protected final String TEXT_353 = NL + "\t\t\treplace_";
  protected final String TEXT_354 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_355 = " = replace_";
  protected final String TEXT_356 = ".split(\"\\\\?\");";
  protected final String TEXT_357 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_358 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_359 = " = insertIgnore_";
  protected final String TEXT_360 = ".split(\"\\\\?\");";
  protected final String TEXT_361 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_362 = " = insert_";
  protected final String TEXT_363 = ".split(\"\\\\?\");";
  protected final String TEXT_364 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_365 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_366 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
