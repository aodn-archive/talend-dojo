...
public class TParAccelBulkExecBeginJava {
  ...
  protected final String TEXT_142 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_148 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_160 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_166 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_167 = ".executeUpdate(\"";
  protected final String TEXT_168 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_169 = ".close();";
  protected final String TEXT_170 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_171 = " = conn_";
  protected final String TEXT_172 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_173 = " = stmtTruncCount_";
  protected final String TEXT_174 = ".executeQuery(\"";
  protected final String TEXT_175 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_176 = " = conn_";
  protected final String TEXT_177 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_178 = ".executeUpdate(\"";
  protected final String TEXT_179 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_180 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_181 = " += rsTruncCount_";
  protected final String TEXT_182 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_183 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_184 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_185 = ".close();            ";
  protected final String TEXT_186 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_187 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_188 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_189 = NL + "\t";
  protected final String TEXT_190 = NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_191 = " = conn_";
  protected final String TEXT_192 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");";
  protected final String TEXT_193 = NL + "    java.sql.Statement stmtXPX_";
  protected final String TEXT_194 = " = conn_";
  protected final String TEXT_195 = ".createStatement();" + NL + "    stmtXPX_";
  protected final String TEXT_196 = ".execute(xpxSQL_";
  protected final String TEXT_197 = ");" + NL + "    stmtXPX_";
  protected final String TEXT_198 = ".close();    ";
  protected final String TEXT_199 = NL + "    stmtBulk_";
  protected final String TEXT_200 = ".execute(bulkSQL_";
  protected final String TEXT_201 = ");" + NL + "    stmtBulk_";
