...
public class TAmazonOracleOutputMainJava {
  ...
  protected final String TEXT_543 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_544 = " = true;";
  protected final String TEXT_545 = NL + "                    throw(e);";
  ...
  protected final String TEXT_558 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_559 = ";";
  protected final String TEXT_560 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_561 = NL + "            }    \t\t" + NL + "    \t\t";
  protected final String TEXT_562 = NL + "                    ";
  protected final String TEXT_563 = NL + "                        query_";
  protected final String TEXT_564 = " = ";
  protected final String TEXT_565 = ";";
  protected final String TEXT_566 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  ...
  protected final String TEXT_583 = NL + "                globalMap.put(\"";
  protected final String TEXT_584 = "_QUERY\", query_";
  protected final String TEXT_585 = ".toString().trim());";
  ...
  protected final String TEXT_593 = NL + "             try {" + NL + "                updatedCount_";
  protected final String TEXT_594 = " = updatedCount_";
  protected final String TEXT_595 = " + pstmt_";
  protected final String TEXT_596 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_597 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_612 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_613 = ";";
  protected final String TEXT_614 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_621 = NL + "    " + NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_622 = " = pstmt_";
  protected final String TEXT_623 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_624 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_625 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_626 = " = rs_";
  protected final String TEXT_627 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_628 = " > 0) {";
  protected final String TEXT_629 = NL + "                        ";
  protected final String TEXT_630 = NL + "                            query_";
  protected final String TEXT_631 = " = ";
  protected final String TEXT_632 = ";";
  protected final String TEXT_633 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_634 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_635 = ".";
  protected final String TEXT_636 = ", pstmtUpdate_";
  ...
  protected final String TEXT_649 = NL + "                    globalMap.put(\"";
  protected final String TEXT_650 = "_QUERY\", query_";
  protected final String TEXT_651 = ".toString().trim());";
  protected final String TEXT_652 = NL + "                try {" + NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_653 = " = updatedCount_";
  protected final String TEXT_654 = " + pstmtUpdate_";
  protected final String TEXT_655 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_656 = " = true;";
  protected final String TEXT_657 = NL + "                        throw(e);";
  protected final String TEXT_658 = NL + "                            ";
  protected final String TEXT_659 = " = new ";
  protected final String TEXT_660 = "Struct();";
  protected final String TEXT_661 = NL + "                                ";
  protected final String TEXT_662 = ".";
  protected final String TEXT_663 = " = ";
  protected final String TEXT_664 = ".";
  protected final String TEXT_665 = ";";
  protected final String TEXT_666 = NL + "                            rejectedCount_";
  protected final String TEXT_667 = " = rejectedCount_";
  protected final String TEXT_668 = " + 1;";
  protected final String TEXT_669 = NL + "                            ";
  protected final String TEXT_670 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_671 = ";";
  protected final String TEXT_672 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_673 = NL + "                }" + NL + "    \t\t} else {";
  protected final String TEXT_674 = NL + "                        ";
  protected final String TEXT_675 = NL + "                            query_";
  protected final String TEXT_676 = " = ";
  protected final String TEXT_677 = ";";
  protected final String TEXT_678 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_679 = ".";
  protected final String TEXT_680 = ", pstmtInsert_";
  ...
  protected final String TEXT_687 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_688 = " = insertedCount_";
  protected final String TEXT_689 = " + pstmtInsert_";
  protected final String TEXT_690 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_705 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_706 = ";";
  protected final String TEXT_707 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_708 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_709 = "++;" + NL + "    \t\t";
  protected final String TEXT_710 = NL + "    \t    int updateFlag_";
  protected final String TEXT_711 = " = 0;" + NL + "    \t    ";
  ...
  protected final String TEXT_730 = NL + "                         query_";
  protected final String TEXT_731 = " = ";
  protected final String TEXT_732 = ";";
  protected final String TEXT_733 = NL + "                globalMap.put(\"";
  protected final String TEXT_734 = "_QUERY\", query_";
  protected final String TEXT_735 = ".toString().trim());";
  protected final String TEXT_736 = NL + "    " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_737 = " = pstmtUpdate_";
  protected final String TEXT_738 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_739 = " = updatedCount_";
  protected final String TEXT_740 = "+updateFlag_";
  protected final String TEXT_741 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_756 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_757 = ";";
  protected final String TEXT_758 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_759 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_760 = " == 0) {" + NL + "            " + NL + "\t\t\t\t";
  protected final String TEXT_761 = NL + "\t\t\t\tquery_";
  protected final String TEXT_762 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_763 = NL + "                        ";
  protected final String TEXT_764 = NL + "                            query_";
  protected final String TEXT_765 = " = ";
  protected final String TEXT_766 = ";";
  protected final String TEXT_767 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_768 = ".";
  protected final String TEXT_769 = ", pstmtInsert_";
  protected final String TEXT_770 = ", ";
  protected final String TEXT_771 = ", \"";
  protected final String TEXT_772 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_773 = NL + "                    globalMap.put(\"";
  protected final String TEXT_774 = "_QUERY\", query_";
  protected final String TEXT_775 = ".toString().trim());";
  protected final String TEXT_776 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_777 = " = insertedCount_";
  protected final String TEXT_778 = " + pstmtInsert_";
  protected final String TEXT_779 = ".executeUpdate();" + NL + "                   " + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_780 = " = true;";
  protected final String TEXT_781 = NL + "                        throw(e);";
  protected final String TEXT_782 = NL + "                            ";
  protected final String TEXT_783 = " = new ";
  protected final String TEXT_784 = "Struct();";
  protected final String TEXT_785 = NL + "                                ";
  protected final String TEXT_786 = ".";
  protected final String TEXT_787 = " = ";
  protected final String TEXT_788 = ".";
  protected final String TEXT_789 = ";";
  protected final String TEXT_790 = NL + "                            rejectedCount_";
  protected final String TEXT_791 = " = rejectedCount_";
  protected final String TEXT_792 = " + 1;";
  protected final String TEXT_793 = NL + "                            ";
  protected final String TEXT_794 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_795 = ";";
  protected final String TEXT_796 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_797 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_812 = NL + "    \t\tpstmt_";
  protected final String TEXT_813 = ".addBatch();" + NL + "    \t\t  ";
  protected final String TEXT_814 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_815 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_816 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_817 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_818 = " = deletedCount_";
  protected final String TEXT_819 = " + pstmt_";
  protected final String TEXT_820 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_821 = " = true;";
  protected final String TEXT_822 = NL + "                    throw(e);";
  ...
  protected final String TEXT_835 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_836 = ";";
  protected final String TEXT_837 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_854 = ") {                " + NL + "                \ttry {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_855 = ".executeBatch();" + NL + "                \t}catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_856 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_857 = NL + "                \t\tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_858 = NL + "                \t}" + NL + "\t\t\t\t\ttmp_batchUpdateCount_";
  protected final String TEXT_859 = " = pstmt_";
  protected final String TEXT_860 = ".getUpdateCount();                \t" + NL + "        \t    \t";
  protected final String TEXT_861 = NL + "        \t    \t\tinsertedCount_";
  protected final String TEXT_862 = NL + "        \t    \t";
  protected final String TEXT_863 = NL + "        \t    \t\tupdatedCount_";
  protected final String TEXT_864 = NL + "        \t    \t";
  protected final String TEXT_865 = NL + "        \t    \t    deletedCount_";
  protected final String TEXT_866 = NL + "        \t    \t";
  protected final String TEXT_867 = "      " + NL + "        \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_868 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_869 = ":0);                   \t    \t" + NL + "        \t    \tbatchSizeCounter_";
  protected final String TEXT_870 = " = 0;             \t                \t                \t" + NL + "    \t\t\t}" + NL + "\t    \t\t";
  protected final String TEXT_871 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_872 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_873 = " <= commitCounter_";
  protected final String TEXT_874 = ") {" + NL + "                " + NL + "\t                ";
  protected final String TEXT_875 = NL + "\t\t                try {" + NL + "\t\t                \t\tpstmt_";
  protected final String TEXT_876 = ".executeBatch();" + NL + "\t\t                }catch (java.sql.BatchUpdateException e){" + NL + "\t\t                \t";
  protected final String TEXT_877 = NL + "\t\t\t\t\t\t\t\tthrow(e);" + NL + "\t\t                \t";
  protected final String TEXT_878 = NL + "\t\t                        System.out.println(e.getMessage());" + NL + "\t\t                \t";
  protected final String TEXT_879 = NL + "\t\t                " + NL + "\t\t                }            \t                              " + NL + "\t\t        \t\ttmp_batchUpdateCount_";
  protected final String TEXT_880 = " = pstmt_";
  protected final String TEXT_881 = ".getUpdateCount();" + NL + "\t\t    \t    \t";
  protected final String TEXT_882 = NL + "\t\t    \t    \t\tinsertedCount_";
  protected final String TEXT_883 = NL + "\t\t    \t    \t";
  protected final String TEXT_884 = "            \t    \t\t" + NL + "\t\t    \t    \t\tupdatedCount_";
  protected final String TEXT_885 = NL + "\t\t    \t    \t";
  protected final String TEXT_886 = NL + "\t\t    \t    \t    deletedCount_";
  protected final String TEXT_887 = NL + "\t\t    \t    \t";
  protected final String TEXT_888 = "     " + NL + "\t\t    \t    \t+= (tmp_batchUpdateCount_";
  protected final String TEXT_889 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_890 = ":0);" + NL + "\t                ";
  protected final String TEXT_891 = NL + "                \tconn_";
  protected final String TEXT_892 = ".commit();                " + NL + "                \tcommitCounter_";
