...
public class THashInputBeginJava
{
  ...
  protected final String TEXT_13 = "==null) {" + NL + "\tthrow new RuntimeException(\"Hash is not initialized : Hash must exist before your read from it\");" + NL + "}" + NL + "java.util.Iterator<";
