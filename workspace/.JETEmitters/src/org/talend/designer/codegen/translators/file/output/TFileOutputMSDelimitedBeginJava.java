...
public class TFileOutputMSDelimitedBeginJava
{
  ...
  protected final String TEXT_27 = NL + "com.talend.csv.CSVWriter out";
  protected final String TEXT_28 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "    new java.io.FileOutputStream(fileName_";
  protected final String TEXT_29 = ", false), ";
  protected final String TEXT_30 = ")),";
  protected final String TEXT_31 = ",'\\0','\\0',\"\\n\");" + NL + "    ";
  ...
  protected final String TEXT_36 = ".setLineEnd(\"\" + row_";
  ...
  protected final String TEXT_44 = ".setQuoteChar(textEnclosure_";
  ...
  protected final String TEXT_47 = ".setEscapeChar('\\\\');" + NL + "} else if (escapeChar_";
  protected final String TEXT_48 = ".equals(textEnclosure_";
  protected final String TEXT_49 = ")) {" + NL + "\tout";
  protected final String TEXT_50 = ".setEscapeChar(textEnclosure_";
  protected final String TEXT_51 = ".charAt(0));" + NL + "}";
