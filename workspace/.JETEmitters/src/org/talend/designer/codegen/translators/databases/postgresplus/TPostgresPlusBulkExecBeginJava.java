...
public class TPostgresPlusBulkExecBeginJava {
  ...
  protected final String TEXT_119 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_126 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_127 = ".execute(\"";
  protected final String TEXT_128 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_129 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_130 = " = conn_";
  protected final String TEXT_131 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_135 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_138 = ".executeUpdate(\"";
  protected final String TEXT_139 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_140 = ".close();";
  protected final String TEXT_141 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_142 = " = conn_";
  protected final String TEXT_143 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_144 = " = stmtTruncCount_";
  protected final String TEXT_145 = ".executeQuery(\"";
  protected final String TEXT_146 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_147 = " = conn_";
  protected final String TEXT_148 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_149 = ".executeUpdate(\"";
  protected final String TEXT_150 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_151 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_152 = " += rsTruncCount_";
  protected final String TEXT_153 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_154 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_155 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_156 = ".close();            ";
  protected final String TEXT_157 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_158 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_159 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_160 = NL + "\t";
  protected final String TEXT_161 = NL + "        int keyCount_";
  protected final String TEXT_162 = " = ";
  protected final String TEXT_163 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_164 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        String tmpTableName_";
  protected final String TEXT_165 = " = tableName_";
  protected final String TEXT_166 = ";" + NL + "        tableName_";
  protected final String TEXT_167 = " = \"tmp_";
  protected final String TEXT_168 = "\" + \"_\" + pid;        " + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_169 = " = conn_";
  protected final String TEXT_170 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_171 = ".execute(\"";
  protected final String TEXT_172 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_173 = ".close();";
  protected final String TEXT_174 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_175 = " =conn_";
  protected final String TEXT_176 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_177 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_178 = ".close();" + NL + "   \t\t";
  protected final String TEXT_179 = "    " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_180 = " = conn_";
  protected final String TEXT_181 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_182 = ".execute(bulkSQL_";
  protected final String TEXT_183 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_184 = ".close();" + NL + "        tableName_";
  protected final String TEXT_185 = " = tmpTableName_";
  protected final String TEXT_186 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_187 = " = \"tmp_";
  protected final String TEXT_188 = "\" + \"_\" + pid;" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_189 = " = conn_";
  protected final String TEXT_190 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_191 = ".executeUpdate(\"";
  protected final String TEXT_192 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_193 = ".close();" + NL + "        tableName_";
  protected final String TEXT_194 = " = tmpTableName_";
  protected final String TEXT_195 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_196 = " = conn_";
  protected final String TEXT_197 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_198 = ".execute(\"";
  protected final String TEXT_199 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_200 = ".close();";
  protected final String TEXT_201 = NL + "\t    ";
  protected final String TEXT_202 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_203 = " =conn_";
  protected final String TEXT_204 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_205 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_206 = ".close();" + NL + "   \t\t";
  protected final String TEXT_207 = "    " + NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_208 = " = conn_";
  protected final String TEXT_209 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_210 = ".execute(bulkSQL_";
  protected final String TEXT_211 = ");" + NL + "    stmtBulk_";
