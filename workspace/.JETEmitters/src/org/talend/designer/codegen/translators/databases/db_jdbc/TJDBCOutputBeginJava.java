...
public class TJDBCOutputBeginJava {
  ...
  protected final String TEXT_23 = "\");" + NL + "    if (null == connection_";
  protected final String TEXT_24 = ") {" + NL + "        java.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "        connection_";
  protected final String TEXT_25 = " = dataSources.get(\"";
  protected final String TEXT_26 = "\").getConnection();" + NL + "        globalMap.put(\"";
  ...
  protected final String TEXT_32 = ";" + NL + "    java.sql.Connection connection_";
  protected final String TEXT_33 = " = java.sql.DriverManager.getConnection(connectionString_";
  protected final String TEXT_34 = ", ";
  protected final String TEXT_35 = ", ";
  protected final String TEXT_36 = ");";
  protected final String TEXT_37 = NL + "        connection_";
  protected final String TEXT_38 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_39 = " = ";
  protected final String TEXT_40 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_41 = " = 0;         ";
  protected final String TEXT_42 = NL + "   int batchSize_";
  protected final String TEXT_43 = " = ";
  protected final String TEXT_44 = ";" + NL + "   int batchSizeCounter_";
  protected final String TEXT_45 = "=0;";
  protected final String TEXT_46 = " " + NL;
  protected final String TEXT_47 = NL + "\tjava.sql.Statement statementClear_";
  ...
  protected final String TEXT_51 = " + statementClear_";
  protected final String TEXT_52 = ".executeUpdate(\"delete from \" + ";
  protected final String TEXT_53 = ");" + NL + "\t";
  protected final String TEXT_54 = NL + "\t\tString insert_";
  protected final String TEXT_55 = " = \"INSERT INTO \" + ";
  ...
  protected final String TEXT_60 = ".prepareStatement(insert_";
  protected final String TEXT_61 = ");" + NL + "\t\t";
  protected final String TEXT_62 = NL + "\t\tString update_";
  protected final String TEXT_63 = " = \"UPDATE \" + ";
  protected final String TEXT_64 = " + \" SET ";
  protected final String TEXT_65 = " WHERE ";
  protected final String TEXT_66 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_67 = " = connection_";
  protected final String TEXT_68 = ".prepareStatement(update_";
  protected final String TEXT_69 = ");" + NL + "\t\t";
  protected final String TEXT_70 = NL + "\t\tjava.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_74 = "\");" + NL + "\t\tString insert_";
  protected final String TEXT_75 = " = \"INSERT INTO \" + ";
  protected final String TEXT_76 = " + \" (";
  protected final String TEXT_77 = ") VALUES (";
  protected final String TEXT_78 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_79 = " = connection_";
  protected final String TEXT_80 = ".prepareStatement(insert_";
  protected final String TEXT_81 = ");" + NL + "\t\tString update_";
  protected final String TEXT_82 = " = \"UPDATE \" + ";
  protected final String TEXT_83 = " + \" SET ";
  protected final String TEXT_84 = " WHERE ";
  protected final String TEXT_85 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_86 = " = connection_";
  protected final String TEXT_87 = ".prepareStatement(update_";
  ...
  protected final String TEXT_93 = "\";" + NL + "\t\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_94 = " = connection_";
  protected final String TEXT_95 = ".prepareStatement(update_";
  ...
  protected final String TEXT_100 = ")\";" + NL + "\t\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_101 = " = connection_";
  protected final String TEXT_102 = ".prepareStatement(insert_";
  protected final String TEXT_103 = ");" + NL + "\t\t";
  protected final String TEXT_104 = NL + "\t\tString delete_";
  protected final String TEXT_105 = " = \"DELETE  FROM \" + ";
  ...
  protected final String TEXT_109 = ".prepareStatement(delete_";
  protected final String TEXT_110 = ");" + NL + "\t\t";
  protected final String TEXT_111 = NL + "        StringBuffer query_";
  protected final String TEXT_112 = " = null;" + NL + "       \t";
  protected final String TEXT_113 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_114 = " = insert_";
  protected final String TEXT_115 = ".split(\"\\\\?\");";
  protected final String TEXT_116 = NL + "\t\t\tupdate_";
  protected final String TEXT_117 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_118 = " = update_";
  protected final String TEXT_119 = ".split(\"\\\\?\");";
  protected final String TEXT_120 = NL + "\t\t\tupdate_";
  protected final String TEXT_121 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_122 = " = update_";
  protected final String TEXT_123 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_124 = " = insert_";
  protected final String TEXT_125 = ".split(\"\\\\?\");";
  protected final String TEXT_126 = NL + "\t\t\tdelete_";
  protected final String TEXT_127 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_128 = " = delete_";
  protected final String TEXT_129 = ".split(\"\\\\?\");";
  protected final String TEXT_130 = NL + "\t\t\treplace_";
  protected final String TEXT_131 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_132 = " = replace_";
  protected final String TEXT_133 = ".split(\"\\\\?\");";
  protected final String TEXT_134 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_135 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_136 = " = insertIgnore_";
  protected final String TEXT_137 = ".split(\"\\\\?\");";
  protected final String TEXT_138 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_139 = " = insert_";
