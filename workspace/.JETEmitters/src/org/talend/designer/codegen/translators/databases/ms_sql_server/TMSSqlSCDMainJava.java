...
public class TMSSqlSCDMainJava {
  ...
  protected final String TEXT_35 = NL + "                     lookUpValue_";
  protected final String TEXT_36 = ".";
  protected final String TEXT_37 = " = mssqlGTU_";
  protected final String TEXT_38 = ".getDate(searchingResult_";
  protected final String TEXT_39 = ".getMetaData(), searchingResult_";
  ...
  protected final String TEXT_46 = " = searchingResult_";
  protected final String TEXT_47 = ".get";
  protected final String TEXT_48 = "(";
  protected final String TEXT_49 = ");" + NL + "                    }";
  protected final String TEXT_50 = NL + "        }" + NL + "        searchingResult_";
  protected final String TEXT_51 = ".close();";
  protected final String TEXT_52 = NL + "\ttry {" + NL + "        lookUpKey_";
  protected final String TEXT_53 = " = new SCDSK_";
  protected final String TEXT_54 = "();";
  protected final String TEXT_55 = NL + "            lookUpKey_";
  protected final String TEXT_56 = ".";
  protected final String TEXT_57 = " = ";
  protected final String TEXT_58 = ".";
  protected final String TEXT_59 = ";";
  protected final String TEXT_60 = NL + "        lookUpKey_";
  protected final String TEXT_61 = ".hashCodeDirty = true;" + NL + "        lookUpValue_";
  protected final String TEXT_62 = " = cache_";
  protected final String TEXT_63 = ".get(lookUpKey_";
  ...
  protected final String TEXT_76 = " skRoutine_";
  protected final String TEXT_77 = " = ";
  protected final String TEXT_78 = ";";
  protected final String TEXT_79 = NL + "                    ";
  protected final String TEXT_80 = "                    ";
  protected final String TEXT_81 = NL + "                    ";
  protected final String TEXT_82 = NL + "                    nextSurrogateKey_";
  protected final String TEXT_83 = "++;";
  protected final String TEXT_84 = NL + "                    ";
  protected final String TEXT_85 = NL + "                ";
  protected final String TEXT_86 = " version_";
  protected final String TEXT_87 = " = 1;";
  protected final String TEXT_88 = NL + "                ";
  protected final String TEXT_89 = NL + "                    ";
  protected final String TEXT_90 = NL + "        nb_line_inserted_";
  protected final String TEXT_91 = " += insertionStatement_";
  protected final String TEXT_92 = ".executeUpdate();";
  protected final String TEXT_93 = NL + "            System.out.println(\"[";
  protected final String TEXT_94 = "] new source id inserted\");";
  ...
  protected final String TEXT_101 = " += updateForType1_";
  protected final String TEXT_102 = ".executeUpdate();";
  protected final String TEXT_103 = NL + "                    System.out.println(\"[";
  protected final String TEXT_104 = "] l1 update done\");";
  ...
  protected final String TEXT_111 = " += updateForType2_";
  protected final String TEXT_112 = ".executeUpdate();";
  protected final String TEXT_113 = NL + "                            ";
  protected final String TEXT_114 = NL + "                            ";
  protected final String TEXT_115 = " skRoutine_";
  protected final String TEXT_116 = " = ";
  protected final String TEXT_117 = ";";
  protected final String TEXT_118 = NL + "                            ";
  protected final String TEXT_119 = "                    ";
  protected final String TEXT_120 = NL + "                            ";
  protected final String TEXT_121 = NL + "                            nextSurrogateKey_";
  protected final String TEXT_122 = "++;";
  protected final String TEXT_123 = NL + "                            ";
  protected final String TEXT_124 = NL + "                        ";
  protected final String TEXT_125 = " maxVersion_";
  protected final String TEXT_126 = " = lookUpValue_";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = " + 1;";
  protected final String TEXT_129 = NL + "                            lookUpValue_";
  protected final String TEXT_130 = ".";
  protected final String TEXT_131 = " = lookUpValue_";
  protected final String TEXT_132 = ".";
  protected final String TEXT_133 = " + 1;                            ";
  protected final String TEXT_134 = NL + "                        ";
  protected final String TEXT_135 = NL + "                            ";
  protected final String TEXT_136 = NL + "                nb_line_inserted_";
  protected final String TEXT_137 = " += insertionStatement_";
  protected final String TEXT_138 = ".executeUpdate();";
  protected final String TEXT_139 = NL + "                    System.out.println(\"[";
  protected final String TEXT_140 = "] new history line\");";
  ...
  protected final String TEXT_153 = NL + "                nb_line_update_";
  protected final String TEXT_154 = " += updateForType3_";
  protected final String TEXT_155 = ".executeUpdate();";
  protected final String TEXT_156 = NL + "                    System.out.println(\"[";
  protected final String TEXT_157 = "] l3 update done\");";
  protected final String TEXT_158 = NL + "            }";
  protected final String TEXT_159 = NL + "    }" + NL + "    " + NL + "\t} catch (Exception e) {//catch" + NL + "  \t\t";
  ...
  protected final String TEXT_173 = NL + "\t}//end catch" + NL + "\t";
  protected final String TEXT_174 = NL + "                lookUpValue_";
  protected final String TEXT_175 = ".";
  protected final String TEXT_176 = " = ";
  protected final String TEXT_177 = ".";
  protected final String TEXT_178 = ";";
  protected final String TEXT_179 = NL + "                lookUpValue_";
  ...
  protected final String TEXT_189 = NL + "        cache_";
  protected final String TEXT_190 = ".put(lookUpKey_";
