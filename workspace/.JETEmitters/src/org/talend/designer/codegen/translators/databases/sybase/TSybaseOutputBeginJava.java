...
public class TSybaseOutputBeginJava {
  ...
  protected final String TEXT_175 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_176 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_186 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_187 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_191 = NL + "                if(!whetherExist_";
  protected final String TEXT_192 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".createStatement();";
  protected final String TEXT_195 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_196 = ".execute(\"";
  protected final String TEXT_197 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_217 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_218 = ".execute(\"";
  protected final String TEXT_219 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_220 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_242 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_243 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_244 = "            ";
  protected final String TEXT_245 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_246 = " = conn_";
  protected final String TEXT_247 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_251 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_252 = " = conn_";
  protected final String TEXT_253 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_254 = " = stmtTruncCount_";
  protected final String TEXT_255 = ".executeQuery(\"";
  protected final String TEXT_256 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_257 = " = conn_";
  protected final String TEXT_258 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_259 = ".executeUpdate(\"";
  protected final String TEXT_260 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_261 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_262 = " += rsTruncCount_";
  protected final String TEXT_263 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_264 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_265 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_266 = ".close();            ";
  protected final String TEXT_267 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_268 = " = conn_";
  protected final String TEXT_269 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_270 = " = stmtTruncCount_";
  protected final String TEXT_271 = ".executeQuery(\"";
  protected final String TEXT_272 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_273 = " = conn_";
  protected final String TEXT_274 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_275 = ".executeUpdate(\"";
  protected final String TEXT_276 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_277 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_278 = " += rsTruncCount_";
  protected final String TEXT_279 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_280 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_281 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_282 = ".close();";
  protected final String TEXT_283 = NL + "\t    String insert_";
  protected final String TEXT_284 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_285 = " + \" (";
  protected final String TEXT_286 = ") VALUES (";
  protected final String TEXT_287 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_288 = " = conn_";
  protected final String TEXT_289 = ".prepareStatement(insert_";
  protected final String TEXT_290 = ");" + NL + "\t    ";
  protected final String TEXT_291 = NL + "\t    String update_";
  protected final String TEXT_292 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_293 = " + \" SET ";
  protected final String TEXT_294 = " WHERE ";
  protected final String TEXT_295 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".prepareStatement(update_";
  protected final String TEXT_298 = ");" + NL + "\t    ";
  protected final String TEXT_299 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_300 = " = conn_";
  protected final String TEXT_301 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_302 = " + \" WHERE ";
  protected final String TEXT_303 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_304 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_305 = " + \" (";
  protected final String TEXT_306 = ") VALUES (";
  protected final String TEXT_307 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_318 = NL + "\t    String update_";
  protected final String TEXT_319 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_320 = " + \" SET ";
  protected final String TEXT_321 = " WHERE ";
  protected final String TEXT_322 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_323 = " = conn_";
  protected final String TEXT_324 = ".prepareStatement(update_";
  protected final String TEXT_325 = ");" + NL + "\t    String insert_";
  protected final String TEXT_326 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_327 = " + \" (";
  protected final String TEXT_328 = ") VALUES (";
  protected final String TEXT_329 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_330 = " = conn_";
  protected final String TEXT_331 = ".prepareStatement(insert_";
  protected final String TEXT_332 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_333 = NL + "\t    String delete_";
  protected final String TEXT_334 = " = \"DELETE  FROM \" + tableName_";
  protected final String TEXT_335 = " + \" WHERE ";
  protected final String TEXT_336 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_337 = " = conn_";
  protected final String TEXT_338 = ".prepareStatement(delete_";
  protected final String TEXT_339 = ");" + NL + "\t    ";
  protected final String TEXT_340 = NL + "        StringBuffer query_";
  protected final String TEXT_341 = " = null;" + NL + "       \t";
  protected final String TEXT_342 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_343 = " = insert_";
  protected final String TEXT_344 = ".split(\"\\\\?\");";
  protected final String TEXT_345 = NL + "\t\t\tupdate_";
  protected final String TEXT_346 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_347 = " = update_";
  protected final String TEXT_348 = ".split(\"\\\\?\");";
  protected final String TEXT_349 = NL + "\t\t\tupdate_";
  protected final String TEXT_350 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_351 = " = update_";
  protected final String TEXT_352 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_353 = " = insert_";
  protected final String TEXT_354 = ".split(\"\\\\?\");";
  protected final String TEXT_355 = NL + "\t\t\tdelete_";
  protected final String TEXT_356 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_357 = " = delete_";
  protected final String TEXT_358 = ".split(\"\\\\?\");";
  protected final String TEXT_359 = NL + "\t\t\treplace_";
  protected final String TEXT_360 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_361 = " = replace_";
  protected final String TEXT_362 = ".split(\"\\\\?\");";
  protected final String TEXT_363 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_364 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_365 = " = insertIgnore_";
  protected final String TEXT_366 = ".split(\"\\\\?\");";
  protected final String TEXT_367 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_368 = " = insert_";
  protected final String TEXT_369 = ".split(\"\\\\?\");";
  protected final String TEXT_370 = NL + "\t    java.sql.Statement stmt_";
  protected final String TEXT_371 = " = conn_";
  protected final String TEXT_372 = ".createStatement();" + NL + "\t    stmt_";
  protected final String TEXT_373 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_374 = " +\" ON\");" + NL + "\t    ";
  protected final String TEXT_375 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_376 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_377 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
