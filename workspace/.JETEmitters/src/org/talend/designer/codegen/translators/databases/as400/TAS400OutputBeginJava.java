...
public class TAS400OutputBeginJava {
  ...
  protected final String TEXT_171 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_181 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_188 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_199 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_202 = ".execute(\"";
  protected final String TEXT_203 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_204 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_205 = " = conn_";
  protected final String TEXT_206 = ".createStatement();";
  protected final String TEXT_207 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_208 = ".execute(\"";
  protected final String TEXT_209 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_216 = ", \"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_226 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_227 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_228 = "            ";
  protected final String TEXT_229 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_230 = " = conn_";
  protected final String TEXT_231 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_232 = ".executeUpdate(\"";
  protected final String TEXT_233 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_234 = ".close();";
  protected final String TEXT_235 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_236 = " = conn_";
  protected final String TEXT_237 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_238 = " = stmtTruncCount_";
  protected final String TEXT_239 = ".executeQuery(\"";
  protected final String TEXT_240 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_241 = " = conn_";
  protected final String TEXT_242 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_243 = ".executeUpdate(\"";
  protected final String TEXT_244 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_245 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_246 = " += rsTruncCount_";
  protected final String TEXT_247 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_248 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_249 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_267 = NL + "\t    String insert_";
  protected final String TEXT_268 = " = \"INSERT INTO \" + ";
  protected final String TEXT_269 = " + \" (";
  protected final String TEXT_270 = ") VALUES (";
  protected final String TEXT_271 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_272 = " = conn_";
  protected final String TEXT_273 = ".prepareStatement(insert_";
  protected final String TEXT_274 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  protected final String TEXT_275 = NL + "\t    String update_";
  protected final String TEXT_276 = " = \"UPDATE \" + ";
  protected final String TEXT_277 = " + \" SET ";
  protected final String TEXT_278 = " WHERE ";
  protected final String TEXT_279 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_280 = " = conn_";
  protected final String TEXT_281 = ".prepareStatement(update_";
  protected final String TEXT_282 = ");" + NL + "\t    ";
  protected final String TEXT_283 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_284 = " = conn_";
  protected final String TEXT_285 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_286 = " + \" WHERE ";
  protected final String TEXT_287 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_288 = " = \"INSERT INTO \" + ";
  protected final String TEXT_289 = " + \" (";
  protected final String TEXT_290 = ") VALUES (";
  protected final String TEXT_291 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_292 = " = conn_";
  protected final String TEXT_293 = ".prepareStatement(insert_";
  protected final String TEXT_294 = ");" + NL + "\t    String update_";
  protected final String TEXT_295 = " = \"UPDATE \" + ";
  protected final String TEXT_296 = " + \" SET ";
  protected final String TEXT_297 = " WHERE ";
  protected final String TEXT_298 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_299 = " = conn_";
  protected final String TEXT_300 = ".prepareStatement(update_";
  protected final String TEXT_301 = ");" + NL + "\t    ";
  protected final String TEXT_302 = NL + "\t    String update_";
  protected final String TEXT_303 = " = \"UPDATE \" + ";
  ...
  protected final String TEXT_354 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_355 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_356 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
