...
public class TGreenplumBulkExecBeginJava {
  ...
  protected final String TEXT_110 = NL + "                if(!whetherExist_";
  ...
  protected final String TEXT_117 = NL + "                if(whetherExist_";
  protected final String TEXT_118 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_119 = " = conn_";
  protected final String TEXT_120 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_121 = ".execute(\"";
  protected final String TEXT_122 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_123 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_129 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_130 = " = conn_";
  protected final String TEXT_131 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_132 = ".executeUpdate(\"";
  protected final String TEXT_133 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_134 = ".close();";
  protected final String TEXT_135 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_136 = " = conn_";
  protected final String TEXT_137 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_138 = " = stmtTruncCount_";
  protected final String TEXT_139 = ".executeQuery(\"";
  protected final String TEXT_140 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_143 = ".executeUpdate(\"";
  protected final String TEXT_144 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_145 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_146 = " += rsTruncCount_";
  protected final String TEXT_147 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_148 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_149 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_150 = ".close();            ";
  protected final String TEXT_151 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_152 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_153 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_154 = NL + "        int keyCount_";
  protected final String TEXT_155 = " = ";
  protected final String TEXT_156 = ";" + NL + "        if(keyCount_";
  protected final String TEXT_157 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        String tmpTableName_";
  protected final String TEXT_158 = " = tableName_";
  protected final String TEXT_159 = ";" + NL + "        tableName_";
  protected final String TEXT_160 = " = \"tmp_";
  protected final String TEXT_161 = "\";" + NL + "        java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_162 = " = con_";
  protected final String TEXT_163 = ".createStatement();" + NL + "        stmtCreateTmp_";
  protected final String TEXT_164 = ".execute(\"";
  protected final String TEXT_165 = ")\");" + NL + "        stmtCreateTmp_";
  protected final String TEXT_166 = ".close();" + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_167 = " = con_";
  protected final String TEXT_168 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_169 = ".execute(bulkSQL_";
  protected final String TEXT_170 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_171 = ".close();" + NL + "        tableName_";
  protected final String TEXT_172 = " = tmpTableName_";
  protected final String TEXT_173 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_174 = " = \"tmp_";
  protected final String TEXT_175 = "\";" + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_176 = " = con_";
  protected final String TEXT_177 = ".createStatement();" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_178 = ".executeUpdate(\"";
  protected final String TEXT_179 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_180 = ".close();" + NL + "        tableName_";
  protected final String TEXT_181 = " = tmpTableName_";
  protected final String TEXT_182 = ";" + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_183 = " = con_";
  protected final String TEXT_184 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_185 = ".execute(\"";
  protected final String TEXT_186 = "\");" + NL + "        stmtTmpDrop_";
  ...
  protected final String TEXT_190 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_191 = ".execute(bulkSQL_";
  protected final String TEXT_192 = ");" + NL + "    stmtBulk_";
