...
public class TAS400OutputMainJava {
  ...
  protected final String TEXT_243 = ", java.sql.Statement.RETURN_GENERATED_KEYS);" + NL + "\t    ";
  ...
  protected final String TEXT_298 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  ...
  protected final String TEXT_348 = " = \"DELETE FROM \" + ";
  ...
  protected final String TEXT_388 = NL + "        whetherReject_";
  protected final String TEXT_389 = " = false;";
  protected final String TEXT_390 = NL + "\t\ttry {";
  ...
  protected final String TEXT_405 = " = insertedCount_";
  protected final String TEXT_406 = " + pstmt_";
  protected final String TEXT_407 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_408 = "++;" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_422 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_423 = NL + "            }";
  protected final String TEXT_424 = NL + "\t\t    try {";
  protected final String TEXT_425 = NL + "                    ";
  protected final String TEXT_426 = NL + "                        query_";
  protected final String TEXT_427 = " = ";
  protected final String TEXT_428 = ";";
  protected final String TEXT_429 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_430 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_431 = ".";
  protected final String TEXT_432 = ", pstmt_";
  protected final String TEXT_433 = ", ";
  protected final String TEXT_434 = ", \"";
  protected final String TEXT_435 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_436 = NL + "                    " + NL + "\t\t\t\t\t";
  protected final String TEXT_437 = NL + "                    \t";
  protected final String TEXT_438 = NL + "                        query_";
  protected final String TEXT_439 = " = ";
  protected final String TEXT_440 = ";";
  protected final String TEXT_441 = "  " + NL + "                    ";
  protected final String TEXT_442 = NL + "                    ";
  protected final String TEXT_443 = NL + "                        query_";
  protected final String TEXT_444 = " = ";
  protected final String TEXT_445 = ";";
  protected final String TEXT_446 = NL + "                globalMap.put(\"";
  protected final String TEXT_447 = "_QUERY\", query_";
  protected final String TEXT_448 = ".toString().trim());";
  protected final String TEXT_449 = NL + "                updatedCount_";
  protected final String TEXT_450 = " = updatedCount_";
  protected final String TEXT_451 = " + pstmt_";
  protected final String TEXT_452 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_453 = "++;" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_454 = " = true;";
  protected final String TEXT_455 = NL + "                    throw(e);";
  protected final String TEXT_456 = NL + "                        ";
  protected final String TEXT_457 = " = new ";
  protected final String TEXT_458 = "Struct();";
  ...
  protected final String TEXT_465 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_466 = ";";
  protected final String TEXT_467 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_468 = NL + "            }";
  protected final String TEXT_469 = NL + "\t\t\t\t\t";
  protected final String TEXT_470 = NL + "                    \t";
  protected final String TEXT_471 = NL + "                    ";
  protected final String TEXT_472 = NL + "    \t\tjava.sql.ResultSet rs_";
  protected final String TEXT_473 = " = pstmt_";
  protected final String TEXT_474 = ".executeQuery();" + NL + "    \t\tint checkCount_";
  protected final String TEXT_475 = " = -1;" + NL + "    \t\twhile(rs_";
  protected final String TEXT_476 = ".next()) {" + NL + "    \t\t\tcheckCount_";
  protected final String TEXT_477 = " = rs_";
  protected final String TEXT_478 = ".getInt(1);" + NL + "    \t\t}" + NL + "    \t\tif(checkCount_";
  protected final String TEXT_479 = " > 0) {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_480 = NL + "                        ";
  protected final String TEXT_481 = NL + "                            query_";
  protected final String TEXT_482 = " = ";
  protected final String TEXT_483 = ";";
  protected final String TEXT_484 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_485 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_493 = NL + "\t                        query_";
  protected final String TEXT_494 = " = ";
  protected final String TEXT_495 = ";" + NL + "\t                        ";
  protected final String TEXT_496 = NL + "\t                    ";
  protected final String TEXT_497 = NL + "                        ";
  protected final String TEXT_498 = NL + "                            query_";
  protected final String TEXT_499 = " = ";
  protected final String TEXT_500 = ";";
  protected final String TEXT_501 = NL + "                    globalMap.put(\"";
  protected final String TEXT_502 = "_QUERY\", query_";
  protected final String TEXT_503 = ".toString().trim());";
  protected final String TEXT_504 = NL + "        \t\t\tupdatedCount_";
  protected final String TEXT_505 = " = updatedCount_";
  protected final String TEXT_506 = " + pstmtUpdate_";
  protected final String TEXT_507 = ".executeUpdate();" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_508 = " = true;";
  protected final String TEXT_509 = NL + "                        throw(e);";
  ...
  protected final String TEXT_519 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_520 = ";";
  protected final String TEXT_521 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_522 = NL + "                }" + NL + "    \t\t} else {" + NL + "    \t\t\ttry {" + NL + "    \t\t\t";
  protected final String TEXT_523 = NL + "                        ";
  protected final String TEXT_524 = NL + "                            query_";
  protected final String TEXT_525 = " = ";
  protected final String TEXT_526 = ";";
  protected final String TEXT_527 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_528 = ".";
  protected final String TEXT_529 = ", pstmtInsert_";
  protected final String TEXT_530 = ", ";
  protected final String TEXT_531 = ", \"";
  protected final String TEXT_532 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_533 = NL + "                    globalMap.put(\"";
  protected final String TEXT_534 = "_QUERY\", query_";
  protected final String TEXT_535 = ".toString().trim());";
  protected final String TEXT_536 = NL + "                    insertedCount_";
  protected final String TEXT_537 = " = insertedCount_";
  protected final String TEXT_538 = " + pstmtInsert_";
  protected final String TEXT_539 = ".executeUpdate();" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  protected final String TEXT_540 = " = true;";
  ...
  protected final String TEXT_551 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_552 = ";";
  protected final String TEXT_553 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_554 = NL + "                }" + NL + "    \t\t}" + NL + "    \t\tnb_line_";
  protected final String TEXT_555 = "++;" + NL + "    " + NL + "    \t\t";
  protected final String TEXT_556 = NL + "    \t    int updateFlag_";
  protected final String TEXT_557 = "=0;" + NL + "            try {" + NL + "    \t    ";
  protected final String TEXT_558 = NL + "                    ";
  protected final String TEXT_559 = NL + "                        query_";
  protected final String TEXT_560 = " = ";
  protected final String TEXT_561 = ";";
  protected final String TEXT_562 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_563 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_564 = ".";
  protected final String TEXT_565 = ", pstmtUpdate_";
  ...
  protected final String TEXT_580 = "_QUERY\", query_";
  protected final String TEXT_581 = ".toString().trim());";
  protected final String TEXT_582 = "\t" + NL + "                updateFlag_";
  protected final String TEXT_583 = "=pstmtUpdate_";
  protected final String TEXT_584 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_585 = " = updatedCount_";
  protected final String TEXT_586 = "+updateFlag_";
  protected final String TEXT_587 = ";" + NL + "            } catch(java.sql.SQLException e) {" + NL + "                whetherReject_";
  protected final String TEXT_588 = " = true;";
  protected final String TEXT_589 = NL + "                    throw(e);";
  ...
  protected final String TEXT_599 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_600 = ";";
  protected final String TEXT_601 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_602 = NL + "            }" + NL + "            " + NL + "            if(updateFlag_";
  protected final String TEXT_603 = " == 0) {" + NL + "            \ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_604 = NL + "\t\t\t\tquery_";
  protected final String TEXT_605 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  ...
  protected final String TEXT_612 = ", pstmtInsert_";
  ...
  protected final String TEXT_620 = " = insertedCount_";
  protected final String TEXT_621 = " + pstmtInsert_";
  protected final String TEXT_622 = ".executeUpdate();" + NL + "                } catch(java.sql.SQLException e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_636 = NL + "                             System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_637 = NL + "                }" + NL + "            } " + NL + "            nb_line_";
  ...
  protected final String TEXT_647 = NL + "                        query_";
  ...
  protected final String TEXT_653 = NL + "                deletedCount_";
  protected final String TEXT_654 = " = deletedCount_";
  ...
  protected final String TEXT_670 = NL + "                         System.err.println(e.getMessage() + \" SQLSTATE=[\" + e.getSQLState() + \"] \" + \"CODE[\" + e.getErrorCode() + \"]\");";
  protected final String TEXT_671 = NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_672 = "++;" + NL + "    \t";
  protected final String TEXT_673 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_684 = NL + "                    commitCounter_";
  protected final String TEXT_685 = "++;                " + NL + "                    if(commitEvery_";
  protected final String TEXT_686 = " <= commitCounter_";
  protected final String TEXT_687 = ") {                " + NL + "                        conn_";
  protected final String TEXT_688 = ".commit();                \t" + NL + "                        commitCounter_";
  protected final String TEXT_689 = "=0;                " + NL + "                    }\t";
