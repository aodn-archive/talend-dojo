...
public class TPostgresqlConnectionBeginJava
{
  ...
  protected final String TEXT_34 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_35 = NL + "\t\t";
  protected final String TEXT_36 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_37 = "\", conn_";
  protected final String TEXT_38 = ");" + NL + "\t}";
  protected final String TEXT_39 = NL + "\tif (null != conn_";
  protected final String TEXT_40 = ") {" + NL + "\t\t";
  protected final String TEXT_41 = NL + "\t}";
  protected final String TEXT_42 = NL + NL + "\tglobalMap.put(\"schema_\" + \"";
