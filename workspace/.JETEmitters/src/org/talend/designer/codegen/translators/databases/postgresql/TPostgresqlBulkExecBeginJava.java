...
public class TPostgresqlBulkExecBeginJava {
  ...
  protected final String TEXT_168 = " == 0) {" + NL + "            throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "        }" + NL + "        " + NL + "        String tmpTableName_";
  ...
  protected final String TEXT_177 = ".close();" + NL + "        " + NL + "        ";
  protected final String TEXT_178 = NL + "   \t\tjava.sql.CallableStatement cs_";
  protected final String TEXT_179 = " =conn_";
  protected final String TEXT_180 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \t\tcs_";
  protected final String TEXT_181 = ".execute();" + NL + "   \t\tcs_";
  protected final String TEXT_182 = ".close();" + NL + "   \t\t";
  protected final String TEXT_183 = "        " + NL + "        " + NL + "        java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_184 = " = conn_";
  protected final String TEXT_185 = ".createStatement();" + NL + "        stmtTmpBulk_";
  protected final String TEXT_186 = ".execute(bulkSQL_";
  protected final String TEXT_187 = ");" + NL + "        stmtTmpBulk_";
  protected final String TEXT_188 = ".close();" + NL + "        " + NL + "        tableName_";
  protected final String TEXT_189 = " = tmpTableName_";
  protected final String TEXT_190 = ";" + NL + "        tmpTableName_";
  protected final String TEXT_191 = " = \"tmp_";
  protected final String TEXT_192 = "\" + \"_\" + pid;" + NL + "        " + NL + "        java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_193 = " = conn_";
  protected final String TEXT_194 = ".createStatement();" + NL + "        " + NL + "        stmtUpdateBulk_";
  protected final String TEXT_195 = ".executeUpdate(\"";
  protected final String TEXT_196 = "\");" + NL + "        stmtUpdateBulk_";
  protected final String TEXT_197 = ".close();" + NL + "        tableName_";
  protected final String TEXT_198 = " = tmpTableName_";
  protected final String TEXT_199 = ";" + NL + "        " + NL + "        java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_200 = " = conn_";
  protected final String TEXT_201 = ".createStatement();" + NL + "        stmtTmpDrop_";
  protected final String TEXT_202 = ".execute(\"";
  protected final String TEXT_203 = "\");" + NL + "        stmtTmpDrop_";
  protected final String TEXT_204 = ".close();";
  protected final String TEXT_205 = NL + "   \tjava.sql.CallableStatement cs_";
  protected final String TEXT_206 = " =conn_";
  protected final String TEXT_207 = ".prepareCall(\"set standard_conforming_strings=on\");" + NL + "   \tcs_";
  protected final String TEXT_208 = ".execute();" + NL + "   \tcs_";
  protected final String TEXT_209 = ".close();";
  protected final String TEXT_210 = NL + "    " + NL + "    java.sql.Statement stmtBulk_";
  protected final String TEXT_211 = " = conn_";
  protected final String TEXT_212 = ".createStatement();" + NL + "    //stmt.execute(\"SET client_encoding to 'UNICODE'\");" + NL + "    stmtBulk_";
  protected final String TEXT_213 = ".execute(bulkSQL_";
  protected final String TEXT_214 = ");" + NL + "    stmtBulk_";
