...
public class TExtractEBCDICFieldsMainJava
{
  ...
  protected final String TEXT_52 = " = cobolConversion.EBCDICType3.readType3Value(bb_";
  ...
  protected final String TEXT_59 = " = cobolConversion.EBCDICType9.readType9Value(bb_";
  ...
  protected final String TEXT_67 = " = new java.math.BigDecimal(new java.math.BigInteger(bb_";
  protected final String TEXT_68 = "_";
  protected final String TEXT_69 = "),0);";
  protected final String TEXT_70 = NL + "\t\t\t\t";
  protected final String TEXT_71 = ".";
  protected final String TEXT_72 = " = bb_";
  protected final String TEXT_73 = "_";
  protected final String TEXT_74 = ";";
  protected final String TEXT_75 = NL + "//////////////////////////////////////////////////" + NL + "DB Type of the column:";
  protected final String TEXT_76 = " should be X, 1, 2, 3, 9, B, T" + NL + "//////////////////////////////////////////////////";
  protected final String TEXT_77 = NL + "\t\t";
  protected final String TEXT_78 = " = null;";
  protected final String TEXT_79 = NL + "\tbbRecord_";
  protected final String TEXT_80 = ".clear();" + NL + "\tnb_line_";
  protected final String TEXT_81 = "++;" + NL + "}catch(Exception ex_";
  protected final String TEXT_82 = "){";
  protected final String TEXT_83 = NL + "\t\tthrow(ex_";
  ...
  protected final String TEXT_94 = ".errorMessage = ex_";
  protected final String TEXT_95 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_96 = ";" + NL + "\t\t    ";
  protected final String TEXT_97 = " = null;";
  protected final String TEXT_98 = NL + "\t\t    System.err.println(ex_";
  protected final String TEXT_99 = ".getMessage());" + NL + "\t\t    ";
  protected final String TEXT_100 = " = null;";
  protected final String TEXT_101 = NL + "\t\t\t";
  protected final String TEXT_102 = ".errorMessage = ex_";
  protected final String TEXT_103 = ".getMessage() + \" - Line: \" + tos_count_";
