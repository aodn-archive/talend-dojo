...
public class TDB2ConnectionBeginJava
{
  ...
  protected final String TEXT_38 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_39 = NL + "\t\t";
  protected final String TEXT_40 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_41 = "\", conn_";
  protected final String TEXT_42 = ");" + NL + "\t}";
  protected final String TEXT_43 = NL + "\tif (null != conn_";
  protected final String TEXT_44 = ") {" + NL + "\t\t";
  protected final String TEXT_45 = NL + "\t}";
  protected final String TEXT_46 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_47 = "\", conn_";
  protected final String TEXT_48 = ");" + NL + "\tglobalMap.put(\"host_";
  ...
  protected final String TEXT_54 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_55 = "\", userName_";
  protected final String TEXT_56 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_57 = "\", password_";
