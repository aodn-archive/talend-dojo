...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_37 = ") {" + NL + "        java.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "        conn_";
  protected final String TEXT_38 = " = dataSources.get(\"";
  protected final String TEXT_39 = "\").getConnection();" + NL + "        globalMap.put(\"";
  protected final String TEXT_40 = "\", conn_";
  protected final String TEXT_41 = ");" + NL + "    }" + NL + "\t";
  protected final String TEXT_42 = NL + "\tString dbProperties_";
  protected final String TEXT_43 = " = ";
  protected final String TEXT_44 = ";" + NL + "\tString url_";
  protected final String TEXT_45 = " = null;" + NL + "\tif(dbProperties_";
  protected final String TEXT_46 = " == null || dbProperties_";
  protected final String TEXT_47 = ".trim().length() == 0) {" + NL + "\t    url_";
  protected final String TEXT_48 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_49 = " + \":\" + ";
  protected final String TEXT_50 = " + \"/\" + ";
  protected final String TEXT_51 = " + \"?\" + \"rewriteBatchedStatements=true\";" + NL + "\t} else {" + NL + "\t\tString properties_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "\t\tif (!properties_";
  protected final String TEXT_54 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_55 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t    url_";
  protected final String TEXT_56 = " = \"jdbc:mysql://\" + ";
  protected final String TEXT_57 = " + \":\" + ";
  protected final String TEXT_58 = " + \"/\" + ";
  protected final String TEXT_59 = " + \"?\" + properties_";
  protected final String TEXT_60 = ";" + NL + "\t}" + NL + "    String dbUser_";
  protected final String TEXT_61 = " = ";
  protected final String TEXT_62 = ";" + NL + "    String dbPwd_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ";    " + NL + "\tjava.lang.Class.forName(\"";
  protected final String TEXT_65 = "\");" + NL + "\tconn_";
  protected final String TEXT_66 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_67 = ", dbUser_";
  protected final String TEXT_68 = ", dbPwd_";
  protected final String TEXT_69 = ");" + NL + "\t";
  protected final String TEXT_70 = NL + "        conn_";
  protected final String TEXT_71 = ".setAutoCommit(false);" + NL + "        int commitEvery_";
  protected final String TEXT_72 = " = ";
  protected final String TEXT_73 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_74 = " = 0;";
  protected final String TEXT_75 = NL + "   int batchSize_";
  protected final String TEXT_76 = " = ";
  protected final String TEXT_77 = ";" + NL + "   int batchSizeCounter_";
  ...
  protected final String TEXT_133 = NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_134 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_135 = "+\"][\"+";
  protected final String TEXT_136 = "+\"][\"+";
  protected final String TEXT_137 = "+\"][\"+";
  protected final String TEXT_138 = "+\"][\"+";
  protected final String TEXT_139 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_140 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_141 = NL + "\t\t    // [%connection%][checktable][tableName]" + NL + "\t\t    String keyCheckTable_";
  protected final String TEXT_142 = " = conn_";
  protected final String TEXT_143 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_144 = " + \"]\";" + NL + "\t\t    ";
  protected final String TEXT_145 = NL + "\t\t    " + NL + "\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_146 = ")== null){" + NL + "\t\t\t" + NL + "\t\t\t\tsynchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_147 = ")) {" + NL + "\t\t\t\t\tif(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_148 = ")== null){";
  protected final String TEXT_149 = "              ";
  protected final String TEXT_150 = NL + "\t\t\t\tjava.sql.Statement isExistStmt_";
  protected final String TEXT_151 = " = conn_";
  protected final String TEXT_152 = ".createStatement();" + NL + "\t\t\t\tboolean whetherExist_";
  protected final String TEXT_153 = " = false;" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_157 = " = false;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tisExistStmt_";
  ...
  protected final String TEXT_296 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_297 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_298 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_299 = ".append(\",\");" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_303 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_312 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_313 = " += \tduplidateClause_";
  protected final String TEXT_314 = ".toString();";
  protected final String TEXT_315 = NL + "\t\t\t\t";
  protected final String TEXT_316 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_317 = " = new StringBuffer(insert_";
  protected final String TEXT_318 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_319 = ".insert(insert_";
  protected final String TEXT_320 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_321 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_322 = " =insertStringBuffer_";
  ...
  protected final String TEXT_327 = ".prepareStatement(insert_";
  protected final String TEXT_328 = ");";
  protected final String TEXT_329 = NL + "                        ";
  protected final String TEXT_330 = NL + "                \t\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_331 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_332 = " = conn_";
  protected final String TEXT_333 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_334 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_335 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_336 = ",insert_";
  protected final String TEXT_337 = ",keyPsmt_";
  protected final String TEXT_338 = ");";
  protected final String TEXT_339 = NL + "\t        \t        ";
  protected final String TEXT_340 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_341 = " {" + NL + "    \t            ";
  protected final String TEXT_342 = NL + "                            ";
  protected final String TEXT_343 = " ";
  protected final String TEXT_344 = ";                ";
  protected final String TEXT_345 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_369 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_370 = " += \tduplidateClause_";
  protected final String TEXT_371 = ".toString();";
  protected final String TEXT_372 = NL + "\t\t\t\t";
  protected final String TEXT_373 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_374 = " = new StringBuffer(insert_";
  protected final String TEXT_375 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_376 = ".insert(insert_";
  protected final String TEXT_377 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_378 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_379 = " =insertStringBuffer_";
  protected final String TEXT_380 = ".toString(); ";
  protected final String TEXT_381 = "    " + NL + "\t            java.sql.PreparedStatement pstmt_";
  protected final String TEXT_382 = " =  conn_";
  protected final String TEXT_383 = ".prepareStatement(insert_";
  protected final String TEXT_384 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_385 = " = \"";
  protected final String TEXT_386 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_387 = " =  \"";
  protected final String TEXT_388 = "\"; " + NL + "\t            int rowCount";
  ...
  protected final String TEXT_393 = ") VALUES (";
  protected final String TEXT_394 = ")\";";
  protected final String TEXT_395 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_396 = " += \tduplidateClause_";
  protected final String TEXT_397 = ".toString();";
  protected final String TEXT_398 = NL + "\t\t        int batchSize_";
  protected final String TEXT_399 = " = ";
  protected final String TEXT_400 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_401 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_402 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_403 = " = new StringBuffer(insert_";
  protected final String TEXT_404 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_405 = ".insert(insert_";
  protected final String TEXT_406 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_407 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_408 = " =insertStringBuffer_";
  protected final String TEXT_409 = ".toString(); ";
  protected final String TEXT_410 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_411 = " = conn_";
  protected final String TEXT_412 = ".prepareStatement(insert_";
  protected final String TEXT_413 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_414 = NL + "\t    String update_";
  protected final String TEXT_415 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_431 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_432 = " = conn_";
  protected final String TEXT_433 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_434 = " + \"` WHERE ";
  protected final String TEXT_435 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_436 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_437 = " + \"` (";
  protected final String TEXT_438 = ") VALUES (";
  protected final String TEXT_439 = ")\";" + NL + "\t    ";
  protected final String TEXT_440 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_441 = " = new StringBuffer(insert_";
  protected final String TEXT_442 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_443 = ".insert(insert_";
  protected final String TEXT_444 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_445 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_446 = " =insertStringBuffer_";
  protected final String TEXT_447 = ".toString(); ";
  protected final String TEXT_448 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_452 = " = \"UPDATE `\" + ";
  protected final String TEXT_453 = " + \"` SET ";
  protected final String TEXT_454 = " WHERE ";
  protected final String TEXT_455 = "\";" + NL + "\t    ";
  protected final String TEXT_456 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_457 = " = new StringBuffer(update_";
  protected final String TEXT_458 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_459 = ".insert(update_";
  protected final String TEXT_460 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_461 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_462 = " =updateStringBuffer_";
  ...
  protected final String TEXT_469 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_481 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_497 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_501 = NL + "\t    String delete_";
  protected final String TEXT_502 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_503 = " + \"` WHERE ";
  protected final String TEXT_504 = "\";" + NL + "\t    ";
  protected final String TEXT_505 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_506 = " = new StringBuffer(delete_";
  protected final String TEXT_507 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_508 = ".insert(delete_";
  protected final String TEXT_509 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_510 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_511 = " =deleteStringBuffer_";
  protected final String TEXT_512 = ".toString();  ";
  protected final String TEXT_513 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_514 = " = conn_";
  protected final String TEXT_515 = ".prepareStatement(delete_";
  protected final String TEXT_516 = ");" + NL + "\t    ";
  protected final String TEXT_517 = NL + "\t    String replace_";
  protected final String TEXT_518 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_523 = ".prepareStatement(replace_";
  protected final String TEXT_524 = ");" + NL + "\t    ";
  protected final String TEXT_525 = NL + "\t    String insertIgnore_";
  protected final String TEXT_526 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_527 = " + \"` (";
  protected final String TEXT_528 = ") VALUES (";
  protected final String TEXT_529 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_530 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_531 = " = conn_";
  protected final String TEXT_532 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_533 = ");" + NL + "\t    ";
  protected final String TEXT_534 = NL + "\t    String insert_";
  protected final String TEXT_535 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_536 = " + \"` (";
  protected final String TEXT_537 = ") VALUES (";
  protected final String TEXT_538 = ")\";" + NL + "\t    ";
  protected final String TEXT_539 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_540 = " = new StringBuffer(insert_";
  protected final String TEXT_541 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_542 = ".insert(insert_";
  protected final String TEXT_543 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_544 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_545 = " =insertStringBuffer_";
  protected final String TEXT_546 = ".toString(); ";
  protected final String TEXT_547 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_548 = " = conn_";
  protected final String TEXT_549 = ".prepareStatement(insert_";
  protected final String TEXT_550 = ");" + NL + "\t    ";
  protected final String TEXT_551 = NL + "        StringBuffer query_";
  protected final String TEXT_552 = " = null;" + NL + "       \t";
  protected final String TEXT_553 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_554 = " = insert_";
  protected final String TEXT_555 = ".split(\"\\\\?\");";
  protected final String TEXT_556 = NL + "\t\t\tupdate_";
  protected final String TEXT_557 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_558 = " = update_";
  ...
  protected final String TEXT_562 = " = update_";
  protected final String TEXT_563 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_564 = " = insert_";
  protected final String TEXT_565 = ".split(\"\\\\?\");";
  protected final String TEXT_566 = NL + "\t\t\tdelete_";
  protected final String TEXT_567 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_568 = " = delete_";
  protected final String TEXT_569 = ".split(\"\\\\?\");";
  protected final String TEXT_570 = NL + "\t\t\treplace_";
  protected final String TEXT_571 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_572 = " = replace_";
  protected final String TEXT_573 = ".split(\"\\\\?\");";
  protected final String TEXT_574 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_575 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_576 = " = insertIgnore_";
  ...
  protected final String TEXT_581 = NL + NL + "\tclass BufferLine_";
  ...
  protected final String TEXT_588 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_589 = "(";
  protected final String TEXT_590 = NL + "                                ,";
  protected final String TEXT_591 = NL + "                            ";
  protected final String TEXT_592 = " ";
  protected final String TEXT_593 = NL + "\t\t\t\t, Dynamic ";
  ...
  protected final String TEXT_602 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_603 = "> exInsertColValueList";
  protected final String TEXT_604 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_605 = " exInsertColValue";
  protected final String TEXT_606 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_607 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_608 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_609 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_610 = "=1;";
  protected final String TEXT_611 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_612 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_613 = "=0;";
  protected final String TEXT_614 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_615 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_616 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_617 = " =null;" + NL + "\tint rowCount";
