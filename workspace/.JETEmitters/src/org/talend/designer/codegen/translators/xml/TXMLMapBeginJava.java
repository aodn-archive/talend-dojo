...
public class TXMLMapBeginJava {
  ...
  protected final String TEXT_199 = NL + "\tjava.util.Map<String,Object> valueMap = null;" + NL + "\t" + NL + "\tDocumentGenerateOrderHelper orderHelper = new DocumentGenerateOrderHelper(";
