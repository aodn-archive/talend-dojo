...
public class FooterJava
{
  ...
  protected final String TEXT_48 = NL + "    \t} catch (java.io.IOException ie) {" + NL + "    \t\tSystem.err.println(\"Could not load context \"+contextStr);" + NL + "    \t\tie.printStackTrace();" + NL + "    \t}" + NL + "    \t" + NL + "    \t" + NL + "\t\t// get context value from parent directly" + NL + "\t\tif (parentContextMap != null && !parentContextMap.isEmpty()) {" + NL + "\t\t";
  ...
  protected final String TEXT_60 = NL + NL + NL + NL + "\tlong startUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "\tlong endUsedMemory = 0;" + NL + "\tlong end = 0;" + NL + "\t" + NL + "\tstartTime = System.currentTimeMillis();";
