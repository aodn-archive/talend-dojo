...
public class TLDAPAttributesInputBeginJava
{
  ...
  protected final String TEXT_22 = ".put(\"java.naming.ldap.factory.socket\", \"talend.ssl.AdvancedSocketFactory\");";
  protected final String TEXT_23 = NL + "\ttalend.ssl.AdvancedSocketFactory.alwaysTrust();";
  protected final String TEXT_24 = NL + "\ttalend.ssl.AdvancedSocketFactory.setCertStorePath(";
  protected final String TEXT_25 = ");";
  protected final String TEXT_26 = NL + "\ttalend.ssl.AdvancedSocketFactory.setCertStorePassword(";
  ...
  protected final String TEXT_37 = ".negotiate((javax.net.ssl.SSLSocketFactory)talend.ssl.AdvancedSocketFactory.getDefault());";
