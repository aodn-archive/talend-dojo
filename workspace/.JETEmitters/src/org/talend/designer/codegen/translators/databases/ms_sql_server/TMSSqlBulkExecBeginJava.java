...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_127 = ".equals";
  protected final String TEXT_128 = "IgnoreCase";
  protected final String TEXT_129 = "(";
  protected final String TEXT_130 = ")) {" + NL + "                    whetherExist_";
  protected final String TEXT_131 = " = true;" + NL + "                    break;" + NL + "                }" + NL + "            }" + NL + "            rsTable_";
  ...
  protected final String TEXT_137 = ".createStatement();" + NL + "                    stmtCreate_";
  ...
  protected final String TEXT_144 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_149 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_155 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_156 = ".executeUpdate(\"";
  protected final String TEXT_157 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_158 = ".close();";
  protected final String TEXT_159 = NL + "            java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_166 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_167 = ".executeUpdate(\"";
  protected final String TEXT_168 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_169 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_170 = " += rsTruncCount_";
  protected final String TEXT_171 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_172 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_173 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_174 = ".close();            ";
  protected final String TEXT_175 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_176 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_177 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_178 = NL + "        java.sql.Statement stmtBulkInsert_";
  protected final String TEXT_179 = " = conn_";
  protected final String TEXT_180 = ".createStatement();" + NL + "        stmtBulkInsert_";
  protected final String TEXT_181 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_182 = " + \"] FROM '\" + ";
  protected final String TEXT_183 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_184 = " + \"',DATAFILETYPE='";
  protected final String TEXT_185 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_186 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_187 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_188 = "+\"')\");" + NL + "        stmtBulkInsert_";
  protected final String TEXT_189 = ".close();        ";
  protected final String TEXT_190 = NL + "            int keyCount_";
  protected final String TEXT_191 = " = ";
  protected final String TEXT_192 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_193 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_194 = " = tableName_";
  protected final String TEXT_195 = ";" + NL + "            tableName_";
  protected final String TEXT_196 = " = \"tmp_";
  protected final String TEXT_197 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_198 = " = conn_";
  protected final String TEXT_199 = ".createStatement();" + NL + "            stmtCreateTmp_";
  protected final String TEXT_200 = ".execute(\"";
  protected final String TEXT_201 = ")\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_202 = ".close();" + NL + "            java.sql.Statement stmtTmpBulk_";
  protected final String TEXT_203 = " = conn_";
  protected final String TEXT_204 = ".createStatement();" + NL + "            stmtTmpBulk_";
  protected final String TEXT_205 = ".execute(\"BULK INSERT [\" + tableName_";
  protected final String TEXT_206 = " + \"] FROM '\" + ";
  protected final String TEXT_207 = " + \"' WITH ( CODEPAGE='\" + ";
  protected final String TEXT_208 = " + \"',DATAFILETYPE='";
  protected final String TEXT_209 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_210 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_211 = " + \",ROWTERMINATOR='\" + ";
  protected final String TEXT_212 = "+\"')\");" + NL + "            stmtTmpBulk_";
  protected final String TEXT_213 = ".close();" + NL + "            tableName_";
  ...
  protected final String TEXT_219 = ".createStatement();" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_220 = ".executeUpdate(\"";
  protected final String TEXT_221 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_222 = ".close();" + NL + "            tableName_";
  ...
  protected final String TEXT_230 = NL + "        if(conn_";
  protected final String TEXT_231 = " != null && !conn_";
  protected final String TEXT_232 = ".isClosed()) {" + NL + "            conn_";
