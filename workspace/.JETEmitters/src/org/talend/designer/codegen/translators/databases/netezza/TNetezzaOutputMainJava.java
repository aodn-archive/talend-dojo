...
public class TNetezzaOutputMainJava {
  ...
  protected final String TEXT_24 = ".executeUpdate();" + NL + "                }catch(Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_63 = ".executeUpdate();" + NL + "            }catch(Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_107 = ".executeUpdate();" + NL + "                }catch(Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_131 = ".executeUpdate();" + NL + "                }catch(Exception e)" + NL + "                {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_167 = ";" + NL + "                " + NL + "            }catch(Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_226 = ".executeUpdate();" + NL + "        }catch(Exception e)" + NL + "        {" + NL + "            whetherReject_";
