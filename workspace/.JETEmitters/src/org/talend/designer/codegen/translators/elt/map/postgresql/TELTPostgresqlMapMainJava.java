...
public class TELTPostgresqlMapMainJava
{
  protected static String nl;
  public static synchronized TELTPostgresqlMapMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TELTPostgresqlMapMainJava result = new TELTPostgresqlMapMainJava();
    nl = null;
    return result;
  }
