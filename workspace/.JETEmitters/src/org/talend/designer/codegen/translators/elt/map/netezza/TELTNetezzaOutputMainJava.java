		...
		for(Column colStmt:stmtStructure){
			...
			if(colStmt.isReplaced()){		
				...
				if(colStmt.isAddCol()){
					...
					updateSetStmt.append(colStmt.getName()+"=\"+select_query.replaceFirst(selectQueryColumnsName,selectQueryColumnsName.split(\",\")[ "+ counterOuter + "]).replaceAll(\"SELECT \",\" \")+\"" +suffix);
				}
			}
			counterOuter ++;
		}
