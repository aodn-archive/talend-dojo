...
public class TInformixOutputBeginJava {
  ...
  protected final String TEXT_180 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  ...
  protected final String TEXT_184 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_185 = " = dbMetaData_";
  protected final String TEXT_186 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_187 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_188 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_189 = " = rsTable_";
  protected final String TEXT_190 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  ...
  protected final String TEXT_198 = ".createStatement();";
  ...
  protected final String TEXT_221 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_222 = ".execute(\"";
  protected final String TEXT_223 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_224 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_246 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_247 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_248 = "            ";
  protected final String TEXT_249 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_250 = " = conn_";
  protected final String TEXT_251 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_252 = ".executeUpdate(\"";
  protected final String TEXT_253 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_254 = ".close();";
  protected final String TEXT_255 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_258 = " = stmtTruncCount_";
  protected final String TEXT_259 = ".executeQuery(\"";
  protected final String TEXT_260 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_261 = " = conn_";
  protected final String TEXT_262 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_263 = ".executeUpdate(\"";
  protected final String TEXT_264 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_265 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_266 = " += rsTruncCount_";
  protected final String TEXT_267 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_268 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_269 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_270 = ".close();            ";
  protected final String TEXT_271 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_272 = " = conn_";
  protected final String TEXT_273 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_274 = " = stmtTruncCount_";
  protected final String TEXT_275 = ".executeQuery(\"";
  protected final String TEXT_276 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_277 = " = conn_";
  protected final String TEXT_278 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_279 = ".executeUpdate(\"";
  protected final String TEXT_280 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_281 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_282 = " += rsTruncCount_";
  protected final String TEXT_283 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_284 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_285 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_314 = ");" + NL + "\t    String update_";
  protected final String TEXT_315 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_316 = " + \" SET ";
  protected final String TEXT_317 = " WHERE ";
  protected final String TEXT_318 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_319 = " = conn_";
  protected final String TEXT_320 = ".prepareStatement(update_";
  protected final String TEXT_321 = ");" + NL + "\t    ";
  protected final String TEXT_322 = NL + "\t    String update_";
  protected final String TEXT_323 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_324 = " + \" SET ";
  protected final String TEXT_325 = " WHERE ";
  protected final String TEXT_326 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_327 = " = conn_";
  protected final String TEXT_328 = ".prepareStatement(update_";
  ...
  protected final String TEXT_337 = NL + "\t    String delete_";
  protected final String TEXT_338 = " = \"DELETE  FROM \" + tableName_";
  ...
  protected final String TEXT_342 = ".prepareStatement(delete_";
  protected final String TEXT_343 = ");" + NL + "\t    ";
  protected final String TEXT_344 = NL + "        StringBuffer query_";
  protected final String TEXT_345 = " = null;" + NL + "       \t";
  protected final String TEXT_346 = NL + "\t\t \tString[] insertSQLSplits_";
  ...
  protected final String TEXT_353 = NL + "\t\t\tupdate_";
  protected final String TEXT_354 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_355 = " = update_";
  protected final String TEXT_356 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_357 = " = insert_";
  protected final String TEXT_358 = ".split(\"\\\\?\");";
  protected final String TEXT_359 = NL + "\t\t\tdelete_";
  protected final String TEXT_360 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_361 = " = delete_";
  protected final String TEXT_362 = ".split(\"\\\\?\");";
  protected final String TEXT_363 = NL + "\t\t\treplace_";
  protected final String TEXT_364 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_365 = " = replace_";
  protected final String TEXT_366 = ".split(\"\\\\?\");";
  protected final String TEXT_367 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_368 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_369 = " = insertIgnore_";
  protected final String TEXT_370 = ".split(\"\\\\?\");";
  protected final String TEXT_371 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_372 = " = insert_";
  protected final String TEXT_373 = ".split(\"\\\\?\");";
  protected final String TEXT_374 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_375 = " = ";
  protected final String TEXT_376 = ";" + NL + "        " + NL + "        int commitCounter_";
  protected final String TEXT_377 = " = 0;" + NL + "        ";
  protected final String TEXT_378 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_379 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_380 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
