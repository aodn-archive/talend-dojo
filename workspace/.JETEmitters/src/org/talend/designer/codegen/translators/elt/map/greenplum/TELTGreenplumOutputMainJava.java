...
public class TELTGreenplumOutputMainJava
{
  ...
  protected final String TEXT_20 = NL + "    java.lang.Class.forName(\"org.postgresql.Driver\");    " + NL + "    String url_";
  protected final String TEXT_21 = " = \"jdbc:postgresql://\"+";
  protected final String TEXT_22 = "+\":\"+";
  protected final String TEXT_23 = "+\"/\"+";
  protected final String TEXT_24 = ";    " + NL + "    String dbUser_";
  protected final String TEXT_25 = " = ";
  protected final String TEXT_26 = ";" + NL + "    String dbPwd_";
  protected final String TEXT_27 = " = ";
  protected final String TEXT_28 = ";   " + NL + "    java.sql.Connection conn_";
  ...
  protected final String TEXT_40 = "\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_41 = "+\"(";
  protected final String TEXT_42 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_43 = " = conn_";
  protected final String TEXT_44 = ".prepareStatement(insertQuery);" + NL;
  protected final String TEXT_45 = NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_46 = "+\" SET ";
  protected final String TEXT_47 = " \" +select_query.substring(select_query.indexOf(\"FROM\"));";
  protected final String TEXT_48 = NL + "\t\tif(select_query.indexOf(\"WHERE\")==-1){" + NL + "\t\tupdateQuery +=\"  WHERE \";" + NL + "\t\t}else{" + NL + "\t\tupdateQuery +=\"  AND \";" + NL + "\t\t} " + NL + "\t\tupdateQuery+= ";
  protected final String TEXT_49 = ";";
  protected final String TEXT_50 = NL + "\tpstmt_";
  protected final String TEXT_51 = " = conn_";
  protected final String TEXT_52 = ".prepareStatement(updateQuery);" + NL;
  protected final String TEXT_53 = NL + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_54 = "+\"(";
  protected final String TEXT_55 = ")  (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_56 = " = conn_";
  protected final String TEXT_57 = ".prepareStatement(insertQuery);" + NL + "\t" + NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_58 = "+\" SET (";
  protected final String TEXT_59 = ") = (\"+select_query+\") \"" + NL + "\t";
  protected final String TEXT_60 = NL + "\t+\"  WHERE \" + ";
  protected final String TEXT_61 = NL + "\t";
  protected final String TEXT_62 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_63 = " = conn_";
  protected final String TEXT_64 = ".prepareStatement(updateQuery);" + NL + "\t\t" + NL + "\t";
  protected final String TEXT_65 = NL + NL + "\tString updateQuery = \"UPDATE \"+tableName_";
  protected final String TEXT_66 = "+\" SET (";
  protected final String TEXT_67 = ") = (\"+select_query+\") \"" + NL + "\t";
  ...
  protected final String TEXT_72 = ".prepareStatement(updateQuery);" + NL + "\t\t\t\t\t" + NL + "\tString insertQuery = \"INSERT INTO \"+tableName_";
  protected final String TEXT_73 = "+\"(";
  protected final String TEXT_74 = ") (\"+select_query+\")\";" + NL + "\tpstmt_";
  protected final String TEXT_75 = " = conn_";
  protected final String TEXT_76 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_77 = NL + "\t" + NL + "\tString deleteQuery = \"DELETE  FROM \"+ tableName_";
  protected final String TEXT_78 = "+\" WHERE EXISTS (\"+select_query+\") \" " + NL + "\t";
  protected final String TEXT_79 = NL + "\t+\"  AND \" + ";
  protected final String TEXT_80 = NL + "\t";
  protected final String TEXT_81 = NL + "\t;" + NL + "\tpstmt_";
  protected final String TEXT_82 = " = conn_";
  protected final String TEXT_83 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_84 = NL + "int nb_line_";
  protected final String TEXT_85 = " = 0;" + NL + "int nb_line_update_";
  protected final String TEXT_86 = " = 0;" + NL + "int nb_line_inserted_";
  protected final String TEXT_87 = " = 0;" + NL + "int nb_line_deleted_";
  protected final String TEXT_88 = " = 0;" + NL + "\t";
  protected final String TEXT_89 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "nb_line_inserted_";
  protected final String TEXT_90 = " = pstmt_";
  protected final String TEXT_91 = ".executeUpdate();" + NL + "System.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_92 = " + \" rows inserted. \\n\");" + NL + "" + NL + "\t";
  protected final String TEXT_93 = NL + "System.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "nb_line_update_";
  ...
  protected final String TEXT_97 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_inserted_";
  protected final String TEXT_98 = " = pstmtInsert_";
  protected final String TEXT_99 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_100 = " + \" rows inserted. \\n\");" + NL + "\t}catch(Exception e){" + NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_update_";
  ...
  protected final String TEXT_104 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_update_";
  protected final String TEXT_105 = " = pstmtUpdate_";
  protected final String TEXT_106 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_update_";
  protected final String TEXT_107 = " + \" rows updated. \\n\");\t\t" + NL + "\t}catch(Exception e){" + NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_inserted_";
  ...
  protected final String TEXT_111 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_112 = " = pstmt_";
  protected final String TEXT_113 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_114 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_115 = NL + NL + "if(pstmtUpdate_";
  protected final String TEXT_116 = " != null){" + NL + "" + NL + "\tpstmtUpdate_";
  protected final String TEXT_117 = ".close();" + NL + "\t" + NL + "}else if(pstmt_";
  protected final String TEXT_118 = " != null) {" + NL + "" + NL + "\tpstmt_";
  protected final String TEXT_119 = ".close();" + NL + "\t" + NL + "}" + NL;
  ...
  protected final String TEXT_125 = ".isClosed()) {" + NL + "        conn_";
  ...
  public String generate(Object argument)
  {
	...
	if((dbschema != null) && (!"".equals(dbschema.trim()) && !"\"\"".equals(dbschema.replaceAll(" ", "").trim()))) {
