...
public class TFTPRenameBeginJava
{
  ...
  protected final String TEXT_68 = ");" + NL + "    list";
  protected final String TEXT_69 = ".add(map";
  protected final String TEXT_70 = ");       ";
  protected final String TEXT_71 = NL + NL + "  for (java.util.Map<String, String> map";
  protected final String TEXT_72 = " : list";
  protected final String TEXT_73 = ") {" + NL;
  protected final String TEXT_74 = NL + "  com.enterprisedt.net.ftp.FTPClient ftp_";
  protected final String TEXT_75 = " =null;" + NL;
  protected final String TEXT_76 = NL + "    ftp_";
  protected final String TEXT_77 = " = (com.enterprisedt.net.ftp.FTPClient)globalMap.get(\"";
  protected final String TEXT_78 = "\");";
  protected final String TEXT_79 = "    " + NL + "    ftp_";
  protected final String TEXT_80 = " = new com.enterprisedt.net.ftp.FTPClient();" + NL + "    ftp_";
  protected final String TEXT_81 = ".setRemoteHost(";
  protected final String TEXT_82 = ");" + NL + "    ftp_";
  protected final String TEXT_83 = ".setRemotePort(";
  protected final String TEXT_84 = ");" + NL;
  protected final String TEXT_85 = NL + "      ftp_";
  protected final String TEXT_86 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.ACTIVE);";
  protected final String TEXT_87 = NL + "      ftp_";
  protected final String TEXT_88 = ".setConnectMode(com.enterprisedt.net.ftp.FTPConnectMode.PASV);";
  protected final String TEXT_89 = NL + "    ftp_";
  protected final String TEXT_90 = ".setControlEncoding(";
  protected final String TEXT_91 = ");" + NL + "    ftp_";
  protected final String TEXT_92 = ".connect();  " + NL + "    ftp_";
  protected final String TEXT_93 = ".login(";
  protected final String TEXT_94 = ", ";
  protected final String TEXT_95 = "); ";
  protected final String TEXT_96 = NL + "  java.util.List<java.util.Map<String,String>> list";
  ...
  protected final String TEXT_109 = ");" + NL + "" + NL + "  for (java.util.Map<String, String> map";
