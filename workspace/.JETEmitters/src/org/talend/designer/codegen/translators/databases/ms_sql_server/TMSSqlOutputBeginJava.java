...
public class TMSSqlOutputBeginJava {
  ...
  protected final String TEXT_158 = " = true;" + NL + "\t\t\t\t} catch (Exception e){" + NL + "\t\t\t\t\twhetherExist_";
  ...
  protected final String TEXT_166 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_167 = ", tableNameForSearch_";
  protected final String TEXT_168 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_169 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_170 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_171 = " = true;" + NL + "\t            }" + NL + "\t            rsTable_";
