...
public class TPOPBeginJava
{
  ...
  protected final String TEXT_119 = " = null;" + NL + "\t\tjavax.mail.Address[] addr_";
  protected final String TEXT_120 = "_";
  protected final String TEXT_121 = " = message_";
  protected final String TEXT_122 = ".getAllRecipients();" + NL + "\t\tboolean matcherFind_";
  protected final String TEXT_123 = "_";
  protected final String TEXT_124 = " = false;" + NL + "\t\tfor(int matcher_";
  protected final String TEXT_125 = " = 0;matcher_";
  protected final String TEXT_126 = " < addr_";
  protected final String TEXT_127 = "_";
  protected final String TEXT_128 = ".length;matcher_";
  protected final String TEXT_129 = "++){" + NL + "\t\t\tmatcher_";
  protected final String TEXT_130 = "_";
  protected final String TEXT_131 = " = pattern_";
  protected final String TEXT_132 = "_";
  protected final String TEXT_133 = ".matcher(addr_";
  protected final String TEXT_134 = "_";
  protected final String TEXT_135 = "[matcher_";
  protected final String TEXT_136 = "]==null?\"\":addr_";
  protected final String TEXT_137 = "_";
  protected final String TEXT_138 = "[matcher_";
  protected final String TEXT_139 = "].toString());" + NL + "\t\t\tmatcherFind_";
  protected final String TEXT_140 = "_";
  protected final String TEXT_141 = " = matcher_";
  protected final String TEXT_142 = "_";
  protected final String TEXT_143 = ".find()||matcherFind_";
  protected final String TEXT_144 = "_";
  protected final String TEXT_145 = ";" + NL + "\t\t\tif(matcherFind_";
  protected final String TEXT_146 = "_";
  protected final String TEXT_147 = "){" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "        isMatch_";
  protected final String TEXT_148 = " = isMatch_";
  protected final String TEXT_149 = " ";
  protected final String TEXT_150 = " matcherFind_";
  protected final String TEXT_151 = "_";
  protected final String TEXT_152 = ";";
  protected final String TEXT_153 = NL + "        java.util.Date date_";
  protected final String TEXT_154 = "_";
  protected final String TEXT_155 = " = null;" + NL + "  " + NL + "        try {" + NL + "          date_";
  protected final String TEXT_156 = "_";
  protected final String TEXT_157 = " = ParserUtils.parseTo_Date(";
  protected final String TEXT_158 = ", \"dd-MM-yyyy HH:mm:ss\");" + NL + "        } catch (Exception e){" + NL + "          date_";
  protected final String TEXT_159 = "_";
  protected final String TEXT_160 = " = ParserUtils.parseTo_Date(";
  protected final String TEXT_161 = ", \"dd-MM-yyyy\");" + NL + "        }" + NL + "  " + NL + "        if (date_";
  protected final String TEXT_162 = "_";
  protected final String TEXT_163 = " != null) {" + NL + "          isMatch_";
  protected final String TEXT_164 = " = isMatch_";
  protected final String TEXT_165 = " ";
  protected final String TEXT_166 = " (message_";
  protected final String TEXT_167 = ".getSentDate()!=null && message_";
  protected final String TEXT_168 = ".getSentDate().";
  protected final String TEXT_169 = "before";
  protected final String TEXT_170 = "after";
  protected final String TEXT_171 = "(date_";
  protected final String TEXT_172 = "_";
  protected final String TEXT_173 = "));" + NL + "        }";
  protected final String TEXT_174 = NL + "      if (isMatch_";
  protected final String TEXT_175 = ") {";
  protected final String TEXT_176 = " " + NL + "      message_";
  protected final String TEXT_177 = ".setFlag(javax.mail.Flags.Flag.DELETED, true);";
  protected final String TEXT_178 = NL + "    String filename_";
  protected final String TEXT_179 = " = ";
  protected final String TEXT_180 = ";" + NL + "    java.io.File file_";
  protected final String TEXT_181 = " = new java.io.File(";
  protected final String TEXT_182 = ", filename_";
  protected final String TEXT_183 = ");" + NL + "    java.io.OutputStream os_";
  protected final String TEXT_184 = " = new java.io.FileOutputStream(file_";
  protected final String TEXT_185 = ");" + NL + "    ";
  protected final String TEXT_186 = " " + NL + "    message_";
  protected final String TEXT_187 = ".writeTo(os_";
  protected final String TEXT_188 = ");" + NL + "    os_";
  protected final String TEXT_189 = ".close();" + NL + "    nb_email_";
  protected final String TEXT_190 = "++;" + NL + "    globalMap.put(\"";
  protected final String TEXT_191 = "_CURRENT_FILE\", filename_";
  protected final String TEXT_192 = ");" + NL + "    globalMap.put(\"";
  protected final String TEXT_193 = "_CURRENT_FILEPATH\", file_";
  protected final String TEXT_194 = ".getAbsolutePath());";
