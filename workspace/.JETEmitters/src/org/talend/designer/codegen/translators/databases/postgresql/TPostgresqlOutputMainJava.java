...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_397 = NL + "                            geometryColumnName_";
  protected final String TEXT_398 = " = \"";
  protected final String TEXT_399 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_400 = ") {" + NL + "                                dimension_";
  protected final String TEXT_401 = " = 2;" + NL + "                                " + NL + "                                // A null first geometry will lead to unknown coordinate system  " + NL + "                                if (";
  protected final String TEXT_402 = ".";
  protected final String TEXT_403 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_404 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_405 = " = " + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_406 = ".";
  protected final String TEXT_407 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_408 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_409 = " = refSys_";
  protected final String TEXT_410 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_411 = " = refSys_";
  protected final String TEXT_412 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_413 = " == null || ident_";
  protected final String TEXT_414 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_415 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_416 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_417 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_418 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_419 = " = Integer.parseInt(code_";
  protected final String TEXT_420 = ");" + NL + "                                            }" + NL + "                                        } catch (Exception e) {" + NL + "                                            System.out.println(\"SRID_";
  protected final String TEXT_421 = " could not be determined\");" + NL + "                                            SRID_";
  protected final String TEXT_422 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_423 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_424 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_425 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_426 = ".";
  protected final String TEXT_427 = ", pstmt_";
  protected final String TEXT_428 = ", ";
  protected final String TEXT_429 = ", \"";
  protected final String TEXT_430 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_431 = NL + "                globalMap.put(\"";
  protected final String TEXT_432 = "_QUERY\", query_";
  protected final String TEXT_433 = ".toString().trim());";
  protected final String TEXT_434 = NL + "\t\t\t";
  protected final String TEXT_435 = NL + "    \t\tpstmt_";
  protected final String TEXT_436 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_437 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_438 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_439 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_440 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_441 = NL + "            try {" + NL + "                insertedCount_";
  protected final String TEXT_442 = " = insertedCount_";
  protected final String TEXT_443 = " + pstmt_";
  protected final String TEXT_444 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_445 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_446 = " = true;";
  protected final String TEXT_447 = NL + "                    throw(e);";
  protected final String TEXT_448 = NL + "                        ";
  protected final String TEXT_449 = " = new ";
  protected final String TEXT_450 = "Struct();";
  protected final String TEXT_451 = NL + "                            ";
  protected final String TEXT_452 = ".";
  protected final String TEXT_453 = " = ";
  protected final String TEXT_454 = ".";
  protected final String TEXT_455 = ";";
  protected final String TEXT_456 = NL + "                        rejectedCount_";
  protected final String TEXT_457 = " = rejectedCount_";
  protected final String TEXT_458 = " + 1;";
  protected final String TEXT_459 = NL + "                        ";
  protected final String TEXT_460 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_461 = ";";
  protected final String TEXT_462 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_468 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_469 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_470 = ".";
  protected final String TEXT_471 = ", pstmt_";
  ...
  protected final String TEXT_483 = NL + "                        query_";
  protected final String TEXT_484 = " = ";
  protected final String TEXT_485 = ";";
  protected final String TEXT_486 = NL + "                globalMap.put(\"";
  protected final String TEXT_487 = "_QUERY\", query_";
  protected final String TEXT_488 = ".toString().trim());";
  protected final String TEXT_489 = NL + "    \t\tpstmt_";
  protected final String TEXT_490 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_491 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_492 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_493 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_494 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_495 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_496 = " = updatedCount_";
  protected final String TEXT_497 = " + pstmt_";
  protected final String TEXT_498 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_499 = "++;" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_500 = " = true;";
  protected final String TEXT_501 = NL + "                    throw(e);";
  protected final String TEXT_502 = NL + "                        ";
  protected final String TEXT_503 = " = new ";
  protected final String TEXT_504 = "Struct();";
  protected final String TEXT_505 = NL + "                            ";
  protected final String TEXT_506 = ".";
  protected final String TEXT_507 = " = ";
  protected final String TEXT_508 = ".";
  protected final String TEXT_509 = ";";
  protected final String TEXT_510 = NL + "                        rejectedCount_";
  protected final String TEXT_511 = " = rejectedCount_";
  protected final String TEXT_512 = " + 1;";
  protected final String TEXT_513 = NL + "                        ";
  protected final String TEXT_514 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_515 = ";";
  protected final String TEXT_516 = NL + "                        System.err.print(e.getMessage());";
  ...
  protected final String TEXT_521 = NL + "    " + NL + "            java.sql.ResultSet rs_";
  protected final String TEXT_522 = " = pstmt_";
  protected final String TEXT_523 = ".executeQuery();" + NL + "            int checkCount_";
  protected final String TEXT_524 = " = -1;" + NL + "            while(rs_";
  protected final String TEXT_525 = ".next()) {" + NL + "                checkCount_";
  protected final String TEXT_526 = " = rs_";
  protected final String TEXT_527 = ".getInt(1);" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_528 = " > 0) {";
  protected final String TEXT_529 = NL + "                        ";
  protected final String TEXT_530 = NL + "                            query_";
  protected final String TEXT_531 = " = ";
  protected final String TEXT_532 = ";";
  protected final String TEXT_533 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_534 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_542 = NL + "\t                        query_";
  protected final String TEXT_543 = " = ";
  protected final String TEXT_544 = ";" + NL + "\t                        ";
  protected final String TEXT_545 = NL + "                        ";
  protected final String TEXT_546 = NL + "                            query_";
  protected final String TEXT_547 = " = ";
  protected final String TEXT_548 = ";";
  protected final String TEXT_549 = NL + "                    globalMap.put(\"";
  protected final String TEXT_550 = "_QUERY\", query_";
  protected final String TEXT_551 = ".toString().trim());";
  protected final String TEXT_552 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_553 = " = updatedCount_";
  protected final String TEXT_554 = " + pstmtUpdate_";
  protected final String TEXT_555 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_556 = " = true;";
  protected final String TEXT_557 = NL + "                        throw(e);";
  protected final String TEXT_558 = NL + "                            ";
  protected final String TEXT_559 = " = new ";
  protected final String TEXT_560 = "Struct();";
  protected final String TEXT_561 = NL + "                                ";
  protected final String TEXT_562 = ".";
  protected final String TEXT_563 = " = ";
  protected final String TEXT_564 = ".";
  protected final String TEXT_565 = ";";
  protected final String TEXT_566 = NL + "                            rejectedCount_";
  protected final String TEXT_567 = " = rejectedCount_";
  protected final String TEXT_568 = " + 1;";
  protected final String TEXT_569 = NL + "                            ";
  protected final String TEXT_570 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_571 = ";";
  protected final String TEXT_572 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_573 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_574 = NL + "                        ";
  protected final String TEXT_575 = NL + "                            query_";
  ...
  protected final String TEXT_587 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_588 = " = insertedCount_";
  protected final String TEXT_589 = " + pstmtInsert_";
  protected final String TEXT_590 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_591 = " = true;";
  protected final String TEXT_592 = NL + "                        throw(e);";
  protected final String TEXT_593 = NL + "                            ";
  protected final String TEXT_594 = " = new ";
  protected final String TEXT_595 = "Struct();";
  protected final String TEXT_596 = NL + "                                ";
  protected final String TEXT_597 = ".";
  protected final String TEXT_598 = " = ";
  protected final String TEXT_599 = ".";
  protected final String TEXT_600 = ";";
  protected final String TEXT_601 = NL + "                            rejectedCount_";
  protected final String TEXT_602 = " = rejectedCount_";
  ...
  protected final String TEXT_608 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  protected final String TEXT_609 = "++;";
  protected final String TEXT_610 = NL + "            int updateFlag_";
  protected final String TEXT_611 = "=0;";
  protected final String TEXT_612 = NL + "                    ";
  protected final String TEXT_613 = NL + "                        query_";
  protected final String TEXT_614 = " = ";
  protected final String TEXT_615 = ";";
  protected final String TEXT_616 = NL + "\t\t\t\t" + NL + "\t\t\t\t\tint count_";
  ...
  protected final String TEXT_633 = NL + "                globalMap.put(\"";
  protected final String TEXT_634 = "_QUERY\", query_";
  protected final String TEXT_635 = ".toString().trim());";
  protected final String TEXT_636 = NL + "        " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_637 = "=pstmtUpdate_";
  protected final String TEXT_638 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_639 = " = updatedCount_";
  protected final String TEXT_640 = "+updateFlag_";
  protected final String TEXT_641 = ";" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_652 = NL + "                        rejectedCount_";
  protected final String TEXT_653 = " = rejectedCount_";
  protected final String TEXT_654 = " + 1;";
  protected final String TEXT_655 = NL + "                        ";
  protected final String TEXT_656 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_657 = ";";
  protected final String TEXT_658 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_659 = NL + "            }" + NL + "            if(updateFlag_";
  protected final String TEXT_660 = " == 0) {" + NL + "            \t";
  protected final String TEXT_661 = NL + "\t\t\t\tquery_";
  protected final String TEXT_662 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_663 = NL + "                        ";
  protected final String TEXT_664 = NL + "                            query_";
  protected final String TEXT_665 = " = ";
  protected final String TEXT_666 = ";";
  protected final String TEXT_667 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_676 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_677 = " = insertedCount_";
  protected final String TEXT_678 = " + pstmtInsert_";
  protected final String TEXT_679 = ".executeUpdate();" + NL + "                } catch(Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_694 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_695 = ";";
  protected final String TEXT_696 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_697 = NL + "                }" + NL + "            }" + NL + "            nb_line_";
  ...
  protected final String TEXT_708 = NL + "                globalMap.put(\"";
  protected final String TEXT_709 = "_QUERY\", query_";
  protected final String TEXT_710 = ".toString().trim());";
  protected final String TEXT_711 = NL + "    \t\tpstmt_";
  protected final String TEXT_712 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_713 = "++;    \t\t " + NL + "\t\t\t" + NL + "    \t\t  ";
  protected final String TEXT_714 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_715 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_716 = "    \t\t" + NL + "    \t\t";
  protected final String TEXT_717 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_718 = " = deletedCount_";
  protected final String TEXT_719 = " + pstmt_";
  protected final String TEXT_720 = ".executeUpdate();" + NL + "            } catch(Exception e) {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_731 = NL + "                        rejectedCount_";
  protected final String TEXT_732 = " = rejectedCount_";
  ...
  protected final String TEXT_737 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_738 = NL + "            }";
  protected final String TEXT_739 = NL + "            nb_line_";
  protected final String TEXT_740 = "++;";
  protected final String TEXT_741 = NL + "            if(!whetherReject_";
  ...
  protected final String TEXT_752 = NL + "    \t\t\tif ( batchSize_";
  protected final String TEXT_753 = " <= batchSizeCounter_";
  protected final String TEXT_754 = ") {                ";
  protected final String TEXT_755 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_756 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_757 = ": pstmt_";
  protected final String TEXT_758 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_759 = " += (countEach_";
  protected final String TEXT_760 = " < 0 ? 0 : countEach_";
  protected final String TEXT_761 = ");" + NL + "\t\t\t\t\t\t}                \t" + NL + "\t\t\t\t    \t";
  protected final String TEXT_762 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_763 = " += countSum_";
  protected final String TEXT_764 = "; " + NL + "\t\t\t\t    \t";
  protected final String TEXT_765 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_766 = " += countSum_";
  protected final String TEXT_767 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_768 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_769 = " += countSum_";
  protected final String TEXT_770 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_771 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_772 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_773 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_774 = NL + "                \tint countSum_";
  protected final String TEXT_775 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_776 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_777 = " += (countEach_";
  protected final String TEXT_778 = " < 0 ? 0 : countEach_";
  protected final String TEXT_779 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_780 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_781 = " += countSum_";
  protected final String TEXT_782 = "; " + NL + "\t\t\t    \t";
  protected final String TEXT_783 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_784 = " += countSum_";
  protected final String TEXT_785 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_786 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_787 = " += countSum_";
  protected final String TEXT_788 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_789 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_790 = NL + "                }";
  protected final String TEXT_791 = "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_792 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_793 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_794 = " <= commitCounter_";
  protected final String TEXT_795 = ") {" + NL + "                ";
  protected final String TEXT_796 = NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_797 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_798 = ": pstmt_";
  protected final String TEXT_799 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_800 = " += (countEach_";
  protected final String TEXT_801 = " < 0 ? 0 : countEach_";
  ...
  protected final String TEXT_810 = " += countSum_";
  protected final String TEXT_811 = ";" + NL + "            \t    \t";
  protected final String TEXT_812 = "            \t    " + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_813 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_814 = NL + "                \t\tint countSum_";
  protected final String TEXT_815 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_816 = ": e.getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_817 = " += (countEach_";
  protected final String TEXT_818 = " < 0 ? 0 : countEach_";
  protected final String TEXT_819 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_820 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_821 = " += countSum_";
  protected final String TEXT_822 = "; " + NL + "\t\t\t\t    \t";
  protected final String TEXT_823 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_824 = " += countSum_";
  protected final String TEXT_825 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_826 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_827 = " += countSum_";
  protected final String TEXT_828 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_829 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_830 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_831 = NL + "                \tconn_";
  protected final String TEXT_832 = ".commit();                " + NL + "                \tcommitCounter_";
  protected final String TEXT_833 = "=0;" + NL + "                }\t";
