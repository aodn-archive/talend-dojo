...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_103 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  ...
  protected final String TEXT_114 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_115 = "\",conn_";
  protected final String TEXT_116 = ".getMetaData().getUserName());";
  protected final String TEXT_117 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_118 = "\", ";
  protected final String TEXT_119 = ");";
  protected final String TEXT_120 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_121 = "\",";
  protected final String TEXT_122 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
