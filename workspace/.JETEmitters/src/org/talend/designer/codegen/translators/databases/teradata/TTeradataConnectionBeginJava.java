...
public class TTeradataConnectionBeginJava
{
  ...
  protected final String TEXT_42 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_43 = NL + "\t\t";
  protected final String TEXT_44 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_45 = "\", conn_";
  protected final String TEXT_46 = ");" + NL + "\t}";
  protected final String TEXT_47 = NL + "\tif (null != conn_";
  protected final String TEXT_48 = ") {" + NL + "\t\t";
  protected final String TEXT_49 = NL + "\t}";
  protected final String TEXT_50 = NL + NL + "\tglobalMap.put(\"conn_\" + \"";
  protected final String TEXT_51 = "\",conn_";
  protected final String TEXT_52 = ");" + NL + "\tglobalMap.put(\"host_";
  protected final String TEXT_53 = "\", ";
  protected final String TEXT_54 = ");" + NL + "\tglobalMap.put(\"dbname_";
  protected final String TEXT_55 = "\", ";
  protected final String TEXT_56 = ");" + NL + "\tglobalMap.put(\"username_";
  protected final String TEXT_57 = "\", userName_";
  protected final String TEXT_58 = ");" + NL + "\tglobalMap.put(\"password_";
  protected final String TEXT_59 = "\", password_";
