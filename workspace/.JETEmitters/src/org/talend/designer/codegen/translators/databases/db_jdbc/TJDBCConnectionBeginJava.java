...
public class TJDBCConnectionBeginJava
{
  ...
  protected final String TEXT_47 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_48 = NL + "\t\t";
  protected final String TEXT_49 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_50 = "\", conn_";
  protected final String TEXT_51 = ");" + NL + "\t}";
  protected final String TEXT_52 = NL + "\tif (null != conn_";
  protected final String TEXT_53 = ") {" + NL + "\t\t";
  protected final String TEXT_54 = NL + "\t}";
  protected final String TEXT_55 = NL + "\t" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_56 = "\", conn_";
  protected final String TEXT_57 = ");" + NL + "\tglobalMap.put(\"url_";
  protected final String TEXT_58 = "\", url_";
  protected final String TEXT_59 = ");" + NL + "\t//globalMap.put(\"user_";
  protected final String TEXT_60 = "\", userName_";
  protected final String TEXT_61 = ");" + NL + "\t//globalMap.put(\"pass_";
