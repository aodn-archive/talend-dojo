...
class OptimizeCodeGenerator {
	...
	public OptimizeCodeGenerator (String cid,boolean isOptimizeCode) {
		this.cid = cid;
    			...
    			if(preMetadata!=null){
	                ...
	                if (this.isBeginPart && this.isOptimizeCode) {
						...
						for(IMetadataColumn column :preMetadata.getListColumns()){
							if(columnsCount%100==0){

    stringBuffer.append(TEXT_311);
    stringBuffer.append(incomingConn.getUniqueName());
    stringBuffer.append(TEXT_312);
    stringBuffer.append(columnsCount/100);
    ...
    stringBuffer.append(TEXT_323);
						...
						if(preMetadata.getListColumns().size()>0&&(preMetadata.getListColumns().size()%100)>0){
...
// ------------------- *** Common code end *** ------------------- //
    			...
    			OptimizeCodeGenerator optimizeGen = new OptimizeCodeGenerator(cid, ("true").equals(ElementParameterParser.getValue(node,"__OPTIMIZE_CODE__")));
