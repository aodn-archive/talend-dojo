...
public class TMapBeginJava {
  ...
  protected final String TEXT_134 = "Struct.commonByteArrayLock_";
  protected final String TEXT_135 = "_";
  protected final String TEXT_136 = ") {" + NL + "" + NL + "\t        try {" + NL + "            " + NL + "\t\t\t\tint length = 0;" + NL + "\t\t\t" + NL + "\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t" + NL + "\t\t";
  protected final String TEXT_137 = NL + "\t\t\t            this.";
  protected final String TEXT_138 = "__";
  protected final String TEXT_139 = " = dis.read";
  protected final String TEXT_140 = "();" + NL + "\t\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t            length = dis.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.";
  protected final String TEXT_142 = "__";
  protected final String TEXT_143 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t\t\tif(length > ";
  protected final String TEXT_144 = "Struct.commonByteArray_";
  protected final String TEXT_145 = "_";
  protected final String TEXT_146 = ".length) {" + NL + "           \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_147 = "Struct.commonByteArray_";
  protected final String TEXT_148 = "_";
  protected final String TEXT_149 = ".length == 0) {" + NL + "\t               \t\t\t\t\t";
  protected final String TEXT_150 = "Struct.commonByteArray_";
  protected final String TEXT_151 = "_";
  protected final String TEXT_152 = " = new byte[1024];" + NL + "           \t\t\t\t\t\t} else {" + NL + "\t               \t\t\t\t\t";
  protected final String TEXT_153 = "Struct.commonByteArray_";
  protected final String TEXT_154 = "_";
  protected final String TEXT_155 = " = new byte[2 * length];" + NL + "\t               \t\t\t\t}" + NL + "           \t\t\t\t\t}" + NL + "               \t\t\t\tdis.readFully(";
  protected final String TEXT_156 = "Struct.commonByteArray_";
  protected final String TEXT_157 = "_";
  protected final String TEXT_158 = ", 0, length);" + NL + "               \t\t\t\tthis.";
  ...
  protected final String TEXT_163 = ", 0, length);" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_168 = " = new Date(dis.readLong());" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t            length = dis.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.";
  protected final String TEXT_170 = "__";
  protected final String TEXT_171 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "               \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "               \t\t\t\tdis.readFully(byteArray);" + NL + "               \t\t\t\tthis.";
  protected final String TEXT_172 = "__";
  protected final String TEXT_173 = " = byteArray;" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_174 = NL + "\t\t\t\t\t\tthis.";
  protected final String TEXT_175 = "__";
  protected final String TEXT_176 = " = (";
  protected final String TEXT_177 = ") dis.readObject();" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_178 = NL + "\t\t\t            length = dis.readByte();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.";
  protected final String TEXT_179 = "__";
  protected final String TEXT_180 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t\t\tthis.";
  protected final String TEXT_181 = "__";
  protected final String TEXT_182 = " = dis.read";
  protected final String TEXT_183 = "();" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_184 = NL + "\t\t\t            this.exprKey_";
  protected final String TEXT_185 = "__";
  protected final String TEXT_186 = " = dis.read";
  protected final String TEXT_187 = "();" + NL + "\t\t\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t            length = dis.readByte();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_189 = "__";
  protected final String TEXT_190 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t    \tthis.exprKey_";
  protected final String TEXT_191 = "__";
  protected final String TEXT_192 = " = new Date(dis.readLong());" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_193 = NL + "\t\t\t            length = dis.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_194 = "__";
  protected final String TEXT_195 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t\t\tif(length > ";
  protected final String TEXT_196 = "Struct.commonByteArray_";
  protected final String TEXT_197 = "_";
  protected final String TEXT_198 = ".length) {" + NL + "           \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_199 = "Struct.commonByteArray_";
  protected final String TEXT_200 = "_";
  protected final String TEXT_201 = ".length == 0) {" + NL + "\t               \t\t\t\t\t";
  protected final String TEXT_202 = "Struct.commonByteArray_";
  protected final String TEXT_203 = "_";
  protected final String TEXT_204 = " = new byte[1024];" + NL + "           \t\t\t\t\t\t} else {" + NL + "\t               \t\t\t\t\t";
  protected final String TEXT_205 = "Struct.commonByteArray_";
  protected final String TEXT_206 = "_";
  protected final String TEXT_207 = " = new byte[2 * length];" + NL + "\t               \t\t\t\t}" + NL + "           \t\t\t\t\t}" + NL + "               \t\t\t\tdis.readFully(";
  protected final String TEXT_208 = "Struct.commonByteArray_";
  protected final String TEXT_209 = "_";
  protected final String TEXT_210 = ", 0, length);" + NL + "               \t\t\t\tthis.exprKey_";
  protected final String TEXT_211 = "__";
  protected final String TEXT_212 = " = new String(";
  protected final String TEXT_213 = "Struct.commonByteArray_";
  protected final String TEXT_214 = "_";
  protected final String TEXT_215 = ", 0, length);" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_216 = NL + "\t\t\t            length = dis.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_217 = "__";
  protected final String TEXT_218 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "               \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "               \t\t\t\tdis.readFully(byteArray);" + NL + "               \t\t\t\tthis.exprKey_";
  protected final String TEXT_219 = "__";
  protected final String TEXT_220 = " = byteArray;" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_221 = NL + "           \t\t\t\tthis.exprKey_";
  protected final String TEXT_222 = "__";
  protected final String TEXT_223 = " = (";
  protected final String TEXT_224 = ") dis.readObject();" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_225 = NL + "\t\t\t            length = dis.readByte();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_226 = "__";
  protected final String TEXT_227 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t\t\tthis.exprKey_";
  protected final String TEXT_228 = "__";
  protected final String TEXT_229 = " = dis.read";
  protected final String TEXT_230 = "();" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_231 = NL + "        \t} catch (IOException e) {" + NL + "\t            throw new RuntimeException(e);";
  protected final String TEXT_232 = NL + NL + "\t\t";
  protected final String TEXT_233 = NL + "\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t";
  protected final String TEXT_234 = NL + NL + "        }" + NL + "        " + NL + "      } " + NL + "    }" + NL + "" + NL + "    public void writeData(ObjectOutputStream dos) {" + NL + "        try {" + NL + "" + NL + "           \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "" + NL + "\t\t";
  protected final String TEXT_235 = NL + "\t\t            \tdos.write";
  protected final String TEXT_236 = "(this.";
  protected final String TEXT_237 = "__";
  protected final String TEXT_238 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t\t\t\tif(this.";
  protected final String TEXT_240 = "__";
  protected final String TEXT_241 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.";
  ...
  protected final String TEXT_244 = NL + "\t\t\t\t\t\tif(this.";
  protected final String TEXT_245 = "__";
  protected final String TEXT_246 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \tdos.writeLong(this.";
  ...
  protected final String TEXT_251 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_252 = "__";
  protected final String TEXT_253 = ".length);" + NL + "               \t\t\t\tdos.write(this.";
  ...
  protected final String TEXT_265 = NL + "\t\t            \tdos.write";
  protected final String TEXT_266 = "(this.exprKey_";
  protected final String TEXT_267 = "__";
  protected final String TEXT_268 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_269 = NL + "\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_270 = "__";
  protected final String TEXT_271 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_272 = "__";
  protected final String TEXT_273 = ".getBytes();" + NL + "           \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "               \t\t\t\tdos.write(byteArray);" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_274 = NL + "\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_275 = "__";
  protected final String TEXT_276 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_277 = "__";
  protected final String TEXT_278 = ".getTime());" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_279 = NL + "\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_280 = "__";
  protected final String TEXT_281 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_282 = "__";
  protected final String TEXT_283 = ".length);" + NL + "               \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_284 = "__";
  protected final String TEXT_285 = ");" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_286 = NL + "       \t\t\t    \tdos.writeObject(this.exprKey_";
  ...
  protected final String TEXT_291 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \tdos.write";
  protected final String TEXT_292 = "(this.exprKey_";
  protected final String TEXT_293 = "__";
  protected final String TEXT_294 = ");" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_295 = NL + "        \t} catch (IOException e) {" + NL + "\t            throw new RuntimeException(e);";
  protected final String TEXT_296 = NL + "        }" + NL + "    }" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t} // G_TM_B_001" + NL + "\t" + NL + "\t";
  protected final String TEXT_297 = NL + "\t" + NL + "" + NL + "\torg.talend.designer.components.lookup.persistent.PersistentRowSorterIterator<SortableRow_";
  protected final String TEXT_298 = "> fsi_";
  protected final String TEXT_299 = " = " + NL + "\t\tnew org.talend.designer.components.lookup.persistent.PersistentRowSorterIterator<SortableRow_";
  protected final String TEXT_300 = ">(" + NL + "\t\t\t";
  protected final String TEXT_301 = " + \"/\"+ jobName +\"_tMapData_\" + pid +\"_";
  protected final String TEXT_302 = "\", ";
  protected final String TEXT_303 = ") {" + NL + "\t\t\tpublic SortableRow_";
  protected final String TEXT_304 = " createRowInstance() {" + NL + "\t\t\t\treturn new SortableRow_";
  protected final String TEXT_305 = "();" + NL + "\t\t\t}" + NL + "\t\t};" + NL + "\t" + NL + "\tfsi_";
  protected final String TEXT_306 = ".initPut();" + NL + "" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_307 = "        " + NL + "        " + NL + "" + NL + "" + NL + "" + NL + "        " + NL + NL + NL + NL + NL + NL + NL + NL;
