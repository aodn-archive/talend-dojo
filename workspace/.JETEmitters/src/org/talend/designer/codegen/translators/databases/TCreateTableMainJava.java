...
public class TCreateTableMainJava
{
  ...
  protected final String TEXT_13 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_14 = " = dbMetaData_";
  protected final String TEXT_15 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_16 = ", tableNameForSearch_";
  protected final String TEXT_17 = ", new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_18 = " = false;" + NL + "\t            if(rsTable_";
  protected final String TEXT_19 = ".next()) {" + NL + "\t            \twhetherExist_";
  protected final String TEXT_20 = " = true;" + NL + "\t            }     ";
  protected final String TEXT_21 = NL + "\t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_22 = " = conn_";
  protected final String TEXT_23 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_24 = " = dbMetaData_";
  protected final String TEXT_25 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_26 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_27 = ".next()) {" + NL + "\t                String table_";
  protected final String TEXT_28 = " = rsTable_";
  protected final String TEXT_29 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_30 = ".equals";
  protected final String TEXT_31 = "IgnoreCase";
  protected final String TEXT_32 = "(";
  protected final String TEXT_33 = ")) {" + NL + "\t                    whetherExist_";
  protected final String TEXT_34 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }     ";
  protected final String TEXT_35 = NL + "                if(!whetherExist_";
  protected final String TEXT_36 = ") {" + NL + "                    java.sql.Statement stmt_";
  protected final String TEXT_37 = " = conn_";
  protected final String TEXT_38 = ".createStatement();" + NL + "                    stmt_";
  ...
  protected final String TEXT_49 = ".createStatement();" + NL + "                stmt_";
  protected final String TEXT_50 = ".execute(\"";
  protected final String TEXT_51 = "\");            " + NL + "\t            ";
  protected final String TEXT_52 = NL + "        ";
  protected final String TEXT_53 = NL + "        globalMap.put(\"";
  protected final String TEXT_54 = "_QUERY\", \"";
  protected final String TEXT_55 = "\");        " + NL + "    } catch(Exception e) {" + NL + "        globalMap.put(\"";
  protected final String TEXT_56 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "        throw new RuntimeException(\"Creating table failed\", e);" + NL + "    }";
...
if(columnList != null && columnList.size() > 0) {
    ...
    if("DB2".equalsIgnoreCase(dbType)||"POSTGRE".equalsIgnoreCase(dbType)||"POSTGREPLUS".equalsIgnoreCase(dbType)){
