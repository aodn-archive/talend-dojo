...
public class TDB2BulkExecBeginJava {
  ...
  protected final String TEXT_102 = "IgnoreCase";
  ...
  protected final String TEXT_154 = NL + "        String action_";
  protected final String TEXT_155 = " = \"";
  protected final String TEXT_156 = "\";" + NL + "        java.sql.CallableStatement callStmt_";
  protected final String TEXT_157 = " = null;" + NL + "        String sql_";
  protected final String TEXT_158 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        String param_";
  protected final String TEXT_159 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_160 = " + \"\\\" OF ";
  protected final String TEXT_161 = " DEL MODIFIED BY COLDEL\"+ ";
  protected final String TEXT_162 = " + " + NL + "        \t\t\t\t\" dateformat=\\\"\"+ ";
  protected final String TEXT_163 = "+ \"\\\" timeformat=\\\"\" + ";
  protected final String TEXT_164 = "+ \"\\\" timestampformat=\\\"\"+";
  protected final String TEXT_165 = " +\"\\\" ";
  protected final String TEXT_166 = " \" +" + NL + "        \t\t\t\t action_";
  protected final String TEXT_167 = " +\" INTO \\\"\"  + tableName_";
  protected final String TEXT_168 = " + \"\\\" ";
  protected final String TEXT_169 = "\";     \t\t\t" + NL + "        callStmt_";
  protected final String TEXT_170 = " = conn_";
  protected final String TEXT_171 = ".prepareCall(sql_";
  protected final String TEXT_172 = ");" + NL + "        callStmt_";
  protected final String TEXT_173 = ".setString(1, param_";
  protected final String TEXT_174 = ");" + NL + "        callStmt_";
  protected final String TEXT_175 = ".execute();        " + NL + "        callStmt_";
  protected final String TEXT_176 = ".close();";
  protected final String TEXT_177 = NL + "            int keyCount_";
  protected final String TEXT_178 = " = ";
  protected final String TEXT_179 = ";" + NL + "            if(keyCount_";
  protected final String TEXT_180 = " == 0) {" + NL + "                throw new RuntimeException(\"For bulk update, Schema must have a key at least.\"); " + NL + "            }" + NL + "            String tmpTableName_";
  protected final String TEXT_181 = " = tableName_";
  protected final String TEXT_182 = ";" + NL + "            tableName_";
  protected final String TEXT_183 = " = \"tmp_";
  protected final String TEXT_184 = "\" + \"_\" + pid; " + NL + "            java.sql.Statement stmtCreateTmp_";
  protected final String TEXT_185 = " = conn_";
  protected final String TEXT_186 = ".createStatement();" + NL + "            " + NL + "" + NL + "            " + NL + "            stmtCreateTmp_";
  protected final String TEXT_187 = ".execute(\"";
  protected final String TEXT_188 = "\");" + NL + "            stmtCreateTmp_";
  protected final String TEXT_189 = ".close();" + NL + "                        " + NL + "        \tjava.sql.CallableStatement callStmt_";
  protected final String TEXT_190 = " = null;" + NL + "        \tString sql_";
  protected final String TEXT_191 = " = \"CALL SYSPROC.ADMIN_CMD(?)\";" + NL + "        \tString param_";
  protected final String TEXT_192 = " = \"LOAD FROM \\\"\"+ fileName_";
  protected final String TEXT_193 = ".replace(\"\\\\\",\"/\") + \"\\\" OF ";
  protected final String TEXT_194 = " DEL MODIFIED BY COLDEL\" + ";
  protected final String TEXT_195 = " + " + NL + "        \t\t\t\t\t\t\t\" dateformat=\\\"\"+";
  protected final String TEXT_196 = "+\"\\\" timeformat=\\\"\" +";
  protected final String TEXT_197 = "+ \"\\\" timestampformat=\\\"\" + ";
  protected final String TEXT_198 = "+\"\\\"\" + " + NL + "        \t\t\t\t\t\t\t\" ";
  protected final String TEXT_199 = " INSERT INTO \\\"\"  + tableName_";
  protected final String TEXT_200 = " + \"\\\" ";
  protected final String TEXT_201 = "\"; \t        \t\t\t" + NL + "        \t" + NL + "        \tcallStmt_";
  protected final String TEXT_202 = " = conn_";
  protected final String TEXT_203 = ".prepareCall(sql_";
  protected final String TEXT_204 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_205 = ".setString(1, param_";
  protected final String TEXT_206 = ");" + NL + "        \tcallStmt_";
  protected final String TEXT_207 = ".execute();        " + NL + "        \tcallStmt_";
  protected final String TEXT_208 = ".close();            " + NL + "                    \t\t\t" + NL + "            tableName_";
  protected final String TEXT_209 = " = tmpTableName_";
  protected final String TEXT_210 = ";" + NL + "            tmpTableName_";
  protected final String TEXT_211 = " = \"tmp_";
  protected final String TEXT_212 = "\"+ \"_\" + pid;             " + NL + "            java.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_213 = " = conn_";
  protected final String TEXT_214 = ".createStatement();" + NL + "                        " + NL + "            stmtUpdateBulk_";
  protected final String TEXT_215 = ".executeUpdate(\"";
  protected final String TEXT_216 = "\");" + NL + "            stmtUpdateBulk_";
  protected final String TEXT_217 = ".close();           " + NL + "            " + NL + "            tableName_";
  protected final String TEXT_218 = " = \"tmp_";
  protected final String TEXT_219 = "\" + \"_\" + pid;" + NL + "            java.sql.Statement stmtTmpDrop_";
  protected final String TEXT_220 = " = conn_";
  protected final String TEXT_221 = ".createStatement();" + NL + "            stmtTmpDrop_";
  protected final String TEXT_222 = ".execute(\"";
  protected final String TEXT_223 = "\");" + NL + "            stmtTmpDrop_";
  protected final String TEXT_224 = ".close();";
  protected final String TEXT_225 = NL + NL + NL + NL + NL + NL;
