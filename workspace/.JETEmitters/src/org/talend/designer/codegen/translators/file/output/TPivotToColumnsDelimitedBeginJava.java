...
public class TPivotToColumnsDelimitedBeginJava {
  ...
  protected final String TEXT_46 = NL + NL + "\tString lineSeparator_";
  protected final String TEXT_47 = " = (String) java.security.AccessController.doPrivileged(" + NL + "\t\tnew sun.security.action.GetPropertyAction(\"line.separator\"));" + NL + "    char quotechar_";
  protected final String TEXT_48 = " = '";
  protected final String TEXT_49 = "';" + NL + "    char escape_";
  protected final String TEXT_50 = " = '\\\\';" + NL + "    ";
  protected final String TEXT_51 = NL + "    lineSeparator_";
  protected final String TEXT_52 = " = \"";
  protected final String TEXT_53 = "\";";
  protected final String TEXT_54 = NL;
  protected final String TEXT_55 = NL;
  protected final String TEXT_56 = NL + "    escape_";
  protected final String TEXT_57 = " = quotechar_";
  protected final String TEXT_58 = ";";
  protected final String TEXT_59 = NL + "    " + NL + "\tcom.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_60 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "            new java.io.FileOutputStream(fileName_";
  protected final String TEXT_61 = ", false), ";
  protected final String TEXT_62 = ")), '";
  protected final String TEXT_63 = "',quotechar_";
  protected final String TEXT_64 = ",escape_";
  protected final String TEXT_65 = ",lineSeparator_";
  protected final String TEXT_66 = ");";
  protected final String TEXT_67 = NL + NL + NL + "java.io.File file";
  protected final String TEXT_68 = " = new java.io.File(fileName_";
  protected final String TEXT_69 = ");" + NL + "" + NL + "boolean pivot_Exists";
  protected final String TEXT_70 = " = false;" + NL + "" + NL + "StringBuilder pivot_Key";
  protected final String TEXT_71 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<String> pivot_Keys";
  protected final String TEXT_72 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "boolean group_Exists";
  protected final String TEXT_73 = " = false;" + NL + "" + NL + "StringBuilder group_Key";
  protected final String TEXT_74 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<java.util.List<String>> group_Keys";
  protected final String TEXT_75 = " = new java.util.ArrayList<java.util.List<String>>();" + NL + "" + NL + "java.util.List<String> gKvalue";
  protected final String TEXT_76 = " = null;" + NL + "" + NL + "java.util.List<String> aggValues";
  protected final String TEXT_77 = " = null;" + NL + "" + NL + "java.util.Map<java.util.List<String>,java.util.List<String>> aggregation";
  protected final String TEXT_78 = " = new java.util.HashMap<java.util.List<String>,java.util.List<String>>();" + NL;
