...
public class TMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_26 = NL + "\t\tString properties_";
  protected final String TEXT_27 = " = ";
  protected final String TEXT_28 = ";" + NL + "\t\tif (properties_";
  protected final String TEXT_29 = " == null || properties_";
  protected final String TEXT_30 = ".trim().length() == 0) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_31 = " += \"rewriteBatchedStatements=true\";" + NL + "\t\t}else if (properties_";
  protected final String TEXT_32 = " != null && !properties_";
  protected final String TEXT_33 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  ...
  protected final String TEXT_38 = " + \"?\" + properties_";
  ...
  protected final String TEXT_49 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_50 = NL + "\t\t";
  protected final String TEXT_51 = NL + "\t\tglobalMap.put(\"conn_";
  ...
  protected final String TEXT_59 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
