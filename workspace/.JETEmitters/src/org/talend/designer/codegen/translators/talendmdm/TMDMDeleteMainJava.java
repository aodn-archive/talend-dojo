...
public class TMDMDeleteMainJava
{
  ...
  protected final String TEXT_43 = ".size() > 0){" + NL + "\t\twsItem_";
  ...
  protected final String TEXT_46 = ".size()]),null);" + NL + "\t}" + NL + "\ttry{" + NL + "\t\torg.talend.mdm.webservice.WSDeleteItems items_";
  protected final String TEXT_47 = " = new org.talend.mdm.webservice.WSDeleteItems(dataCluster_";
  protected final String TEXT_48 = ",";
  protected final String TEXT_49 = ",wsItem_";
  protected final String TEXT_50 = ",";
  protected final String TEXT_51 = ",false);" + NL + "\t\txtentisWS_";
  protected final String TEXT_52 = ".deleteItems(items_";
  protected final String TEXT_53 = ");" + NL + "\t}catch(Exception e_";
