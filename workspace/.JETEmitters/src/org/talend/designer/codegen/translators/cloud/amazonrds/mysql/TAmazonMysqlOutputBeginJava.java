...
public class TAmazonMysqlOutputBeginJava {
  ...
  protected final String TEXT_183 = ".trim().length() ==0)) {" + NL + "\t                    whetherExist_";
  ...
  protected final String TEXT_194 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_195 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_202 = ".createStatement();";
  ...
  protected final String TEXT_221 = ".close();            " + NL + "                }                ";
  ...
  protected final String TEXT_225 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_226 = ".execute(\"";
  protected final String TEXT_227 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_228 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_250 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_251 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_252 = "            ";
  protected final String TEXT_253 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_254 = " = conn_";
  protected final String TEXT_255 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_256 = ".executeUpdate(\"";
  protected final String TEXT_257 = "\");" + NL + "            stmtClear_";
  ...
  protected final String TEXT_275 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_276 = " = conn_";
  protected final String TEXT_277 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_278 = " = stmtTruncCount_";
  protected final String TEXT_279 = ".executeQuery(\"";
  protected final String TEXT_280 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_281 = " = conn_";
  protected final String TEXT_282 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_283 = ".executeUpdate(\"";
  protected final String TEXT_284 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_285 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_286 = " += rsTruncCount_";
  protected final String TEXT_287 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_288 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_289 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_290 = ".close();";
  protected final String TEXT_291 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_292 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");\t" + NL + "\t\t\t\t";
  protected final String TEXT_293 = NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_294 = ".append(\",\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_295 = "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_296 = ".append (\"`\" +  ";
  protected final String TEXT_297 = " + \"`\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_298 = ".append (\"=\");" + NL + "\t\t\t\t\t\tduplidateClause_";
  protected final String TEXT_299 = ".append (";
  protected final String TEXT_300 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_301 = NL + "\t\t\t\t       ";
  protected final String TEXT_302 = NL + "\t\t        String insert_";
  protected final String TEXT_303 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_304 = " + \"` (";
  protected final String TEXT_305 = ") VALUES (";
  protected final String TEXT_306 = ")\";";
  protected final String TEXT_307 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_308 = " += \tduplidateClause_";
  protected final String TEXT_309 = ".toString();";
  protected final String TEXT_310 = NL + "\t\t\t\t";
  protected final String TEXT_311 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_312 = " = new StringBuffer(insert_";
  protected final String TEXT_313 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_314 = ".insert(insert_";
  protected final String TEXT_315 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_316 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_317 = " =insertStringBuffer_";
  protected final String TEXT_318 = ".toString(); ";
  protected final String TEXT_319 = "    " + NL;
  protected final String TEXT_320 = NL + "                        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_326 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_327 = " = conn_";
  protected final String TEXT_328 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_329 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_330 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_331 = ",insert_";
  protected final String TEXT_332 = ",keyPsmt_";
  protected final String TEXT_333 = ");";
  protected final String TEXT_334 = NL + "\t        \t        ";
  protected final String TEXT_335 = "\t            " + NL + "\t            class BufferLine_";
  protected final String TEXT_336 = " {" + NL + "    \t            ";
  protected final String TEXT_337 = NL + "                            ";
  protected final String TEXT_338 = " ";
  protected final String TEXT_339 = ";                ";
  protected final String TEXT_340 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  protected final String TEXT_341 = "(";
  protected final String TEXT_342 = NL + "                                ,";
  protected final String TEXT_343 = NL + "                            ";
  protected final String TEXT_344 = " ";
  protected final String TEXT_345 = " " + NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_346 = NL + "                                this.";
  protected final String TEXT_347 = " = ";
  protected final String TEXT_348 = ";              ";
  protected final String TEXT_349 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "\t            " + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_350 = "> exInsertColValueList";
  protected final String TEXT_351 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_352 = " exInsertColValue";
  protected final String TEXT_353 = " = null; " + NL + "\t            " + NL + "\t            " + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_354 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_355 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_356 = ".append(\"(";
  protected final String TEXT_357 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_358 = "-1) extendInsertValueStmt_";
  protected final String TEXT_359 = ".append(\",\");" + NL + "                }" + NL + "               " + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_360 = " = \"INSERT INTO `\"+";
  protected final String TEXT_361 = "+\"` (";
  protected final String TEXT_362 = ") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_363 = ".toString();";
  protected final String TEXT_364 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_365 = " += \tduplidateClause_";
  protected final String TEXT_366 = ".toString();";
  protected final String TEXT_367 = NL + "\t\t\t\t";
  protected final String TEXT_368 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_369 = " = new StringBuffer(insert_";
  protected final String TEXT_370 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_371 = ".insert(insert_";
  protected final String TEXT_372 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_373 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_374 = " =insertStringBuffer_";
  ...
  protected final String TEXT_378 = ".prepareStatement(insert_";
  protected final String TEXT_379 = ");" + NL + "\t            " + NL + "\t            String insertColName";
  protected final String TEXT_380 = " = \"";
  protected final String TEXT_381 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_382 = " =  \"";
  protected final String TEXT_383 = "\"; " + NL + "\t            int rowCount";
  protected final String TEXT_384 = " = 0;\t ";
  protected final String TEXT_385 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_386 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_387 = " + \"` (";
  protected final String TEXT_388 = ") VALUES (";
  protected final String TEXT_389 = ")\";";
  protected final String TEXT_390 = "            " + NL + "\t\t\t\tinsert_";
  protected final String TEXT_391 = " += \tduplidateClause_";
  protected final String TEXT_392 = ".toString();";
  protected final String TEXT_393 = NL + "\t\t        int batchSize_";
  protected final String TEXT_394 = " = ";
  protected final String TEXT_395 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_396 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_397 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_398 = " = new StringBuffer(insert_";
  protected final String TEXT_399 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_400 = ".insert(insert_";
  protected final String TEXT_401 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_402 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_403 = " =insertStringBuffer_";
  protected final String TEXT_404 = ".toString(); ";
  protected final String TEXT_405 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_410 = " = \"UPDATE `\" + ";
  ...
  protected final String TEXT_422 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_428 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_429 = " + \"` WHERE ";
  protected final String TEXT_430 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_431 = " = \"INSERT INTO `\" + ";
  ...
  protected final String TEXT_447 = " = \"UPDATE `\" + ";
  protected final String TEXT_448 = " + \"` SET ";
  protected final String TEXT_449 = " WHERE ";
  protected final String TEXT_450 = "\";" + NL + "\t    ";
  protected final String TEXT_451 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_452 = " = new StringBuffer(update_";
  protected final String TEXT_453 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_454 = ".insert(update_";
  protected final String TEXT_455 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_456 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_457 = " =updateStringBuffer_";
  protected final String TEXT_458 = ".toString(); ";
  protected final String TEXT_459 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_464 = " = \"UPDATE `\" + ";
  protected final String TEXT_465 = " + \"` SET ";
  protected final String TEXT_466 = " WHERE ";
  protected final String TEXT_467 = "\";" + NL + "\t    ";
  protected final String TEXT_468 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_469 = " = new StringBuffer(update_";
  protected final String TEXT_470 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_471 = ".insert(update_";
  protected final String TEXT_472 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_473 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_474 = " =updateStringBuffer_";
  protected final String TEXT_475 = ".toString(); ";
  protected final String TEXT_476 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_492 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_496 = NL + "\t    String delete_";
  protected final String TEXT_497 = " = \"DELETE  FROM `\" + ";
  protected final String TEXT_498 = " + \"` WHERE ";
  protected final String TEXT_499 = "\";" + NL + "\t    ";
  protected final String TEXT_500 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_501 = " = new StringBuffer(delete_";
  protected final String TEXT_502 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_503 = ".insert(delete_";
  protected final String TEXT_504 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_505 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_506 = " =deleteStringBuffer_";
  protected final String TEXT_507 = ".toString();  ";
  protected final String TEXT_508 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_509 = " = conn_";
  protected final String TEXT_510 = ".prepareStatement(delete_";
  protected final String TEXT_511 = ");" + NL + "\t    ";
  protected final String TEXT_512 = NL + "\t    String replace_";
  protected final String TEXT_513 = " = \"REPLACE INTO `\" + ";
  ...
  protected final String TEXT_518 = ".prepareStatement(replace_";
  protected final String TEXT_519 = ");" + NL + "\t    ";
  protected final String TEXT_520 = NL + "\t    String insertIgnore_";
  protected final String TEXT_521 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_522 = " + \"` (";
  protected final String TEXT_523 = ") VALUES (";
  protected final String TEXT_524 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_525 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_526 = " = conn_";
  protected final String TEXT_527 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_528 = ");" + NL + "\t    ";
  protected final String TEXT_529 = NL + "\t    String insert_";
  protected final String TEXT_530 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_531 = " + \"` (";
  protected final String TEXT_532 = ") VALUES (";
  protected final String TEXT_533 = ")\";" + NL + "\t    ";
  protected final String TEXT_534 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_535 = " = new StringBuffer(insert_";
  protected final String TEXT_536 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_537 = ".insert(insert_";
  protected final String TEXT_538 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_539 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_540 = " =insertStringBuffer_";
  ...
  protected final String TEXT_576 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_577 = " {" + NL + "    \t            ";
  protected final String TEXT_578 = NL + "                            ";
  protected final String TEXT_579 = " ";
  protected final String TEXT_580 = ";                ";
  protected final String TEXT_581 = NL + "\t\t\t\tDynamic ";
  protected final String TEXT_582 = ";" + NL + "\t\t\t";
  protected final String TEXT_583 = "   " + NL + "\t            " + NL + "\t                public BufferLine_";
  ...
  protected final String TEXT_594 = NL + "\t\t\t\tthis.";
  protected final String TEXT_595 = "=";
  protected final String TEXT_596 = ";" + NL + "\t\t\t";
  protected final String TEXT_597 = "   \t                " + NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_598 = "> exInsertColValueList";
  protected final String TEXT_599 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_600 = " exInsertColValue";
  protected final String TEXT_601 = " = null; " + NL + "\t\t    String insert_";
  protected final String TEXT_602 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_603 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_604 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_605 = "=1;";
  protected final String TEXT_606 = NL + NL + NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_607 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_608 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_609 = " =null;" + NL + "\tint batchSizeCounter_";
  protected final String TEXT_610 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_611 = "=0;" + NL + "\tint rowCount";
