...
public class TIngresInputBeginJava
{
  ...
  protected final String TEXT_96 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_97 = ") {" + NL + "\t\t\t\t\tjava.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_98 = " = dataSources.get(\"";
  protected final String TEXT_99 = "\").getConnection();" + NL + "\t\t\t\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_202 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_203 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_204 = " = ";
  protected final String TEXT_205 = "; i_";
  protected final String TEXT_206 = "  <= rsmd_";
  protected final String TEXT_207 = ".getColumnCount(); i_";
  protected final String TEXT_208 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_209 = ".getColumnTypeName(i_";
  protected final String TEXT_210 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_211 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_212 = ".getClob(i_";
  protected final String TEXT_213 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_214 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_215 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_216 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_217 = ".add(tNTextImpl_";
  protected final String TEXT_218 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_219 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_220 = ".";
  protected final String TEXT_221 = ", rs_";
  protected final String TEXT_222 = ", fixedColumnCount_";
