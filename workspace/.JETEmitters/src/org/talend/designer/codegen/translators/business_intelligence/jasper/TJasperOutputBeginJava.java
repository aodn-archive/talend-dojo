...
public class TJasperOutputBeginJava
{
  ...
  protected final String TEXT_14 = ".createNewFile();" + NL + "    }" + NL + "    " + NL + "    String lineSeparator_";
  protected final String TEXT_15 = " = (String) java.security.AccessController.doPrivileged(" + NL + "\t\tnew sun.security.action.GetPropertyAction(\"line.separator\"));" + NL + "    " + NL + "    com.talend.csv.CSVWriter CsvWriter_";
  protected final String TEXT_16 = "=new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "                new java.io.FileOutputStream(tempFile_";
  protected final String TEXT_17 = ",false),";
  protected final String TEXT_18 = ")), ',','\\0','\\0',lineSeparator_";
  protected final String TEXT_19 = ");  " + NL + "\t";
  protected final String TEXT_20 = NL + "   \tString[] headColu_";
  protected final String TEXT_21 = "=new String[";
  protected final String TEXT_22 = "];";
  protected final String TEXT_23 = NL + "   \theadColu_";
  protected final String TEXT_24 = "[";
  protected final String TEXT_25 = "]=\"";
  protected final String TEXT_26 = "\";";
  protected final String TEXT_27 = NL + "    CsvWriter_";
  protected final String TEXT_28 = ".writeNext(headColu_";
  protected final String TEXT_29 = ");" + NL + "    CsvWriter_";
  protected final String TEXT_30 = ".setQuoteChar('\"');" + NL + "    CsvWriter_";
  protected final String TEXT_31 = ".setEscapeChar('\"');";
