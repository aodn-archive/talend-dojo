...
public class TOracleBulkExecBeginJava {
  ...
  protected final String TEXT_440 = " = 0;" + NL + "int nb_line_discarded_";
  protected final String TEXT_441 = " = 0;" + NL + "" + NL + "/*\t1.get log file all lines count\t" + NL + "\t2.get \"Total logical records read\" line number from file end.\t" + NL + "\t3.get \"Total logical records read\" and \"Total logical records rejected\" count. */" + NL + "String tempLine_";
  protected final String TEXT_442 = " = \"\";" + NL + "int countLines_";
  protected final String TEXT_443 = " =0;//log file lines count" + NL + "//1" + NL + "boolean isEnglish_";
  protected final String TEXT_444 = " = false;" + NL + "while ((tempLine_";
  protected final String TEXT_445 = " = lr_";
  protected final String TEXT_446 = ".readLine() )!= null) {" + NL + "\tcountLines_";
  protected final String TEXT_447 = "++;" + NL + "\tif(!isEnglish_";
  protected final String TEXT_448 = " && tempLine_";
  protected final String TEXT_449 = ".contains(\"Total logical records\")){" + NL + "\t\tisEnglish_";
  protected final String TEXT_450 = " = true;" + NL + "\t}" + NL + "}" + NL + "lr_";
  protected final String TEXT_451 = ".close();" + NL + "//need new instance to readLine ." + NL + "lr_";
  protected final String TEXT_452 = " = new java.io.BufferedReader(new java.io.FileReader(logf_";
  protected final String TEXT_453 = "));" + NL + "if(isEnglish_";
  protected final String TEXT_454 = "){" + NL + "\tfor (int i_";
  protected final String TEXT_455 = "=0; i_";
  protected final String TEXT_456 = "<= countLines_";
  protected final String TEXT_457 = "; i_";
  protected final String TEXT_458 = "++) {" + NL + "\t\ttempLine_";
  protected final String TEXT_459 = " = lr_";
  protected final String TEXT_460 = ".readLine();" + NL + "\t\tif(tempLine_";
  protected final String TEXT_461 = ".contains(\"Rows successfully loaded\")){" + NL + "\t\t\tnb_line_inserted_";
  protected final String TEXT_462 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_463 = ".substring(0,tempLine_";
  protected final String TEXT_464 = ".indexOf(\"Rows successfully loaded\")).trim());" + NL + "\t\t}" + NL + "\t\tif(tempLine_";
  protected final String TEXT_465 = ".contains(\"Total logical records read\")){" + NL + "\t\t\tnb_line_data_";
  protected final String TEXT_466 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_467 = ".substring(tempLine_";
  protected final String TEXT_468 = ".indexOf(\":\") + 1).trim());" + NL + "\t\t}" + NL + "\t\tif(tempLine_";
  protected final String TEXT_469 = ".contains(\"Total logical records rejected\")){" + NL + "\t\t\tnb_line_bad_";
  protected final String TEXT_470 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_471 = ".substring(tempLine_";
  protected final String TEXT_472 = ".indexOf(\":\") + 1).trim());" + NL + "\t\t\tbreak;" + NL + "\t\t}" + NL + "\t}" + NL + "}else{" + NL + "//2" + NL + "for (int i_";
  protected final String TEXT_473 = "=0; i_";
  protected final String TEXT_474 = "<= countLines_";
  protected final String TEXT_475 = " - 10; i_";
  protected final String TEXT_476 = "++) {" + NL + "\tlr_";
  protected final String TEXT_477 = ".readLine();" + NL + "}" + NL + "//3.Total logical records read" + NL + "tempLine_";
  protected final String TEXT_478 = " = lr_";
  protected final String TEXT_479 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_480 = " != null) {" + NL + "\tnb_line_data_";
  protected final String TEXT_481 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_482 = ".substring(tempLine_";
  protected final String TEXT_483 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "//3.Total logical records rejected" + NL + "tempLine_";
  protected final String TEXT_484 = " = lr_";
  protected final String TEXT_485 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_486 = " != null) {" + NL + "\tnb_line_bad_";
  protected final String TEXT_487 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_488 = ".substring(tempLine_";
  protected final String TEXT_489 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "tempLine_";
  protected final String TEXT_490 = " = lr_";
  protected final String TEXT_491 = ".readLine();" + NL + "if (tempLine_";
  protected final String TEXT_492 = " != null) {" + NL + "\tnb_line_discarded_";
  protected final String TEXT_493 = " = Integer.parseInt(tempLine_";
  protected final String TEXT_494 = ".substring(tempLine_";
  protected final String TEXT_495 = ".indexOf(\":\") + 1).trim());" + NL + "}" + NL + "\tnb_line_inserted_";
  protected final String TEXT_496 = " = nb_line_data_";
  protected final String TEXT_497 = " - nb_line_bad_";
  protected final String TEXT_498 = " - nb_line_discarded_";
  protected final String TEXT_499 = ";" + NL + "}" + NL + "lr_";
  protected final String TEXT_500 = ".close();" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_501 = "_NB_LINE_DATA\", nb_line_data_";
  protected final String TEXT_502 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_503 = "_NB_LINE_BAD\", nb_line_bad_";
  protected final String TEXT_504 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_505 = "_NB_LINE_INSERTED\", nb_line_inserted_";
  protected final String TEXT_506 = ");" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_507 = "_RETURN_CODE\", exitCode_";
