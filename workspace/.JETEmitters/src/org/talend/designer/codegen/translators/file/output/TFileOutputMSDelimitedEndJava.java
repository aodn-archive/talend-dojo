...
public class TFileOutputMSDelimitedEndJava
{
  ...
  protected final String TEXT_12 = NL + "if(nb_line_";
  protected final String TEXT_13 = " == 0){" + NL + "\tnew java.io.File(fileName_";
  protected final String TEXT_14 = ").delete();" + NL + "}";
...
//				sb.append("out" + cid + ".setLineEnd(\"\"+row_" + connection + ".charAt(0));\n");
