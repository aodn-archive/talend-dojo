...
public class TInformixConnectionBeginJava
{
  ...
  protected final String TEXT_46 = NL + "\tString password_";
  protected final String TEXT_47 = " = ";
  protected final String TEXT_48 = ";" + NL + "" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_49 = " = null;" + NL;
  protected final String TEXT_50 = NL + "\t";
  protected final String TEXT_51 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  ...
  protected final String TEXT_61 = ");" + NL + "\tglobalMap.put(\"dbschema_\" + \"";
