...
public class TMysqlOutputBulkBeginJava
{
  ...
  protected final String TEXT_16 = " = 0;  // 0: double quotes; 1: backslash" + NL + "\t\tif(escapeChar_";
  protected final String TEXT_17 = "=='\\\\'){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_18 = " = 1;" + NL + "\t\t}else if(escapeChar_";
  protected final String TEXT_19 = " == textEnclosure_";
  protected final String TEXT_20 = "){" + NL + "\t\t\tescape_mode_";
  protected final String TEXT_21 = " = 0;" + NL + "\t\t}else {" + NL + "\t\t\tthrow new RuntimeException(\"The escape mode only support the '\\\\' or double text enclosure.\");" + NL + "\t\t}" + NL + "\t\t\t\t" + NL + "\t\tjava.io.File file_";
  ...
  protected final String TEXT_26 = NL + "\t\t\t\t" + NL + "\t\tjava.io.BufferedWriter csvWriter_";
  protected final String TEXT_27 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        new java.io.FileOutputStream(file_";
