...
public class THiveConnectionBeginJava
{
  ...
  protected final String TEXT_24 = ");" + NL + "\t\t\t\tSystem.setProperty(\"hive.metastore.execute.setugi\", \"true\");" + NL + "\t\t\t\tString url_";
  ...
  protected final String TEXT_43 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_44 = NL + "\t\t";
  protected final String TEXT_45 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_46 = "\", conn_";
  protected final String TEXT_47 = ");" + NL + "\t}";
  protected final String TEXT_48 = NL + "\tif (null != conn_";
  protected final String TEXT_49 = ") {" + NL + "\t\t";
  protected final String TEXT_50 = NL + "\t}";
  protected final String TEXT_51 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_52 = "\",conn_";
  protected final String TEXT_53 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
