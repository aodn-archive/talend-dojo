...
public class TFileInputDelimitedBeginJava
{
  ...
  protected final String TEXT_362 = " = -1;\t" + NL + "\t\t\t\t//the parameters of reader constructor" + NL + "\t\t\t\tchar fieldSeparatorChar_";
  protected final String TEXT_363 = " = ',';" + NL + "\t\t\t\tString rowSeparatorChars_";
  protected final String TEXT_364 = " = \"\\n\";" + NL + "\t\t\t\tchar textQuote_";
  protected final String TEXT_365 = " = '\\0';" + NL + "\t\t\t\tchar escape_";
  protected final String TEXT_366 = " = '\\\\';" + NL + "\t\t\t\tboolean useDoubleTextQuoteEscape_";
  protected final String TEXT_367 = " = false;" + NL + "\t\t\t\tboolean skipEmptyRow_";
  protected final String TEXT_368 = " = ";
  protected final String TEXT_369 = ";" + NL + "\t\t\t\tint header_";
  protected final String TEXT_370 = " = ";
  protected final String TEXT_371 = ";" + NL + "\t\t\t\tif(header_";
  protected final String TEXT_372 = " < 0) {" + NL + "\t\t\t\t\theader_";
  protected final String TEXT_373 = " = 0;" + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\tchar[] fieldSeparator_";
  protected final String TEXT_374 = " = null;" + NL + "\t\t\t\t" + NL + "\t\t\t\t//support passing value (property: Field Separator) by 'context.fs' or 'globalMap.get(\"fs\")'. " + NL + "\t\t\t\tif ( ((String)";
  protected final String TEXT_375 = ").length() > 0 ){" + NL + "\t\t\t\t\tfieldSeparator_";
  protected final String TEXT_376 = " = ((String)";
  protected final String TEXT_377 = ").toCharArray();" + NL + "\t\t\t\t}else {\t\t\t" + NL + "\t\t\t\t\tthrow new IllegalArgumentException(\"Field Separator must be assigned a char.\"); " + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\tfieldSeparatorChar_";
  protected final String TEXT_378 = " = fieldSeparator_";
  protected final String TEXT_379 = "[0];" + NL + "\t\t\t" + NL + "\t\t\t\tchar[] rowSeparator_";
  protected final String TEXT_380 = " = null;" + NL + "\t\t\t" + NL + "\t\t\t\t//support passing value (property: Row Separator) by 'context.rs' or 'globalMap.get(\"rs\")'. " + NL + "\t\t\t\tif ( ((String)";
  protected final String TEXT_381 = ").length() > 0 ){" + NL + "\t\t\t\t\trowSeparator_";
  protected final String TEXT_382 = " = ((String)";
  protected final String TEXT_383 = ").toCharArray();" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t\tthrow new IllegalArgumentException(\"Row Separator must be assigned a char.\"); " + NL + "\t\t\t\t}" + NL + "\t\t\t\t" + NL + "\t\t\t\tif ( (rowSeparator_";
  protected final String TEXT_384 = "[0] != '\\n') && (rowSeparator_";
  protected final String TEXT_385 = "[0] != '\\r') ) {" + NL + "\t\t\t\t\trowSeparatorChars_";
  protected final String TEXT_386 = " = \"\" + rowSeparator_";
  protected final String TEXT_387 = "[0];" + NL + "\t\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_388 = NL + "    \t\t\t\ttextQuote_";
  protected final String TEXT_389 = " = '";
  protected final String TEXT_390 = "';" + NL + "\t\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\tString textEnclosure1_";
  protected final String TEXT_392 = " = ";
  protected final String TEXT_393 = "; " + NL + "\t\t\t\t\tchar textEnclosure_";
  protected final String TEXT_394 = "[] = null;" + NL + "\t        " + NL + "\t\t\t\t    if(((String)textEnclosure1_";
  protected final String TEXT_395 = ").length() > 0 ){ " + NL + "\t\t\t\t\t\ttextEnclosure_";
  protected final String TEXT_396 = " = ((String)textEnclosure1_";
  protected final String TEXT_397 = ").toCharArray(); " + NL + "\t\t\t\t\t}else { " + NL + "        \t\t\t\tthrow new IllegalArgumentException(\"Text Enclosure must be assigned a char.\"); " + NL + "    \t\t\t\t}" + NL + "\t\t\t\t\ttextQuote_";
  protected final String TEXT_398 = " = textEnclosure_";
  protected final String TEXT_399 = "[0];" + NL + "\t\t\t\t";
  protected final String TEXT_400 = NL + "        \t\t\t\t//use the default escape char \\" + NL + "\t\t\t\t\t";
  protected final String TEXT_401 = NL + "        \t\t\t\tuseDoubleTextQuoteEscape_";
  protected final String TEXT_402 = " = true;" + NL + "\t\t\t\t\t";
  protected final String TEXT_403 = NL + "        \t\t\t\t//now we can support,but too many choice is not a good idea." + NL + "\t\t\t\t\t";
  protected final String TEXT_404 = " " + NL + "        \t\t\tString escapeChar1_";
  protected final String TEXT_405 = " = ";
  protected final String TEXT_406 = ";          " + NL + "        \t\t\tchar escapeChar_";
  protected final String TEXT_407 = "[] = null;" + NL + "\t        " + NL + "\t\t\t        if(((String)escapeChar1_";
  protected final String TEXT_408 = ").length() > 0 ){ " + NL + "\t\t\t        \tescapeChar_";
  protected final String TEXT_409 = " = ((String)escapeChar1_";
  protected final String TEXT_410 = ").toCharArray(); " + NL + "\t\t\t  \t\t}else { " + NL + "        \t\t\t    throw new IllegalArgumentException(\"Escape Char must be assigned a char.\"); " + NL + "        \t\t\t}" + NL + "       \t\t\t\tif(escapeChar_";
  protected final String TEXT_411 = "[0] == '\\\\'){" + NL + "       \t\t\t\t\t//use the default escape char \\" + NL + "       \t\t\t\t}else if(escapeChar_";
  protected final String TEXT_412 = "[0] ==";
  protected final String TEXT_413 = "'";
  protected final String TEXT_414 = "'";
  protected final String TEXT_415 = "textEnclosure_";
  protected final String TEXT_416 = "[0]";
  protected final String TEXT_417 = "){" + NL + "       \t\t\t\t\tuseDoubleTextQuoteEscape_";
  protected final String TEXT_418 = " = true;" + NL + "       \t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_419 = " " + NL + "\t\t\t" + NL + "\t\t\t\tObject filename_";
  protected final String TEXT_420 = " = ";
  protected final String TEXT_421 = ";\t\t" + NL + "\t\t\t\tcom.talend.csv.CSVReader csvReader";
  protected final String TEXT_422 = " = null;" + NL + "\t" + NL + "\t\t\t\ttry{" + NL + "\t\t\t\t\t";
  protected final String TEXT_423 = NL + "\t        \t\t\tjava.util.zip.ZipInputStream zis_";
  protected final String TEXT_424 = " = null;" + NL + "\t        \t\t\ttry {" + NL + "\t\t        \t\t\tif(filename_";
  protected final String TEXT_425 = " instanceof java.io.InputStream){" + NL + "\t\t        \t\t\t\tzis_";
  protected final String TEXT_426 = " = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream((java.io.InputStream)filename_";
  protected final String TEXT_427 = "));" + NL + "\t\t        \t\t\t}else{" + NL + "\t\t        \t\t\t\tzis_";
  protected final String TEXT_428 = " = new java.util.zip.ZipInputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_429 = "))));" + NL + "\t\t        \t\t\t}" + NL + "\t        \t\t\t} catch(Exception e) {" + NL + "\t        \t\t\t\t";
  protected final String TEXT_430 = NL + "\t\t\t\t\t\t\t\tthrow e;" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_431 = NL + "\t\t\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_432 = NL + "\t        \t\t\t}" + NL + "\t        \t\t\tjava.util.zip.ZipEntry entry_";
  protected final String TEXT_433 = " = null;" + NL + "\t\t        " + NL + "\t\t\t\t        while (true) {" + NL + "\t\t\t        \t\ttry {" + NL + "\t        \t\t\t\t\tentry_";
  protected final String TEXT_434 = " = zis_";
  protected final String TEXT_435 = ".getNextEntry();" + NL + "\t        \t\t\t\t} catch(Exception e) {" + NL + "\t        \t\t\t\t\t";
  protected final String TEXT_436 = NL + "\t\t\t\t\t\t\t\t\tthrow e;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_437 = NL + "\t\t\t\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_438 = NL + "\t        \t\t\t\t}" + NL + "\t        \t\t\t\tif(entry_";
  protected final String TEXT_439 = " == null) {" + NL + "\t\t\t\t\t\t\t\tbreak;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t        \t\t\t\tif(entry_";
  protected final String TEXT_440 = ".isDirectory()){ //directory" + NL + "\t        \t\t\t\t\tcontinue;" + NL + "\t        \t\t\t\t}" + NL + "\t        \t\t\t\tString[] row";
  protected final String TEXT_441 = "=null;" + NL + "\t        \t\t\t\tint currentLine";
  protected final String TEXT_442 = " = 0;" + NL + "\t        \t\t\t\tint outputLine";
  protected final String TEXT_443 = " = 0;" + NL + "\t        \t\t\t\ttry {//TD110 begin" + NL + "\t        \t\t\t\t\tcsvReader";
  protected final String TEXT_444 = " = new com.talend.csv.CSVReader(zis_";
  protected final String TEXT_445 = ", " + NL + "            \t\t\t\t\t\t";
  protected final String TEXT_446 = ", rowSeparatorChars_";
  protected final String TEXT_447 = ", fieldSeparatorChar_";
  protected final String TEXT_448 = ", " + NL + "            \t\t\t\t\t\ttextQuote_";
  protected final String TEXT_449 = ", escape_";
  protected final String TEXT_450 = "," + NL + "            \t\t\t\t\t\tskipEmptyRow_";
  protected final String TEXT_451 = ", header_";
  protected final String TEXT_452 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_453 = NL + "\t\t\t\t\t\tString[] row";
  protected final String TEXT_454 = "=null;" + NL + "\t\t\t\t\t\tint currentLine";
  protected final String TEXT_455 = " = 0;" + NL + "\t        \t\t\tint outputLine";
  protected final String TEXT_456 = " = 0;" + NL + "\t\t\t\t\t\ttry {//TD110 begin" + NL + "\t\t\t\t\t\t\tif(filename_";
  protected final String TEXT_457 = " instanceof java.io.InputStream){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_458 = NL + "    \t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_459 = " = new com.talend.csv.CSVReader((java.io.InputStream)filename_";
  protected final String TEXT_460 = ", " + NL + "\t        \t\t\t\t\t\t";
  protected final String TEXT_461 = ", rowSeparatorChars_";
  protected final String TEXT_462 = ", fieldSeparatorChar_";
  protected final String TEXT_463 = ", " + NL + "\t        \t\t\t\t\t\ttextQuote_";
  protected final String TEXT_464 = ", escape_";
  protected final String TEXT_465 = "," + NL + "            \t\t\t\t\t\tskipEmptyRow_";
  protected final String TEXT_466 = ", header_";
  protected final String TEXT_467 = ");" + NL + "\t\t\t\t\t\t\t}else{" + NL + "    \t\t\t\t\t\t\tcsvReader";
  protected final String TEXT_468 = " = new com.talend.csv.CSVReader(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_469 = ")), " + NL + "            \t\t\t\t\t\t";
  protected final String TEXT_470 = ", rowSeparatorChars_";
  protected final String TEXT_471 = ", fieldSeparatorChar_";
  protected final String TEXT_472 = ", " + NL + "            \t\t\t\t\t\ttextQuote_";
  protected final String TEXT_473 = ", escape_";
  protected final String TEXT_474 = "," + NL + "            \t\t\t\t\t\tskipEmptyRow_";
  protected final String TEXT_475 = ", header_";
  protected final String TEXT_476 = ");" + NL + "\t\t        \t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_477 = NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tcsvReader";
  protected final String TEXT_478 = ".doubleQuoteCharEscape(useDoubleTextQuoteEscape_";
  protected final String TEXT_479 = ");" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tif(footer_";
  protected final String TEXT_480 = " > 0){" + NL + "\t\t\t\t\t\ttotalLine";
  protected final String TEXT_481 = " = header_";
  protected final String TEXT_482 = ";" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t            while ((row";
  protected final String TEXT_483 = " = csvReader";
  protected final String TEXT_484 = ".readNext())!=null) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_485 = NL + "\t\t\t\t\t\t\t\tif(!(row";
  protected final String TEXT_486 = ".length == 1 && (\"\\015\").equals(row";
  protected final String TEXT_487 = "[0]))){//empty line when row separator is '\\n'" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_488 = NL + "\t                " + NL + "\t                \t\ttotalLine";
  protected final String TEXT_489 = "++;" + NL + "\t                " + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_490 = NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_491 = NL + "\t                " + NL + "\t\t\t            }" + NL + "\t            \t\tint lastLineTemp";
  protected final String TEXT_492 = " = totalLine";
  protected final String TEXT_493 = " - footer_";
  protected final String TEXT_494 = "   < 0? 0 : totalLine";
  protected final String TEXT_495 = " - footer_";
  protected final String TEXT_496 = " ;" + NL + "\t            \t\tif(lastLine";
  protected final String TEXT_497 = " > 0){" + NL + "\t                \t\tlastLine";
  protected final String TEXT_498 = " = lastLine";
  protected final String TEXT_499 = " < lastLineTemp";
  protected final String TEXT_500 = " ? lastLine";
  protected final String TEXT_501 = " : lastLineTemp";
  protected final String TEXT_502 = "; " + NL + "\t            \t\t}else {" + NL + "\t                \t\tlastLine";
  protected final String TEXT_503 = " = lastLineTemp";
  protected final String TEXT_504 = ";" + NL + "\t            \t\t}" + NL + "\t         " + NL + "\t\t\t          \tcsvReader";
  protected final String TEXT_505 = ".close();" + NL + "\t\t\t\t        if(filename_";
  protected final String TEXT_506 = " instanceof java.io.InputStream){" + NL + "    \t\t\t\t        csvReader";
  protected final String TEXT_507 = " = new com.talend.csv.CSVReader((java.io.InputStream)filename_";
  protected final String TEXT_508 = ", " + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_509 = ", rowSeparatorChars_";
  protected final String TEXT_510 = ", fieldSeparatorChar_";
  protected final String TEXT_511 = ", " + NL + "        \t\t\t\t\t\ttextQuote_";
  protected final String TEXT_512 = ", escape_";
  protected final String TEXT_513 = "," + NL + "        \t\t\t\t\t\tskipEmptyRow_";
  protected final String TEXT_514 = ", header_";
  protected final String TEXT_515 = ");" + NL + "\t\t        \t\t}else{" + NL + "\t\t        \t\t\tcsvReader";
  protected final String TEXT_516 = " = new com.talend.csv.CSVReader(new java.io.FileInputStream(String.valueOf(filename_";
  protected final String TEXT_517 = ")), " + NL + "        \t\t\t\t\t\t";
  protected final String TEXT_518 = ", rowSeparatorChars_";
  protected final String TEXT_519 = ", fieldSeparatorChar_";
  protected final String TEXT_520 = ", " + NL + "        \t\t\t\t\t\ttextQuote_";
  protected final String TEXT_521 = ", escape_";
  protected final String TEXT_522 = "," + NL + "        \t\t\t\t\t\tskipEmptyRow_";
  protected final String TEXT_523 = ", header_";
  protected final String TEXT_524 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\tcsvReader";
  protected final String TEXT_525 = ".doubleQuoteCharEscape(useDoubleTextQuoteEscape_";
  protected final String TEXT_526 = ");" + NL + "\t        \t\t}" + NL + "\t        " + NL + "\t\t\t        if(limit";
  protected final String TEXT_527 = " != 0){" + NL + "\t\t\t        \tcurrentLine";
  protected final String TEXT_528 = " = header_";
  protected final String TEXT_529 = ";" + NL + "\t\t\t        }" + NL + "\t        " + NL + "\t    \t\t} catch(Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_530 = NL + "\t\t\t\t\t\tthrow e;" + NL + "\t\t\t\t\t";
  protected final String TEXT_531 = NL + "\t\t\t\t\t\tSystem.err.println(e.getMessage());" + NL + "\t\t\t\t\t";
  protected final String TEXT_532 = NL + "\t    \t\t}//TD110 end" + NL + "\t        " + NL + "\t        \twhile ( limit";
  protected final String TEXT_533 = " != 0 && csvReader";
  protected final String TEXT_534 = "!=null && (row";
  protected final String TEXT_535 = " = csvReader";
  protected final String TEXT_536 = ".readNext())!=null ) { " + NL + "\t        " + NL + "\t\t\t\t\t";
