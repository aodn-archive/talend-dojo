...
public class TFirebirdConnectionBeginJava
{
  ...
  protected final String TEXT_32 = NL + "\tString password_";
  protected final String TEXT_33 = " = ";
  protected final String TEXT_34 = ";" + NL + "" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_35 = " = null;" + NL;
  protected final String TEXT_36 = NL + "\t";
  protected final String TEXT_37 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_38 = NL + "\t\t";
  protected final String TEXT_39 = NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_40 = "\", conn_";
  protected final String TEXT_41 = ");" + NL + "\t}";
  protected final String TEXT_42 = NL + "\tif (null != conn_";
