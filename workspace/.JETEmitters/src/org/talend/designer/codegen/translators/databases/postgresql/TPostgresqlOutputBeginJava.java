...
public class TPostgresqlOutputBeginJava {
  ...
  protected final String TEXT_175 = " = true;" + NL + "\t                    break;" + NL + "\t                }" + NL + "\t            }" + NL + "\t            rsTable_";
  protected final String TEXT_176 = ".close();";
  protected final String TEXT_177 = "      " + NL + "\t            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_178 = " = conn_";
  protected final String TEXT_179 = ".getMetaData();" + NL + "\t            java.sql.ResultSet rsTable_";
  protected final String TEXT_180 = " = dbMetaData_";
  protected final String TEXT_181 = ".getTables(null, null, null, new String[]{\"TABLE\"});" + NL + "\t            boolean whetherExist_";
  protected final String TEXT_182 = " = false;" + NL + "\t            while(rsTable_";
  protected final String TEXT_183 = ".next()) {" + NL + "\t                String table_";
  ...
  protected final String TEXT_190 = NL + "                if(!whetherExist_";
  protected final String TEXT_191 = ") {" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_214 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_215 = " = conn_";
  protected final String TEXT_216 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_217 = ".execute(\"";
  protected final String TEXT_218 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_219 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_241 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_242 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_243 = "            ";
  protected final String TEXT_244 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_245 = " = conn_";
  protected final String TEXT_246 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_247 = ".executeUpdate(\"";
  protected final String TEXT_248 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_249 = ".close();";
  protected final String TEXT_250 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_251 = " = conn_";
  protected final String TEXT_252 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_253 = " = stmtTruncCount_";
  protected final String TEXT_254 = ".executeQuery(\"";
  protected final String TEXT_255 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_256 = " = conn_";
  protected final String TEXT_257 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_258 = ".executeUpdate(\"";
  protected final String TEXT_259 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_260 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_261 = " += rsTruncCount_";
  protected final String TEXT_262 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_263 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_264 = ".close();" + NL + "            stmtTrunc_";
  ...
  protected final String TEXT_282 = NL + "\t    String insert_";
  protected final String TEXT_283 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_284 = " + \"\\\" (";
  protected final String TEXT_285 = ") VALUES (";
  protected final String TEXT_286 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_287 = " = conn_";
  protected final String TEXT_288 = ".prepareStatement(insert_";
  protected final String TEXT_289 = ");" + NL + "\t    ";
  protected final String TEXT_290 = NL + "\t    String update_";
  protected final String TEXT_291 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_292 = " + \"\\\" SET ";
  protected final String TEXT_293 = " WHERE ";
  protected final String TEXT_294 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_295 = " = conn_";
  protected final String TEXT_296 = ".prepareStatement(update_";
  protected final String TEXT_297 = ");" + NL + "\t    ";
  protected final String TEXT_298 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_299 = " = conn_";
  protected final String TEXT_300 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_301 = " + \"\\\" WHERE ";
  protected final String TEXT_302 = "\");" + NL + "\t    String insert_";
  protected final String TEXT_303 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_304 = " + \"\\\" (";
  protected final String TEXT_305 = ") VALUES (";
  protected final String TEXT_306 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_307 = " = conn_";
  protected final String TEXT_308 = ".prepareStatement(insert_";
  protected final String TEXT_309 = ");" + NL + "\t    String update_";
  protected final String TEXT_310 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_311 = " + \"\\\" SET ";
  protected final String TEXT_312 = " WHERE ";
  protected final String TEXT_313 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_314 = " = conn_";
  protected final String TEXT_315 = ".prepareStatement(update_";
  ...
  protected final String TEXT_328 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_329 = " = conn_";
  protected final String TEXT_330 = ".prepareStatement(insert_";
  protected final String TEXT_331 = ");\t\t" + NL + "\t    ";
  protected final String TEXT_332 = NL + "\t    String delete_";
  protected final String TEXT_333 = " = \"DELETE FROM \\\"\" + tableName_";
  ...
  protected final String TEXT_339 = NL + "        StringBuffer query_";
  protected final String TEXT_340 = " = null;" + NL + "       \t";
  protected final String TEXT_341 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_342 = " = insert_";
  protected final String TEXT_343 = ".split(\"\\\\?\");";
  protected final String TEXT_344 = NL + "\t\t\tupdate_";
  protected final String TEXT_345 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_346 = " = update_";
  protected final String TEXT_347 = ".split(\"\\\\?\");";
  protected final String TEXT_348 = NL + "\t\t\tupdate_";
  protected final String TEXT_349 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_350 = " = update_";
  protected final String TEXT_351 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_352 = " = insert_";
  protected final String TEXT_353 = ".split(\"\\\\?\");";
  protected final String TEXT_354 = NL + "\t\t\tdelete_";
  protected final String TEXT_355 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_356 = " = delete_";
  protected final String TEXT_357 = ".split(\"\\\\?\");";
  protected final String TEXT_358 = NL + "\t\t\treplace_";
  protected final String TEXT_359 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_360 = " = replace_";
  protected final String TEXT_361 = ".split(\"\\\\?\");";
  protected final String TEXT_362 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_363 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_364 = " = insertIgnore_";
  protected final String TEXT_365 = ".split(\"\\\\?\");";
  protected final String TEXT_366 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_367 = " = insert_";
  protected final String TEXT_368 = ".split(\"\\\\?\");";
  protected final String TEXT_369 = NL + "    \tString geometryColumnName_";
  protected final String TEXT_370 = " = null;" + NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_371 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_372 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_373 = " = true;" + NL + "    \t";
  protected final String TEXT_374 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_375 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_376 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
