...
public class TInformixInputBeginJava
{
  ...
  protected final String TEXT_104 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_105 = ") {" + NL + "\t\t\t\t\tjava.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_106 = " = dataSources.get(\"";
  protected final String TEXT_107 = "\").getConnection();" + NL + "\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_108 = "\", conn_";
  protected final String TEXT_109 = ");" + NL + "\t\t        }";
  protected final String TEXT_110 = NL + NL + "\t\t    ";
  protected final String TEXT_111 = NL + "\t\t    " + NL + "\t\t    String dbquery_";
  protected final String TEXT_112 = " = ";
  protected final String TEXT_113 = ";" + NL + "\t\t    " + NL + "\t\t    globalMap.put(\"";
  protected final String TEXT_114 = "_QUERY\",dbquery_";
  protected final String TEXT_115 = ");" + NL + "\t\t    " + NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_116 = " = stmt_";
  protected final String TEXT_117 = ".executeQuery(dbquery_";
  protected final String TEXT_118 = ");" + NL + "\t\t    java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_119 = " = rs_";
  protected final String TEXT_120 = ".getMetaData();" + NL + "\t\t    int colQtyInRs_";
  protected final String TEXT_121 = " = rsmd_";
  protected final String TEXT_122 = ".getColumnCount();" + NL;
  protected final String TEXT_123 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_124 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_125 = ".setDbmsId(\"";
  protected final String TEXT_126 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_127 = "=new java.util.ArrayList<String>();" + NL + "\t\t    for(int i_";
  protected final String TEXT_128 = "=1; i_";
  protected final String TEXT_129 = "<";
  protected final String TEXT_130 = "; i_";
  protected final String TEXT_131 = "++) {" + NL + "\t\t    \tlistSchema_";
  protected final String TEXT_132 = ".add(rsmd_";
  protected final String TEXT_133 = ".getColumnName(i_";
  protected final String TEXT_134 = ").toUpperCase());" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t\t\tint fixedColumnCount_";
  protected final String TEXT_135 = " = ";
  protected final String TEXT_136 = ";" + NL + "\t\t\t" + NL + "            for (int i = ";
  protected final String TEXT_137 = "; i <= rsmd_";
  protected final String TEXT_138 = ".getColumnCount(); i++) {" + NL + "                if (!(listSchema_";
  ...
  protected final String TEXT_177 = " = null;" + NL + "\t\t    while (rs_";
  protected final String TEXT_178 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_179 = "++;" + NL + "\t\t        ";
  protected final String TEXT_180 = " \t" + NL + "\t\t                    if(colQtyInRs_";
  ...
  protected final String TEXT_191 = " = (List)rs_";
  protected final String TEXT_192 = ".getObject(";
  protected final String TEXT_193 = ");";
  protected final String TEXT_194 = NL + "\t\t                         ";
  protected final String TEXT_195 = NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load((oracle.sql.STRUCT) rs_";
  protected final String TEXT_196 = ".getObject(";
  protected final String TEXT_197 = "));" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_198 = NL + "                                    ";
  protected final String TEXT_199 = ".";
  protected final String TEXT_200 = " = new Geometry(wktValue);";
  protected final String TEXT_201 = NL + "                                        ";
  protected final String TEXT_202 = ".";
  protected final String TEXT_203 = ".setEPSG(";
  protected final String TEXT_204 = ");";
  protected final String TEXT_205 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_206 = NL + "                                  ";
  protected final String TEXT_207 = ".";
  protected final String TEXT_208 = "=dcg_";
  protected final String TEXT_209 = ";";
  protected final String TEXT_210 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_211 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_212 = " = ";
  protected final String TEXT_213 = "; i_";
  protected final String TEXT_214 = "  <= rsmd_";
  protected final String TEXT_215 = ".getColumnCount(); i_";
  protected final String TEXT_216 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_217 = ".getColumnTypeName(i_";
  protected final String TEXT_218 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_219 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_220 = ".getClob(i_";
  protected final String TEXT_221 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_222 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_223 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_224 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_225 = ".add(tNTextImpl_";
  protected final String TEXT_226 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_227 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_228 = ".";
  protected final String TEXT_229 = ", rs_";
  protected final String TEXT_230 = ", fixedColumnCount_";
  protected final String TEXT_231 = ",list_";
