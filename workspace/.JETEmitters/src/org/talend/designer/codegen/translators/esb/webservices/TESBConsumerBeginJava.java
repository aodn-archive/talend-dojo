...
public class TESBConsumerBeginJava
{
  ...
  protected final String TEXT_61 = NL + "\t\tconfig_";
  protected final String TEXT_62 = ".setBasicAuth(true);" + NL + "\t";
  protected final String TEXT_63 = NL + "\t";
  protected final String TEXT_64 = NL + "\t\tconfig_";
  protected final String TEXT_65 = ".setTokenAuth(true);" + NL + "\t";
  protected final String TEXT_66 = NL + "\tconfig_";
  protected final String TEXT_67 = ".setProxyServer(";
  protected final String TEXT_68 = ");" + NL + "\tconfig_";
  protected final String TEXT_69 = ".setProxyPort(";
  protected final String TEXT_70 = ");" + NL + "\tconfig_";
  protected final String TEXT_71 = ".setProxyUsername(";
  protected final String TEXT_72 = ");" + NL + "\tconfig_";
  protected final String TEXT_73 = ".setProxyPassword(";
  protected final String TEXT_74 = ");";
  protected final String TEXT_75 = NL + NL + "\tjava.net.URI uri_";
  protected final String TEXT_76 = " = new java.net.URI(";
  protected final String TEXT_77 = ");" + NL + "\tif (\"http\".equals(uri_";
  protected final String TEXT_78 = ".getScheme()) || \"https\".equals(uri_";
  protected final String TEXT_79 = ".getScheme())) {" + NL + "\t\tserviceInvokerHelper_";
  protected final String TEXT_80 = " = new org.talend.ws.helper.ServiceInvokerHelper(";
  protected final String TEXT_81 = ", config_";
  protected final String TEXT_82 = ", ";
  protected final String TEXT_83 = ");" + NL + "\t} else {" + NL + "\t\torg.talend.ws.helper.ServiceDiscoveryHelper serviceDiscoveryHelper_";
  protected final String TEXT_84 = " =" + NL + "\t\t\t\tnew org.talend.ws.helper.ServiceDiscoveryHelper(";
  protected final String TEXT_85 = ", ";
  protected final String TEXT_86 = ");" + NL + "\t\tserviceInvokerHelper_";
  protected final String TEXT_87 = " = new org.talend.ws.helper.ServiceInvokerHelper(serviceDiscoveryHelper_";
  protected final String TEXT_88 = ", config_";
  protected final String TEXT_89 = ");" + NL + "\t}" + NL + "" + NL + "\tserviceName_";
  protected final String TEXT_90 = " = new javax.xml.namespace.QName(\"";
  protected final String TEXT_91 = "\", \"";
  protected final String TEXT_92 = "\");" + NL + "\tportName_";
...
if (useSl) {
    ...
    stringBuffer.append(Boolean.valueOf(ElementParameterParser.getValue(node, "__SERVICE_ACTIVITY_MONITOR__")));
