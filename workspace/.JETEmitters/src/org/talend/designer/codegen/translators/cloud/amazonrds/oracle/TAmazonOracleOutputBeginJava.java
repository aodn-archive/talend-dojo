...
public class TAmazonOracleOutputBeginJava {
  ...
  protected final String TEXT_241 = ".createStatement();";
  protected final String TEXT_242 = NL + "\t\t\t\t\t\tstmtCreate_";
  protected final String TEXT_243 = ".execute(\"";
  protected final String TEXT_244 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_261 = NL + "                if(whetherExist_";
  protected final String TEXT_262 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_263 = " = conn_";
  protected final String TEXT_264 = ".createStatement();" + NL + "                    stmtDrop_";
  ...
  protected final String TEXT_269 = ".createStatement();";
  ...
  protected final String TEXT_290 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_291 = "            ";
  protected final String TEXT_292 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_293 = " = conn_";
  protected final String TEXT_294 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_305 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_306 = ".executeUpdate(\"";
  protected final String TEXT_307 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_308 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_309 = " += rsTruncCount_";
  protected final String TEXT_310 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_311 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_312 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_313 = ".close();            ";
  protected final String TEXT_314 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_315 = " = conn_";
  protected final String TEXT_316 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_317 = " = stmtTruncCount_";
  protected final String TEXT_318 = ".executeQuery(\"";
  protected final String TEXT_319 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_320 = " = conn_";
  protected final String TEXT_321 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_322 = ".executeUpdate(\"";
  protected final String TEXT_323 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_324 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_325 = " += rsTruncCount_";
  protected final String TEXT_326 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_327 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_328 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_329 = ".close();";
  protected final String TEXT_330 = NL + "\t    String insert_";
  protected final String TEXT_331 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_332 = " + \" (";
  protected final String TEXT_333 = ") VALUES (";
  protected final String TEXT_334 = ")\";" + NL + "\t   \t";
  protected final String TEXT_335 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_336 = " = new StringBuffer(insert_";
  protected final String TEXT_337 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_338 = ".insert(insert_";
  protected final String TEXT_339 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_340 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_341 = " =insertStringBuffer_";
  ...
  protected final String TEXT_346 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_352 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_353 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_354 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_355 = ",insert_";
  protected final String TEXT_356 = ",keyPsmt_";
  protected final String TEXT_357 = ");";
  protected final String TEXT_358 = NL + "\t    " + NL + "\t    ";
  protected final String TEXT_359 = NL + "\t    String update_";
  protected final String TEXT_360 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_361 = " + \" SET ";
  protected final String TEXT_362 = " WHERE ";
  protected final String TEXT_363 = "\";" + NL + "    \t";
  protected final String TEXT_364 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_365 = " = new StringBuffer(update_";
  protected final String TEXT_366 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_367 = ".insert(update_";
  protected final String TEXT_368 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_369 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_370 = " =updateStringBuffer_";
  ...
  protected final String TEXT_374 = ".prepareStatement(update_";
  ...
  protected final String TEXT_383 = ") VALUES (";
  ...
  protected final String TEXT_393 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_394 = " = conn_";
  protected final String TEXT_395 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_401 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_402 = " = new StringBuffer(update_";
  protected final String TEXT_403 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_404 = ".insert(update_";
  protected final String TEXT_405 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_406 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_407 = " =updateStringBuffer_";
  protected final String TEXT_408 = ".toString(); ";
  protected final String TEXT_409 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_416 = " WHERE ";
  protected final String TEXT_417 = "\";" + NL + "\t   \t";
  protected final String TEXT_418 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_419 = " = new StringBuffer(update_";
  protected final String TEXT_420 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_421 = ".insert(update_";
  protected final String TEXT_422 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_423 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_424 = " =updateStringBuffer_";
  protected final String TEXT_425 = ".toString(); ";
  protected final String TEXT_426 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_442 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_446 = NL + "\t    String delete_";
  protected final String TEXT_447 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_448 = " + \" WHERE ";
  protected final String TEXT_449 = "\";" + NL + "\t    ";
  protected final String TEXT_450 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_451 = " = new StringBuffer(delete_";
  protected final String TEXT_452 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_453 = ".insert(delete_";
  protected final String TEXT_454 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_455 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_456 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_460 = ".prepareStatement(delete_";
  protected final String TEXT_461 = ");" + NL + "\t    ";
  protected final String TEXT_462 = NL + "        StringBuffer query_";
  protected final String TEXT_463 = " = null;" + NL + "\t   ";
  protected final String TEXT_464 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_465 = " = insert_";
  protected final String TEXT_466 = ".split(\"\\\\?\");";
  protected final String TEXT_467 = NL + "\t\t\tupdate_";
  protected final String TEXT_468 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_469 = " = update_";
  protected final String TEXT_470 = ".split(\"\\\\?\");";
  protected final String TEXT_471 = NL + "\t\t\tupdate_";
  protected final String TEXT_472 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_473 = " = update_";
  protected final String TEXT_474 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_481 = NL + "\t\t\treplace_";
  protected final String TEXT_482 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_483 = " = replace_";
  protected final String TEXT_484 = ".split(\"\\\\?\");";
  protected final String TEXT_485 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_486 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_487 = " = insertIgnore_";
