...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_45 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  ...
  protected final String TEXT_53 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_54 = "\", ";
  protected final String TEXT_55 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_56 = "\",  ";
  protected final String TEXT_57 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_58 = "\",conn_";
  protected final String TEXT_59 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
