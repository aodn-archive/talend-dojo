...
public class TAccessBulkExecBeginJava {
  ...
  protected final String TEXT_108 = ".equals";
  protected final String TEXT_109 = "IgnoreCase";
  protected final String TEXT_110 = "(";
  protected final String TEXT_111 = ")) {" + NL + "                    whetherExist_";
  ...
  protected final String TEXT_122 = NL + "                if(whetherExist_";
  protected final String TEXT_123 = ") {" + NL + "                    java.sql.Statement stmtDrop_";
  protected final String TEXT_124 = " = conn_";
  protected final String TEXT_125 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_126 = ".execute(\"";
  protected final String TEXT_127 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_128 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  protected final String TEXT_129 = " = conn_";
  protected final String TEXT_130 = ".createStatement();" + NL + "                stmtCreate_";
  ...
  protected final String TEXT_134 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_135 = " = conn_";
  protected final String TEXT_136 = ".createStatement();" + NL + "            stmtClear_";
  protected final String TEXT_137 = ".executeUpdate(\"";
  protected final String TEXT_138 = "\");" + NL + "            stmtClear_";
  protected final String TEXT_139 = ".close();";
  protected final String TEXT_140 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_141 = " = conn_";
  protected final String TEXT_142 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_143 = " = stmtTruncCount_";
  protected final String TEXT_144 = ".executeQuery(\"";
  protected final String TEXT_145 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_146 = " = conn_";
  protected final String TEXT_147 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_148 = ".executeUpdate(\"";
  protected final String TEXT_149 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_150 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_151 = " += rsTruncCount_";
  protected final String TEXT_152 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_153 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_154 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_155 = ".close();            ";
  protected final String TEXT_156 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_157 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_158 = ".commit();" + NL + "\t\t}";
  protected final String TEXT_159 = " " + NL;
  protected final String TEXT_160 = NL + "\t\tString bulkInsert_";
  protected final String TEXT_161 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_162 = " + \"] SELECT * FROM [Text;Database=\"" + NL + "\t\t\t\t\t\t\t\t\t\t+ fileDirectory_";
  protected final String TEXT_163 = " + \";HDR=";
  ...
  protected final String TEXT_168 = ".createStatement();" + NL + "\tstmt_";
  protected final String TEXT_169 = ".execute(bulkInsert_";
  protected final String TEXT_170 = ");" + NL + "" + NL + "\tstmt_";
