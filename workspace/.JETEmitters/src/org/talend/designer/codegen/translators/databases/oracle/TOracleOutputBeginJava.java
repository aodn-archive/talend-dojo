...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_236 = ".getString(\"TABLE_NAME\");" + NL + "\t                if(table_";
  protected final String TEXT_237 = ".equalsIgnoreCase(";
  ...
  protected final String TEXT_267 = ".createStatement();" + NL + "                    stmtDrop_";
  protected final String TEXT_268 = ".execute(\"";
  protected final String TEXT_269 = "\");" + NL + "                    stmtDrop_";
  protected final String TEXT_270 = ".close();" + NL + "                }" + NL + "                java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_275 = "\"+DynamicUtils.getCreateTableSQL(";
  ...
  protected final String TEXT_292 = NL + "\t\t\t\tGlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_293 = ", true);" + NL + "" + NL + "\t\t\t\t\t} // end of if" + NL + "\t\t\t\t} // end synchronized" + NL + "\t\t\t}";
  protected final String TEXT_294 = "            ";
  protected final String TEXT_295 = NL + "            java.sql.Statement stmtClear_";
  protected final String TEXT_296 = " = conn_";
  protected final String TEXT_297 = ".createStatement();" + NL + "            stmtClear_";
  ...
  protected final String TEXT_301 = NL + "            java.sql.Statement stmtTruncCount_";
  protected final String TEXT_302 = " = conn_";
  protected final String TEXT_303 = ".createStatement();" + NL + "            java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_304 = " = stmtTruncCount_";
  protected final String TEXT_305 = ".executeQuery(\"";
  protected final String TEXT_306 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_307 = " = conn_";
  protected final String TEXT_308 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_309 = ".executeUpdate(\"";
  protected final String TEXT_310 = "\");" + NL + "            while(rsTruncCount_";
  protected final String TEXT_311 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_312 = " += rsTruncCount_";
  protected final String TEXT_313 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_314 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_315 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_316 = ".close();            ";
  protected final String TEXT_317 = NL + "\t\t \tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_318 = " = conn_";
  protected final String TEXT_319 = ".createStatement();" + NL + "\t\t \tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_320 = " = stmtTruncCount_";
  protected final String TEXT_321 = ".executeQuery(\"";
  protected final String TEXT_322 = "\");" + NL + "            java.sql.Statement stmtTrunc_";
  protected final String TEXT_323 = " = conn_";
  protected final String TEXT_324 = ".createStatement();" + NL + "            stmtTrunc_";
  protected final String TEXT_325 = ".executeUpdate(\"";
  protected final String TEXT_326 = "\");" + NL + "             while(rsTruncCount_";
  protected final String TEXT_327 = ".next()) {" + NL + "                deletedCount_";
  protected final String TEXT_328 = " += rsTruncCount_";
  protected final String TEXT_329 = ".getInt(1);" + NL + "            }" + NL + "            rsTruncCount_";
  protected final String TEXT_330 = ".close();" + NL + "            stmtTruncCount_";
  protected final String TEXT_331 = ".close();" + NL + "            stmtTrunc_";
  protected final String TEXT_332 = ".close();";
  protected final String TEXT_333 = NL + "\t    String insert_";
  protected final String TEXT_334 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_335 = " + \" (";
  protected final String TEXT_336 = ") VALUES (";
  protected final String TEXT_337 = ")\";" + NL + "\t   \t";
  protected final String TEXT_338 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_339 = " = new StringBuffer(insert_";
  protected final String TEXT_340 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_341 = ".insert(insert_";
  protected final String TEXT_342 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_343 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_344 = " =insertStringBuffer_";
  ...
  protected final String TEXT_353 = " = null;         " + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_354 = " = conn_";
  protected final String TEXT_355 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_356 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_357 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_358 = ",insert_";
  protected final String TEXT_359 = ",keyPsmt_";
  protected final String TEXT_360 = ");";
  protected final String TEXT_361 = NL + "\t    " + NL + "\t    ";
  protected final String TEXT_362 = NL + "\t    String update_";
  protected final String TEXT_363 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_364 = " + \" SET ";
  protected final String TEXT_365 = " WHERE ";
  ...
  protected final String TEXT_375 = NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_381 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  ...
  protected final String TEXT_396 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_412 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_429 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  ...
  protected final String TEXT_435 = ") VALUES (";
  ...
  protected final String TEXT_445 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  ...
  protected final String TEXT_449 = NL + "\t    String delete_";
  protected final String TEXT_450 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_451 = " + \" WHERE ";
  protected final String TEXT_452 = "\";" + NL + "\t    ";
  protected final String TEXT_453 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_454 = " = new StringBuffer(delete_";
  protected final String TEXT_455 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_456 = ".insert(delete_";
  protected final String TEXT_457 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_458 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_459 = " =deleteStringBuffer_";
  protected final String TEXT_460 = ".toString();  ";
  protected final String TEXT_461 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_462 = " = conn_";
  protected final String TEXT_463 = ".prepareStatement(delete_";
  protected final String TEXT_464 = ");" + NL + "\t    ";
  protected final String TEXT_465 = NL + "        StringBuffer query_";
  protected final String TEXT_466 = " = null;" + NL + "\t   ";
  protected final String TEXT_467 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_468 = " = insert_";
  protected final String TEXT_469 = ".split(\"\\\\?\");";
  protected final String TEXT_470 = NL + "\t\t\tupdate_";
  protected final String TEXT_471 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_472 = " = update_";
  ...
  protected final String TEXT_477 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_478 = " = insert_";
  protected final String TEXT_479 = ".split(\"\\\\?\");";
  protected final String TEXT_480 = NL + "\t\t\tdelete_";
  protected final String TEXT_481 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_482 = " = delete_";
  protected final String TEXT_483 = ".split(\"\\\\?\");";
  protected final String TEXT_484 = NL + "\t\t\treplace_";
  protected final String TEXT_485 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_486 = " = replace_";
  protected final String TEXT_487 = ".split(\"\\\\?\");";
  protected final String TEXT_488 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_489 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_490 = " = insertIgnore_";
  protected final String TEXT_491 = ".split(\"\\\\?\");";
  protected final String TEXT_492 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_493 = " = insert_";
  protected final String TEXT_494 = ".split(\"\\\\?\");";
  protected final String TEXT_495 = NL + "\t   ";
  protected final String TEXT_496 = NL + "    \t// Initialize SRID" + NL + "    \tint SRID_";
  protected final String TEXT_497 = " = 0;" + NL + "    \tint dimension_";
  protected final String TEXT_498 = " = 0; " + NL + "    \tboolean firstGeometry_";
  protected final String TEXT_499 = " = true;" + NL + "    \t";
  protected final String TEXT_500 = NL + "\tclass XMLTypeUtil_";
  ...
  protected final String TEXT_502 = " xmlTypeUtil_";
  protected final String TEXT_503 = " = null;" + NL + "\txmlTypeUtil_";
  protected final String TEXT_504 = " = new XMLTypeUtil_";
  protected final String TEXT_505 = "();";
  protected final String TEXT_506 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_507 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_508 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_509 = " =null;";
  protected final String TEXT_510 = NL + NL + NL + NL;
