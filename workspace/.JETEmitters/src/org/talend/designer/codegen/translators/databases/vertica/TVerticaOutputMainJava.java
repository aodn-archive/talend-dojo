...
public class TVerticaOutputMainJava {
  ...
  protected final String TEXT_368 = ".executeBatch();                \t" + NL + "            \t    \t";
  ...
  protected final String TEXT_371 = ".toString().getBytes());" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_372 = NL + "\t\t\t\t\t    com.vertica.jdbc.VerticaCopyStream vcs_";
  protected final String TEXT_373 = " = new com.vertica.jdbc.VerticaCopyStream((com.vertica.jdbc.VerticaConnection)conn_";
  protected final String TEXT_374 = ",template_";
  protected final String TEXT_375 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_376 = ".start();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_377 = ".addStream(bais_";
  protected final String TEXT_378 = ");" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_379 = ".execute();" + NL + "\t\t\t\t\t\tvcs_";
  protected final String TEXT_380 = ".finish();" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_381 = NL + "\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_382 = ").executeCopyIn(template_";
  protected final String TEXT_383 = ", bais_";
  protected final String TEXT_384 = ");" + NL + "\t\t\t\t\t    \t";
  protected final String TEXT_385 = NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_386 = " = null;" + NL + "\t\t\t\t\t\tif (bais_";
  protected final String TEXT_387 = " != null) {" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_388 = ".close();" + NL + "\t\t\t\t\t\t\tbais_";
  protected final String TEXT_389 = " = null;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_390 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_391 = NL + "\t\t\t\t\t\t";
  protected final String TEXT_392 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_393 = " += pstmt_";
  protected final String TEXT_394 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_395 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_396 = " += pstmt_";
  protected final String TEXT_397 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_398 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_399 = " += pstmt_";
  protected final String TEXT_400 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_401 = NL + "            \t    \t\t\tcopiedCount_";
  protected final String TEXT_402 = " += vcs_";
  protected final String TEXT_403 = ".getRowCount();" + NL + "            \t    \t";
  protected final String TEXT_404 = NL + "            \t    \t\t\tcopiedCount_";
  protected final String TEXT_405 = " += stmt_";
  protected final String TEXT_406 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_407 = "                         \t    \t" + NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_408 = " = 0;             \t                \t                \t" + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_409 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_410 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_411 = NL + "                }";
  protected final String TEXT_412 = "    \t\t\t" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_413 = "                                                " + NL + "                try {" + NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_414 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_415 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_416 = " += pstmt_";
  protected final String TEXT_417 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_418 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_419 = " += pstmt_";
  protected final String TEXT_420 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_421 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_422 = " += pstmt_";
  protected final String TEXT_423 = ". getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_424 = "                         \t    \t" + NL + "                }catch (java.sql.BatchUpdateException e){" + NL + "                \t";
  protected final String TEXT_425 = NL + "                \t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_426 = NL + "                \tSystem.err.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_427 = NL + "                }";
  protected final String TEXT_428 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_429 = "++;            " + NL + "                if(commitEvery_";
  protected final String TEXT_430 = " <= commitCounter_";
  protected final String TEXT_431 = ") {" + NL + "                ";
  protected final String TEXT_432 = NL + "                try {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_433 = NL + "\t\t\t\t\t\tpstmt_";
  protected final String TEXT_434 = ".executeBatch();                \t" + NL + "            \t    \t";
  protected final String TEXT_435 = NL + "\t\t\t\t\t\tif (stmtBuilder_";
  protected final String TEXT_436 = " != null && stmtBuilder_";
  protected final String TEXT_437 = ".length() != 0 ) { // stmtBuilder_";
  protected final String TEXT_438 = " start" + NL + "\t\t\t\t\t\t\tjava.io.ByteArrayInputStream bais_";
  protected final String TEXT_439 = " = new ByteArrayInputStream(stmtBuilder_";
  protected final String TEXT_440 = ".toString().getBytes());" + NL + "\t\t\t\t\t\t\t((com.vertica.PGStatement)stmt_";
  protected final String TEXT_441 = ").executeCopyIn(template_";
  protected final String TEXT_442 = ", bais_";
  protected final String TEXT_443 = ");" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_444 = " = null;" + NL + "\t\t\t\t\t\t\tif (bais_";
  protected final String TEXT_445 = " != null) {" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_446 = ".close();" + NL + "\t\t\t\t\t\t\t\tbais_";
  protected final String TEXT_447 = " = null;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\tstmtBuilder_";
  protected final String TEXT_448 = " = new StringBuilder();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_449 = NL + NL + "            \t    \t";
  protected final String TEXT_450 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_451 = " += pstmt_";
  protected final String TEXT_452 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_453 = "            \t    \t\t" + NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_454 = " += pstmt_";
  protected final String TEXT_455 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_456 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_457 = " += pstmt_";
  protected final String TEXT_458 = ".getUpdateCount();" + NL + "            \t    \t";
  protected final String TEXT_459 = NL + "            \t    \t\t\tcopiedCount_";
  protected final String TEXT_460 = " += stmt_";
  protected final String TEXT_461 = ".getUpdateCount();" + NL + "            \t    \t} // stmtBuilder_";
  protected final String TEXT_462 = " end" + NL + "            \t    \t";
  protected final String TEXT_463 = "             \t    " + NL + "                }catch (java.sql.SQLException e){" + NL + "                \t";
  protected final String TEXT_464 = NL + "\t\t\t\t\t\tthrow(e);" + NL + "                \t";
  protected final String TEXT_465 = NL + "                        System.out.println(e.getMessage());" + NL + "                \t";
  protected final String TEXT_466 = NL + "                " + NL + "                }            \t                              ";
  protected final String TEXT_467 = NL + "       \t\t\t\tconn_";
  protected final String TEXT_468 = ".commit();" + NL + "                \tcommitCounter_";
  protected final String TEXT_469 = "=0;" + NL + "                }\t";
