...
public class THashOutputMainJava
{
  ...
  protected final String TEXT_28 = "_\" + pid +\"_";
  protected final String TEXT_29 = "\");" + NL + "\t\t\tmf_";
  protected final String TEXT_30 = ".getResourceMap().put(\"tHashFile_";
  protected final String TEXT_31 = "_\" + pid +\"_";
  protected final String TEXT_32 = "\", tHashFile_";
  protected final String TEXT_33 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_34 = "Struct oneRow_";
  protected final String TEXT_35 = " = new ";
  protected final String TEXT_36 = "Struct();";
  protected final String TEXT_37 = NL + "\t\t\toneRow_";
  protected final String TEXT_38 = ".";
  protected final String TEXT_39 = " = ";
  protected final String TEXT_40 = ".";
  protected final String TEXT_41 = ".clone();";
  protected final String TEXT_42 = NL + "\t\t\toneRow_";
  protected final String TEXT_43 = ".";
  protected final String TEXT_44 = " = ";
  protected final String TEXT_45 = ".";
  protected final String TEXT_46 = ";";
  protected final String TEXT_47 = NL + "        tHashFile_";
  protected final String TEXT_48 = ".put(oneRow_";
