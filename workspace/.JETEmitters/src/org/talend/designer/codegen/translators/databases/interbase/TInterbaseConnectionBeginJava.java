...
public class TInterbaseConnectionBeginJava
{
  ...
  protected final String TEXT_3 = NL + "\t\t\tjava.lang.Class.forName(\"";
  protected final String TEXT_4 = "\");";
  protected final String TEXT_5 = NL + "\t\t\tString sharedConnectionName_";
  protected final String TEXT_6 = " = ";
  protected final String TEXT_7 = ";" + NL + "\t\t\tconn_";
  protected final String TEXT_8 = " = SharedDBConnection.getDBConnection(\"";
  protected final String TEXT_9 = "\",url_";
  protected final String TEXT_10 = ",userName_";
  protected final String TEXT_11 = " , password_";
  protected final String TEXT_12 = " , sharedConnectionName_";
  protected final String TEXT_13 = ");";
  protected final String TEXT_14 = NL + "\t\tconn_";
  protected final String TEXT_15 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_16 = ",userName_";
  protected final String TEXT_17 = ",password_";
  protected final String TEXT_18 = ");";
  protected final String TEXT_19 = NL + "\t\t\tconn_";
  protected final String TEXT_20 = ".setAutoCommit(";
  protected final String TEXT_21 = ");";
  protected final String TEXT_22 = NL + "\t\tString url_";
  protected final String TEXT_23 = " = \"jdbc:interbase://\"+";
  ...
  protected final String TEXT_35 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
