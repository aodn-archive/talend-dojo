...
public class TAccessConnectionBeginJava
{
  ...
  protected final String TEXT_51 = NL + "\tString password_";
  protected final String TEXT_52 = " = ";
  protected final String TEXT_53 = ";" + NL + "" + NL + "\tjava.sql.Connection conn_";
  protected final String TEXT_54 = " = null;" + NL;
  protected final String TEXT_55 = NL + "\t";
  protected final String TEXT_56 = NL + "\tif (null == globalMap.get(KEY_DB_DATASOURCES)) {" + NL + "\t\t";
  protected final String TEXT_57 = NL + "\t\t";
  protected final String TEXT_58 = NL + "\t\tglobalMap.put(\"conn_";
