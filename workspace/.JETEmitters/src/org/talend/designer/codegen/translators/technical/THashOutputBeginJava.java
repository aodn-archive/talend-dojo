...
public class THashOutputBeginJava
{
  ...
  protected final String TEXT_13 = "_\" +pid + \"_";
  protected final String TEXT_14 = "\"))==null){" + NL + "\t\t\t\ttHashFile_";
  protected final String TEXT_15 = " = new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<";
  protected final String TEXT_16 = "Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.";
  protected final String TEXT_17 = ");                " + NL + "\t        }";
  protected final String TEXT_18 = NL + "\t\t\ttHashFile_";
  ...
  protected final String TEXT_22 = "\t\t\t" + NL + "        //use this ResourceMap instead of globalMap,so that globalMap will not be too large" + NL + "        mf_";
  protected final String TEXT_23 = ".getResourceMap().put(\"tHashFile_";
  protected final String TEXT_24 = "_\" +pid + \"_";
  ...
  protected final String TEXT_28 = "Struct> tHashFile_";
  ...
  protected final String TEXT_33 = "_\" + pid + \"_";
