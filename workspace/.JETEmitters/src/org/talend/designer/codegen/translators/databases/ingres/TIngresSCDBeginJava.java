...
public class TIngresSCDBeginJava {
  ...
  protected final String TEXT_13 = NL + "    \tjava.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "    \tString connectionString_";
  protected final String TEXT_14 = " = \"jdbc:ingres://\" + ";
  ...
  protected final String TEXT_22 = NL + "    java.sql.Timestamp timestamp_";
  protected final String TEXT_23 = " = null;" + NL + "    String tmpValue_";
  protected final String TEXT_24 = " = null;    ";
  protected final String TEXT_25 = NL + "        String searching_";
  protected final String TEXT_26 = " = \"";
  protected final String TEXT_27 = "\";" + NL + "        java.sql.PreparedStatement searchingStmt_";
  protected final String TEXT_28 = " = connection_";
  protected final String TEXT_29 = ".prepareStatement(searching_";
  protected final String TEXT_30 = ");" + NL + "        java.sql.ResultSet searchingResult_";
  protected final String TEXT_31 = " = null;";
  protected final String TEXT_32 = NL + "        String search_";
  protected final String TEXT_33 = " = \"";
  protected final String TEXT_34 = "\";" + NL + "        java.sql.Statement statement_";
  protected final String TEXT_35 = " = connection_";
  protected final String TEXT_36 = ".createStatement();" + NL + "        java.sql.ResultSet resultSet_";
  protected final String TEXT_37 = " = statement_";
  protected final String TEXT_38 = ".executeQuery(search_";
  protected final String TEXT_39 = ");" + NL + "        java.util.Map<SCDSK_";
  protected final String TEXT_40 = ", SCDStruct_";
  protected final String TEXT_41 = "> cache_";
  protected final String TEXT_42 = " = new java.util.HashMap<SCDSK_";
  protected final String TEXT_43 = ", SCDStruct_";
  protected final String TEXT_44 = ">();" + NL + "        while(resultSet_";
  protected final String TEXT_45 = ".next()) {" + NL + "            SCDSK_";
  protected final String TEXT_46 = " sk_";
  protected final String TEXT_47 = " = new SCDSK_";
  protected final String TEXT_48 = "();" + NL + "            SCDStruct_";
  protected final String TEXT_49 = " row_";
  protected final String TEXT_50 = " = new SCDStruct_";
  protected final String TEXT_51 = "();";
  protected final String TEXT_52 = NL + "                    tmpValue_";
  protected final String TEXT_53 = " = resultSet_";
  protected final String TEXT_54 = ".getString(";
  protected final String TEXT_55 = ");" + NL + "                    if (tmpValue_";
  protected final String TEXT_56 = " != null && tmpValue_";
  protected final String TEXT_57 = ".length() > 0) {";
  protected final String TEXT_58 = NL + "                        ";
  protected final String TEXT_59 = ".";
  protected final String TEXT_60 = " = tmpValue_";
  protected final String TEXT_61 = ".charAt(0);" + NL + "                    } else {";
  ...
  protected final String TEXT_70 = NL + "                            if(tmpValue_";
  protected final String TEXT_71 = "(\"\").equals()) {";
  protected final String TEXT_72 = NL + "                                ";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = " = '\\0';" + NL + "                            } else {" + NL + "                                throw new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_75 = "' in '";
  protected final String TEXT_76 = "' connection, value is invalid or this column should be nullable or have a default value.\");" + NL + "                            }";
  protected final String TEXT_77 = NL + "                    }";
  protected final String TEXT_78 = NL + "                    timestamp_";
  ...
  protected final String TEXT_85 = " = new java.util.Date(timestamp_";
  protected final String TEXT_86 = ".getTime());" + NL + "                    } else {";
  protected final String TEXT_87 = NL + "                        ";
  protected final String TEXT_88 = ".";
  protected final String TEXT_89 = " = null;" + NL + "                    }";
  protected final String TEXT_90 = NL + "                    if(resultSet_";
  ...
  protected final String TEXT_99 = NL + "            cache_";
  protected final String TEXT_100 = ".put(sk_";
  protected final String TEXT_101 = ", row_";
  protected final String TEXT_102 = ");" + NL + "        }" + NL + "        resultSet_";
  protected final String TEXT_103 = ".close();" + NL + "        statement_";
  protected final String TEXT_104 = ".close();";
  protected final String TEXT_105 = NL + "            System.out.println(\"[";
  protected final String TEXT_106 = "] comparison cache loaded\");";
  protected final String TEXT_107 = NL + "        ";
  protected final String TEXT_108 = " nextSurrogateKey_";
  protected final String TEXT_109 = " = 1;";
  protected final String TEXT_110 = NL + "            if(cache_";
  protected final String TEXT_111 = ".size() > 0) {";
  protected final String TEXT_112 = NL + "        String tmpQuery_";
  protected final String TEXT_113 = " = \"SELECT MAX(\\\"";
  protected final String TEXT_114 = "\\\") FROM \\\"\" + tableName_";
  protected final String TEXT_115 = " + \"\\\"\";" + NL + "        java.sql.Statement tmpStmt_";
  protected final String TEXT_116 = " = connection_";
  protected final String TEXT_117 = ".createStatement();" + NL + "        java.sql.ResultSet tmpRS_";
  protected final String TEXT_118 = " = tmpStmt_";
  protected final String TEXT_119 = ".executeQuery(tmpQuery_";
  protected final String TEXT_120 = ");";
  protected final String TEXT_121 = NL + "        if(tmpRS_";
  protected final String TEXT_122 = ".next() && tmpRS_";
  protected final String TEXT_123 = ".getObject(1) != null) {" + NL + "            nextSurrogateKey_";
  protected final String TEXT_124 = " = tmpRS_";
  protected final String TEXT_125 = ".get";
  protected final String TEXT_126 = "(1) + 1;" + NL + "        }" + NL + "        tmpRS_";
  protected final String TEXT_127 = ".close();" + NL + "        tmpStmt_";
  protected final String TEXT_128 = ".close();";
  protected final String TEXT_129 = NL + "            }            ";
  protected final String TEXT_130 = NL + "    String insertionSQL_";
  protected final String TEXT_131 = " = \"";
  protected final String TEXT_132 = "\";" + NL + "    java.sql.PreparedStatement insertionStatement_";
  protected final String TEXT_133 = " = connection_";
  protected final String TEXT_134 = ".prepareStatement(insertionSQL_";
  protected final String TEXT_135 = ");";
  protected final String TEXT_136 = NL + "            insertionStatement_";
  protected final String TEXT_137 = ".setTimestamp(";
  protected final String TEXT_138 = ", new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_139 = "\")));";
  protected final String TEXT_140 = NL + "            insertionStatement_";
  protected final String TEXT_141 = ".setNull(";
  protected final String TEXT_142 = ", java.sql.Types.DATE);";
  protected final String TEXT_143 = NL + "            insertionStatement_";
  protected final String TEXT_144 = ".setTimestamp(";
  protected final String TEXT_145 = ", new java.sql.Timestamp(new java.text.SimpleDateFormat(\"yyyy-MM-dd HH:mm:ss\").parse(";
  protected final String TEXT_146 = " + \"-01-01 12:00:00\").getTime()));";
  protected final String TEXT_147 = NL + "        String updateSQLForType1_";
  protected final String TEXT_148 = " = \"";
  protected final String TEXT_149 = "\";" + NL + "        java.sql.PreparedStatement updateForType1_";
  protected final String TEXT_150 = " = connection_";
  protected final String TEXT_151 = ".prepareStatement(updateSQLForType1_";
  protected final String TEXT_152 = ");        ";
  protected final String TEXT_153 = NL + "        String updateSQLForType2_";
  protected final String TEXT_154 = " = \"";
  protected final String TEXT_155 = "\";" + NL + "        java.sql.PreparedStatement updateForType2_";
  protected final String TEXT_156 = " = connection_";
  protected final String TEXT_157 = ".prepareStatement(updateSQLForType2_";
  protected final String TEXT_158 = ");";
  protected final String TEXT_159 = NL + "            updateForType2_";
  protected final String TEXT_160 = ".setTimestamp(1, new java.sql.Timestamp(start_Hash.get(\"";
  protected final String TEXT_161 = "\")));";
  protected final String TEXT_162 = NL + "        String updateSQLForType3_";
  protected final String TEXT_163 = " = \"";
  protected final String TEXT_164 = "\";" + NL + "        java.sql.PreparedStatement updateForType3_";
  protected final String TEXT_165 = " = connection_";
  protected final String TEXT_166 = ".prepareStatement(updateSQLForType3_";
  protected final String TEXT_167 = ");";
  protected final String TEXT_168 = NL + "    ";
  protected final String TEXT_169 = NL + "        SCDSK_";
  protected final String TEXT_170 = " lookUpKey_";
  protected final String TEXT_171 = " = null;        ";
  protected final String TEXT_172 = NL + "    SCDStruct_";
  protected final String TEXT_173 = " lookUpValue_";
