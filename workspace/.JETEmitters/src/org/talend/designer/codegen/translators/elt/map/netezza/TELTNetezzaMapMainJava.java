...
public class TELTNetezzaMapMainJava
{
  protected static String nl;
  public static synchronized TELTNetezzaMapMainJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TELTNetezzaMapMainJava result = new TELTNetezzaMapMainJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = NL + "\t\t\t\t);" + NL + "\t\t\t\t" + NL + "\t\t\t\tglobalMap.put(" + NL + "\t\t\t\t\t\"";
