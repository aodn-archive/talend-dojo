...
public class TInterbaseInputBeginJava
{
  ...
  protected final String TEXT_95 = "\");" + NL + "\t\t        if (null == conn_";
  protected final String TEXT_96 = ") {" + NL + "\t\t\t\t\tjava.util.Map<String, javax.sql.DataSource> dataSources= (java.util.Map<String, javax.sql.DataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\t\t\t\tconn_";
  protected final String TEXT_97 = " = dataSources.get(\"";
  protected final String TEXT_98 = "\").getConnection();" + NL + "\t\t\t\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_201 = NL + "\t\t\t\t\t\t\t\t\t\tList<Object> list_";
  protected final String TEXT_202 = " = new java.util.ArrayList<Object>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_203 = " = ";
  protected final String TEXT_204 = "; i_";
  protected final String TEXT_205 = "  <= rsmd_";
  protected final String TEXT_206 = ".getColumnCount(); i_";
  protected final String TEXT_207 = " ++){" + NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_208 = ".getColumnTypeName(i_";
  protected final String TEXT_209 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_210 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_211 = ".getClob(i_";
  protected final String TEXT_212 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_213 = "!=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_214 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_215 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_216 = ".add(tNTextImpl_";
  protected final String TEXT_217 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_218 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_219 = ".";
  protected final String TEXT_220 = ", rs_";
  protected final String TEXT_221 = ", fixedColumnCount_";
  protected final String TEXT_222 = ",list_";
